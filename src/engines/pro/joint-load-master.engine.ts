...
export const JOINTS: JointMeta[] = [
  { id: 'shoulder', label: 'Плечо', icon: '🤸', dangerous: ['вращательная манжета (rotator cuff)', 'суставная губа (labrum)', 'AC-сустав', 'субакромиальная бурса'], description: 'Импинджмент при широком хвате/высоком жиме, жиме из-за головы, upright row выше сосков. Узкий хват + локти 30-45° и пауза берегут плечо.', relatedLifts: ['bench','ohp','incline_press','pulldown'], mobilityTestId: 'shoulder_flexion' },
