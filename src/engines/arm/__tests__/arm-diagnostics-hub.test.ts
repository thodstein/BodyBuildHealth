...
describe('arm-diagnostics-hub PRO', () => {
  ...
  it('tendon >18 → warn', () => {
    ...
    expect(r.findings.some(f=>f.text.includes('Tendon'))).toBe(true);
  });
  it('score 0-100', () => {
  ...
  it('verification 0.5 with grip', () => {
    ...
    expect(r.verification).toBe(0.5);
  });
  it('humerus side fail → critical', () => {
