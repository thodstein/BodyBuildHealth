...
const SUPPORT_MAX: PoolEntry[] = [
  ...
  { exId: 'rolling_thunder', protocol: 'Тяжёлые пятёрки DOH с холдом 8с — выносливость под нагрузкой', dose: '5×5 + холд', freq: '2×/нед', source: 'SBS DOH holds (endurance)', sets: 5, reps: [5, 5], holdSeconds: 8, restSec: 180, dayTag: 'SupportGrip', fixes: ['mid', 'hold_long'], warmup: 'Разминка: круги + лёгкие сжимания 1×12', causes: ['endurance'], minLevel: 'advanced', phase: 'strength', cues: ['Центр ручки', 'Холд 8с без разжимания'], progression: '+2.5%/нед к пятёрке', equipmentAlt: ['barbell', 'dumbbell'] },
  { exId: 'apollon_axle', protocol: 'Аксель DOH: объёмные тройки без лямок', dose: '5×3', freq: '2×/нед', source: 'AUSA axle volume', sets: 5, reps: [3, 3], restSec: 180, dayTag: 'SupportGrip', fixes: ['off_floor', 'mid'], warmup: 'Разминка: DOH без лямок на лёгком', causes: ['volume'], minLevel: 'advanced', phase: 'strength', cues: ['DOH', 'Без лямок', 'Одинаковый хват все сеты'], progression: '+2.5%/нед', equipmentAlt: ['barbell'] },
  { exId: 'napalm_handle_60', protocol: 'Napalm: холды 10с на рабочем весе — выносливость под нагрузкой', dose: '4×холд 10с', freq: '2×/нед', source: 'Napalm (endurance/strength)', sets: 4, reps: [1, 1], holdSeconds: 10, restSec: 150, dayTag: 'SupportGrip', fixes: ['mid', 'hold_long'], warmup: 'Разминка: круги + лёгкий гриппер 1×10', causes: ['endurance'], minLevel: 'intermediate', phase: 'strength', cues: ['60мм', 'Холд 10с без разжимания'], progression: '+2.5%/нед', equipmentAlt: ['dumbbell'] },
  { exId: 'raptor_3', protocol: 'Raptor: объёмные тройки DOH без лямок', dose: '5×3', freq: '2×/нед', source: 'AUSA Raptor volume', sets: 5, reps: [3, 3], restSec: 180, dayTag: 'SupportGrip', fixes: ['off_floor', 'mid'], warmup: 'Разминка: круги + Fat Gripz 1×12', causes: ['volume'], minLevel: 'advanced', phase: 'strength', cues: ['DOH толстый', 'Одинаковый хват все сеты'], progression: '+2.5%/нед', equipmentAlt: ['dumbbell'] },
  // ── ROUND-10 (третья ступень): каждая причина × фаза ≥4 ──
  { exId: 'napalm_handle_60', protocol: 'Силовая база 60 мм: тройки на 85% с паузой 2с', dose: '5×3', freq: '2×/нед', source: 'Napalm (силовая база)', sets: 5, reps: [3, 3], holdSeconds: 2, restSec: 180, dayTag: 'SupportGrip', fixes: ['off_floor'], causes: ['max_strength'], minLevel: 'intermediate', phase: 'strength', cues: ['Пауза 2с на старте', 'Без лямок'], progression: '+2.5 кг/нед', equipmentAlt: ['dumbbell', 'grip_tool'] },
  { exId: 'raptor_3', protocol: 'Техничные тройки Raptor на 80–85% — траектория и постановка кисти под нагрузкой', dose: '5×3', freq: '2×/нед', source: 'ArmliftingUSA Raptor (техника под нагрузкой)', sets: 5, reps: [3, 3], restSec: 150, dayTag: 'SupportGrip', fixes: ['start', 'mid'], causes: ['technique', 'max_strength'], minLevel: 'intermediate', phase: 'strength', cues: ['Кисть «в замок» до старта', 'Старт плавный, без рывка', 'То же качество на 3-м репе'], progression: '+2.5 кг/нед при чистой технике', equipmentAlt: ['dumbbell', 'bodyweight'] },
  { exId: 'farmer_walk_fat', protocol: 'Толстый гриф: объёмные тройки с добором — силовая база DOH', dose: '5×3–5', freq: '2×/нед', source: 'NSCA thick bar volume', sets: 5, reps: [3, 5], restSec: 150, dayTag: 'SupportGrip', fixes: ['mid', 'support'], causes: ['volume', 'max_strength'], minLevel: 'intermediate', phase: 'strength', cues: ['Стойка над снарядом', 'Хват до 3-го репа ровный'], progression: '+2.5 кг/нед', equipmentAlt: ['barbell', 'dumbbell'] },
  { exId: 'fat_bar_deadlift', protocol: 'Силовая выносливость: 50 мм гриф на длинные сеты при 70%', dose: '3×10', freq: '2×/нед', source: 'NSCA thick bar endurance', sets: 3, reps: [8, 12], restSec: 120, dayTag: 'SupportGrip', fixes: ['mid'], causes: ['endurance', 'max_strength'], minLevel: 'beginner', phase: 'strength', cues: ['Дыхание ровное', 'Хват не перезажимать'], progression: '+1 повтор/нед', equipmentAlt: ['barbell', 'dumbbell'] },
];
...
const PINCH: PoolEntry[] = [
  ...
  { exId: 'hub_pinch', protocol: 'Hub: синглы с паузой 3с — сила щипка с контролем', dose: '4×1 + пауза 3с', freq: '2×/нед', source: 'IronMind Hub (сила/стабильность)', sets: 4, reps: [1, 1], holdSeconds: 3, restSec: 150, dayTag: 'PinchGrip', fixes: ['off_floor', 'hold_short'], warmup: 'Разминка: круги запястий + 1×10 лёгким щипком', causes: ['max_strength'], minLevel: 'intermediate', phase: 'stability', cues: ['5 подушечек', 'Пауза 3с без сползания'], progression: '+1–2.5кг/нед', equipmentAlt: ['dumbbell'] },
  { exId: 'saxon_bar', protocol: 'Saxon: тяжёлые тройки — техника старта щипка', dose: '4×3', freq: '2×/нед', source: 'Saxon-практика (техника)', sets: 4, reps: [3, 3], restSec: 150, dayTag: 'PinchGrip', warmup: 'Разминка: прогрев пальцев 1×10–12', causes: ['max_strength', 'technique'], minLevel: 'advanced', phase: 'technique', cues: ['Прямоугольник 3″', 'Старт без рывка', 'Пальцы прямо'], progression: '+2.5%/нед при чистом старте', equipmentAlt: ['dumbbell'] },
  { exId: 'plate_pinch_hold', protocol: 'Щипок: постановка пальцев под нагрузкой (контроль)', dose: '4×10с', freq: '2–3×/нед', source: 'NSCA plate pinch (техника)', sets: 4, reps: [1, 1], holdSeconds: 10, restSec: 120, dayTag: 'PinchGrip', fixes: ['hold_short', 'mid'], warmup: 'Разминка: пальцы — круги + лёгкий экстензор 1×15', causes: ['technique'], minLevel: 'intermediate', phase: 'stability', cues: ['Гладкими наружу', 'Постановка 5 подушечек'], progression: '+5с холда/нед', equipmentAlt: ['dumbbell'] },
  { exId: 'finger_containment_band', protocol: 'Containment-резина на технику при усталости (свод пальцев)', dose: '3×15', freq: '3×/нед', source: 'Containment-практика (fatigue)', sets: 3, reps: [12, 15], restSec: 60, dayTag: 'PinchGrip', fixes: ['hold_short', 'mid'], warmup: 'Без разминки — активация', causes: ['fatigue', 'technique'], minLevel: 'beginner', phase: 'technique', cues: ['Держать свод', 'Не распахивать пальцы'], progression: 'Туже резина → дольше', equipmentAlt: ['band'], gentle: true },
  { exId: 'saxon_bar', protocol: 'Saxon: техника старта под нагрузкой 4×2', dose: '4×2', freq: '2×/нед', source: 'Saxon-практика (нагрузка)', sets: 4, reps: [2, 2], restSec: 180, dayTag: 'PinchGrip', warmup: 'Разминка: прогрев пальцев 1×10–12', causes: ['technique'], minLevel: 'advanced', phase: 'strength', cues: ['Прямоугольник 3″', 'Старт без рывка под весом'], progression: '+2.5%/нед', equipmentAlt: ['dumbbell'] },
  { exId: 'blockbuster_pinch', protocol: 'Blockbuster: холд 5с на технике щипка', dose: '4×5с', freq: '2×/нед', source: 'GripSport Blockbuster (техника)', sets: 4, reps: [1, 1], holdSeconds: 5, restSec: 120, dayTag: 'PinchGrip', fixes: ['hold_short', 'hold_long'], warmup: 'Разминка: круги + 1×10 лёгким щипком', causes: ['technique'], minLevel: 'intermediate', phase: 'stability', cues: ['Блок 2 3/8″', 'Холд 5с без сползания'], progression: '+5с холда/нед', equipmentAlt: ['dumbbell'] },
  { exId: 'euro_pinch_2h', protocol: 'Euro Pinch: тяжёлые тройки — техника постановки пальцев', dose: '5×3', freq: '2×/нед', source: 'Euro Pinch (сила/техника)', sets: 5, reps: [3, 3], restSec: 150, dayTag: 'PinchGrip', fixes: ['off_floor', 'hold_short'], warmup: 'Разминка: мел + 1×10–12 лёгким щипком', causes: ['max_strength'], minLevel: 'intermediate', phase: 'technique', cues: ['Две руки', 'Пальцы прямо, без рывка'], progression: '+2.5%/нед', equipmentAlt: ['dumbbell'] },
  { exId: 'hub_pinch', protocol: 'Hub: синглы с паузой 3с — стабильность щипка', dose: '5×1 + пауза', freq: '2×/нед', source: 'IronMind Hub (сила/стабильность 2)', sets: 5, reps: [1, 1], holdSeconds: 3, restSec: 150, dayTag: 'PinchGrip', fixes: ['off_floor', 'hold_short'], warmup: 'Разминка: круги запястий + 1×10 лёгким щипком', causes: ['max_strength'], minLevel: 'intermediate', phase: 'stability', cues: ['5 подушечек', 'Пауза 3с на пределе'], progression: '+1–2.5кг/нед', equipmentAlt: ['dumbbell'] },
  // ── ROUND-10 (третья ступень): причина × фаза ≥4 ──
  { exId: 'anvil_hub', protocol: 'Anvil Hub на 85–90% — синглы с единой постановкой кисти (техника максимума)', dose: '4×1', freq: '2×/нед', source: 'ArmliftingUSA Anvil (техника максимума)', sets: 4, reps: [1, 1], restSec: 180, dayTag: 'PinchGrip', fixes: ['off_floor', 'start'], causes: ['max_strength', 'technique'], minLevel: 'advanced', phase: 'technique', cues: ['Кисть сверху, пальцы «крючком»', 'Отрыв плавный, без рывка'], progression: '+2.5 кг/нед чистых синглов', equipmentAlt: ['dumbbell', 'grip_tool'] },
  { exId: 'blockbuster_pinch', protocol: 'Blockbuster: одиночные с паузой — техника щипка держится под усталостью', dose: '4×1', freq: '2×/нед', source: 'Gods of Grip Blockbuster (техника/стабильность)', sets: 4, reps: [1, 1], holdSeconds: 2, restSec: 180, dayTag: 'PinchGrip', fixes: ['hold_long'], causes: ['technique', 'fatigue'], minLevel: 'intermediate', phase: 'stability', cues: ['Пауза 2с в 3 см от пола', 'Одинаковая постановка каждый сет'], progression: '+2.5 кг/нед', equipmentAlt: ['dumbbell', 'grip_tool'] },
  { exId: 'plate_pinch_hold', protocol: 'Щипок на стабильность: холд 15с на 70% (одинаковое положение кисти)', dose: '4×15с', freq: '3×/нед', source: 'NSCA plate pinch (стабильность)', sets: 4, reps: [1, 1], holdSeconds: 15, restSec: 120, dayTag: 'PinchGrip', fixes: ['hold_long'], causes: ['technique', 'fatigue'], minLevel: 'beginner', phase: 'stability', cues: ['Кисть по центру', 'Без разъезда пальцев'], progression: '+5с/нед', equipmentAlt: ['dumbbell', 'grip_tool'] },
];

const CRUSH: PoolEntry[] = [
  { exId: 'coc_trainer', protocol: 'Warm: 10–12 лёгко, без отказа', dose: '1×12', freq: '2–3×/нед', source: 'CoC FAQ warm', sets: 1, reps: [10, 12], restSec: 60, dayTag: 'CrushGrip', causes: ['technique', 'volume'], minLevel: 'beginner', phase: 'technique', cues: ['Легко', 'Без отказа', 'Полная амплитуда'], progression: '10–12 чисто → следующий гриппер', equipmentAlt: ['band'], gentle: true },
  { exId: 'coc_no1', protocol: 'Work: 5–7 до отказа, 1–3 сета', dose: '3×5–7', freq: '2–3×/нед', source: 'CoC FAQ work', sets: 3, reps: [5, 7], restSec: 90, dayTag: 'CrushGrip', causes: ['max_strength'], minLevel: 'intermediate', phase: 'strength', cues: ['5–7 до отказа', 'Пауза между сетами полная'], progression: '10–12 повторов → следующий уровень', equipmentAlt: ['band'] },
  { exId: 'coc_gripper', protocol: 'Work + challenge: частички/негативы после отказа', dose: '3×5 + негативы', freq: '2×/нед', source: 'CoC FAQ challenge', sets: 3, reps: [5, 5], restSec: 120, dayTag: 'CrushGrip', fixes: ['close_fail', 'hold_short'], causes: ['max_strength'], minLevel: 'intermediate', phase: 'strength', cues: ['Работа до отказа', 'Негативы после'], progression: 'Частички → негативы → холд 3–5с', equipmentAlt: ['band'] },
  { exId: 'silver_bullet_hold', protocol: 'Удержание патрона в закрытом гриппере на время', dose: '3×макс', freq: '2×/нед', source: 'IronMind Silver', sets: 3, reps: [1, 1], holdSeconds: 20, restSec: 120, dayTag: 'CrushGrip', fixes: ['hold_short', 'hold_long'], causes: ['endurance'], minLevel: 'intermediate', phase: 'stability', cues: ['Вертикаль', 'Патрон не ронять'], progression: '+5с/нед', equipmentAlt: ['band'] },
  { exId: 'coc_no1_5', protocol: 'Work: 5–7 до отказа — мостик к №2', dose: '3×5–7', freq: '2–3×/нед', source: 'CoC-канон work (1.5)', sets: 3, reps: [5, 7], restSec: 120, dayTag: 'CrushGrip', fixes: ['close_fail'], warmup: 'Разминка: гриппером легче 1×10–12', causes: ['max_strength'], minLevel: 'advanced', phase: 'strength', cues: ['Мостик к №2', 'До отказа'], progression: '10–12 → пробовать №2', equipmentAlt: ['band'] },
  { exId: 'coc_no2', protocol: 'Work: 3–5 до отказа — соревновательный уровень', dose: '3×3–5', freq: '2×/нед', source: 'CoC-канон work (№2)', sets: 3, reps: [3, 5], restSec: 150, dayTag: 'CrushGrip', fixes: ['close_fail'], warmup: 'Разминка: лесенка 2–3 гриппера вверх', causes: ['max_strength'], minLevel: 'advanced', phase: 'strength', cues: ['Низкие повторы', 'Высокое усилие'], progression: 'Тройки → пятёрки → №2.5', equipmentAlt: ['band'] },
  { exId: 'coc_no1', protocol: 'Объёмные сеты 8–10 на №1 — работа на выносливость хвата', dose: '3×8–10', freq: '2×/нед', source: 'CoC FAQ volume', sets: 3, reps: [8, 10], restSec: 90, dayTag: 'CrushGrip', warmup: 'Разминка: гриппером легче 1×12', causes: ['volume', 'endurance'], minLevel: 'intermediate', phase: 'stability', cues: ['Без отказа', 'Ровный темп'], progression: '+1–2 повтора/нед', equipmentAlt: ['band'] },
  { exId: 'silver_bullet_hold', protocol: 'Патрон в лёгком гриппере — техника вертикали и постановки', dose: '3×10с', freq: '2×/нед', source: 'IronMind Silver техника', sets: 3, reps: [1, 1], holdSeconds: 10, restSec: 90, dayTag: 'CrushGrip', warmup: 'Разминка: лёгкий гриппер 1×10', causes: ['technique'], minLevel: 'beginner', phase: 'technique', cues: ['Вертикаль', 'Лёгкий гриппер'], progression: '+5с/нед', equipmentAlt: ['band'] },
  // ── ROUND-10 (третья ступень): причина × фаза ≥4 ──
  { exId: 'country_crush_3', protocol: 'Country Crush на максимум — удержание с жёстким корпусом (сила/стабильность)', dose: '4×1 + пауза', freq: '2×/нед', source: 'Country Crush (сила/стабильность)', sets: 4, reps: [1, 1], holdSeconds: 3, restSec: 180, dayTag: 'CrushGrip', fixes: ['close_fail'], causes: ['max_strength', 'fatigue'], minLevel: 'advanced', phase: 'stability', cues: ['Корпус жёсткий, без наклона', 'Пауза 3с на сжатии'], progression: '+2.5 кг/нед', equipmentAlt: ['grip_tool', 'band'] },
  { exId: 'country_crush_2', protocol: 'Country Crush в усталости: серия синглов на технику замыкания', dose: '5×1', freq: '3×/нед', source: 'Country Crush (усталость/техника)', sets: 5, reps: [1, 1], restSec: 120, dayTag: 'CrushGrip', fixes: ['close_fail'], causes: ['fatigue', 'technique'], minLevel: 'intermediate', phase: 'technique', cues: ['Первые 2 сета — эталон техники', 'После 3-го — только чистое замыкание'], progression: 'Держать N×1 при +2.5 кг', equipmentAlt: ['grip_tool', 'band'] },
  { exId: 'coc_no1', protocol: 'Стабильность хруста: 6×1 на №1 с паузой 3с (одинаковое замыкание)', dose: '6×1', freq: '3×/нед', source: 'CoC FAQ (стабильность)', sets: 6, reps: [1, 1], holdSeconds: 3, restSec: 90, dayTag: 'CrushGrip', fixes: ['close_fail'], causes: ['technique', 'fatigue'], minLevel: 'intermediate', phase: 'stability', cues: ['Замыкание до касания ручек', 'Пауза 3с без дрожи'], progression: '+1 сет/нед до 8', equipmentAlt: ['band', 'grip_tool'] },
  { exId: 'coc_no2', protocol: 'CoC №2 с паузой 2с в раскрытии — мобильность кисти + техника замыкания', dose: '3×3', freq: '2×/нед', source: 'CoC FAQ (мобильность/техника)', sets: 3, reps: [3, 3], holdSeconds: 2, restSec: 120, dayTag: 'CrushGrip', fixes: ['close_fail'], causes: ['mobility', 'technique'], minLevel: 'advanced', phase: 'technique', cues: ['Полное раскрытие до конца', 'Замыкание без «переката» в ладони'], progression: '+1 повтор/нед при полном раскрытии', equipmentAlt: ['band', 'grip_tool'] },
];
...
const ENDURANCE: PoolEntry[] = [
  ...
  { exId: 'fat_gripz_curl', protocol: 'Fat Gripz: сгибания на технику при усталости (щадяще)', dose: '3×12', freq: '2×/нед', source: 'AUSA Fat Gripz (fatigue)', sets: 3, reps: [10, 12], restSec: 90, dayTag: 'SupportGrip', fixes: ['mid', 'hold_short'], warmup: 'Разминка: лёгкие сжимания 1×15', causes: ['fatigue'], minLevel: 'beginner', phase: 'technique', cues: ['Накладки 50мм', 'Без отказа, только техника'], progression: '+1–2 повтора/нед', equipmentAlt: ['dumbbell'], gentle: true },
];
...
const BASE_POOL: Record<ArmliftWeakLink, PoolEntry[]> = {
  ...
  conditioning: [
    { exId: 'wrist_ext_bb', protocol: 'Минимальная нагрузка, без провокации боли', dose: '2×15', freq: 'ежедневно', source: 'Rehab-практика', sets: 2, reps: [15, 15], restSec: 60, dayTag: 'SupportGrip', equipmentAlt: ['dumbbell', 'band'] },
    { exId: 'wrist_roller', protocol: 'Пустой валик, только кровоток', dose: '2 подъёма', freq: 'ежедневно', source: 'Rehab-практика', sets: 2, reps: [1, 2], restSec: 60, dayTag: 'SupportGrip', equipmentAlt: ['cable'] },
    { exId: 'plate_pinch_hold', protocol: 'Техника щипка с 50% веса, без боли', dose: '2×15с', freq: 'по готовности', source: 'Return-to-play', sets: 2, reps: [1, 1], holdSeconds: 15, restSec: 90, dayTag: 'PinchGrip', equipmentAlt: ['dumbbell'] },
  ],
};
