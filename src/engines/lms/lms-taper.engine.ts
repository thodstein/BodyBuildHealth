...
/**
 * Примечание: описания режимов тапера для UI живут в TAPER_MODE_LABELS/подсказках
 * PLCompetitionTab. Ранее здесь был экспорт TAPER_MODE_DESCS — удалён (0 потребителей,
 * держать «второй словарь» опасно: доки ошибочно числили его залоченным тестами).
 */
