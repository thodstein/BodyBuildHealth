...
export const SPLIT_PATTERNS: SplitPattern[] = [
  ...
  {
    id: 'female_lower_upper_4',
    name: 'Женский Низ+Верх 4×/нед',
    rotationDays: 7, sessionsPerRotation: 4,
    schedule: [
      { kind: 'тренировка', character: 'тяж', sessionTag: 'Glutes' },
      { kind: 'тренировка', character: 'тяж', sessionTag: 'Upper' },
    ...
    level: ['beginner', 'intermediate', 'advanced'],
    description: 'Женский низ-доминантный сплит 4×/нед: 2 glute-сессии (Glutes + GlutesHams) + Lower (памп ягодицы/квадры) + Upper для баланса. Ягодичные 3×/нед, база и акцент на нижнюю часть (Schoenfeld 2016, Kassiano 2024).',
    direction: 'bodybuilding',
  },
  {
    id: 'female_bikini_5',
    name: 'Женский Bikini 5×/нед',
    rotationDays: 7, sessionsPerRotation: 5,
    schedule: [
      { kind: 'тренировка', character: 'тяж', sessionTag: 'ShouldersArms' },
      { kind: 'тренировка', character: 'тяж', sessionTag: 'Glutes' },
      { kind: 'тренировка', character: 'тяж', sessionTag: 'Pull' },
      { kind: 'тренировка', character: 'памп', sessionTag: 'GlutesHams' },
      { kind: 'тренировка', character: 'памп', sessionTag: 'Legs' },
      { kind: 'отдых', character: null },
      { kind: 'отдых', character: null },
    ],
    level: ['intermediate', 'advanced', 'enhanced'],
    description: 'Bikini-пропорции 5×/нед: плечи+руки, ягодицы 3×/нед (Glutes/GlutesHams/Legs), спина-ширина (Pull), квадры (Legs). Свип-силуэт: дельты+спина ширина вверху, ягодицы+квадры внизу (IFBB Bikini-критерии, Schoenfeld 2016).',
    direction: 'bodybuilding',
  },
  {
    id: 'female_wellness_5',
    name: 'Женский Wellness 5×/нед',
    rotationDays: 7, sessionsPerRotation: 5,
    schedule: [
      { kind: 'тренировка', character: 'тяж', sessionTag: 'Legs' },
      { kind: 'тренировка', character: 'тяж', sessionTag: 'Glutes' },
    ...
    level: ['intermediate', 'advanced', 'enhanced'],
    description: 'Wellness-низ-доминанта 5×/нед: 4 сессии низа (Legs/Glutes/GlutesHams/Lower) + 1 Upper. Акцент квадры+ягодицы+хамсы с сохранением баланса верх (IFBB Wellness-критерии, Plotkin 2023).',
    direction: 'bodybuilding',
  },
  {
    id: 'female_upper_glute_4',
    name: 'Женский Верх+Ягодицы 4×/нед',
    rotationDays: 7, sessionsPerRotation: 4,
    schedule: [
      { kind: 'тренировка', character: 'тяж', sessionTag: 'Upper' },
      { kind: 'тренировка', character: 'тяж', sessionTag: 'Glutes' },
    ...
    level: ['beginner', 'intermediate', 'advanced'],
    description: 'Компактный женский сплит 4×/нед: верх + ягодицы 2×/нед (Glutes + GlutesHams памп) + Pull. Для занятых — мало дней, но акцент на ягодицы и плечи-ширину (Schoenfeld 2016).',
    direction: 'bodybuilding',
  },
];
