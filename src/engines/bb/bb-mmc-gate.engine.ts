 ...
 *
 * Наука (Calatayud; Schoenfeld 2018: внутренний +12.4% vs +6.9% на бицепсе, на квадрах
 * у нетренированных — ноль; Nuckols/SBS): внутренний фокус повышает ЭМГ
 ...
 * 2025-уточнения: у тренированных внутренний НЕ меняет ЭМГ жима от сессии к сессии
 * (Nascimento: опыт гасит эффект на базе); на пек-деке внутренний держит +ЭМГ все
 * сессии без прогрессии (поддержание, не рост); выносливость — внешний (Grgic d=0.58).
