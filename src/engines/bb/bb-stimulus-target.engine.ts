...
export const EXERCISE_STIMULUS_DB: ExerciseStimulus[] = [
  ...
  {
    key: 'close_press',
    ids: ['bench_closegrip', 'close_grip_bench'],
    nameRe: [/узким хватом/i, /close.?grip/i, /narrow/i],
    headsHit: ['triceps_lateral'],
    headsPartial: ['chest_mid'],
    alternativesForMissed: { triceps_long: ['Французский жим лёжа', 'Разгибания из-за головы'] },
    setup: ['Хват на ширине плеч (не уже — запястья)', 'Локти вдоль тела', 'Опускание на низ груди'],
    resistanceLine: 'База латеральной головки. Локти в стороны превращают его в обычный жим на грудь',
    peakPoint: 'mid',
    needsPause: false,
    stability: 'med',
    cheating: [
      { deviation: 'локти в стороны', steals: 'середина груди и плечи вместо трицепса' },
      { deviation: 'слишком узкий хват', steals: 'запястья (боль вместо стимула)' },
    ],
    rirTarget: [2, 3],
    rom: 'Низ груди ↔ выпрямление без блокировки',
  },
  {
    key: 'dips_tri',
    ids: ['dips_tricep', 'bench_dips'],
    nameRe: [/трицепсовый стиль/i, /обратные отжимания/i, /dips_tricep/i, /bench_dips/i],
    headsHit: ['triceps_lateral'],
    alternativesForMissed: { triceps_long: ['Французский жим лёжа'] },
    setup: ['Корпус строго вертикально', 'Локти назад вдоль тела', 'Опускание до 90° в локтях'],
    resistanceLine: 'Вертикаль = трицепс, наклон = грудь. Одно и то же движение — разный стимул по корпусу',
    peakPoint: 'lengthened',
    needsPause: false,
    stability: 'med',
    cheating: [
      { deviation: 'наклон вперёд', steals: 'низ груди вместо трицепса' },
      { deviation: 'неполное опускание', steals: 'теряется растянутая позиция' },
    ],
    rirTarget: [1, 3],
    rom: 'Глубокое опускание ↔ выпрямление',
  },
  {
    key: 'incline_curl',
  ...
  {
    key: 'pushup_flat',
    ids: ['pushup', 'pushup_wide'],
    nameRe: [/отжимания от пола/i, /широкие отжимания/i, /pushup/i],
    headsHit: ['chest_mid'],
    headsPartial: ['triceps_lateral'],
    alternativesForMissed: { chest_upper: ['Жим на наклонной 30° (ноги выше)'] },
    setup: ['Тело ровной планкой, ягодицы напряжены', 'Локти под 45° (не 90°)', 'Грудь к полу, полная амплитуда'],
    resistanceLine: 'Домашний жим лёжа. Ноги на возвышении смещают акцент вверх, узкая постановка — в трицепс',
    peakPoint: 'lengthened',
    needsPause: false,
    stability: 'med',
    cheating: [
      { deviation: 'локти 90° в стороны', steals: 'плечевой сустав вместо груди' },
      { deviation: 'провисание поясницы', steals: 'поясница вместо груди' },
      { deviation: 'короткая амплитуда сверху', steals: 'теряется растяжение груди' },
    ],
    rirTarget: [1, 3],
    rom: 'Грудь к полу ↔ выпрямление',
  },
  {
    key: 'dips_decline',
    ids: ['dips_chest', 'decline_bar', 'decline_db'],
    nameRe: [/брусья(?!.*трицепс)/i, /dips(?!_tricep)/i, /отрицательн/i, /decline/i],
  ...
  },
  {
    key: 'deadlift_pull',
    ids: ['deadlift'],
    nameRe: [/становая(?!.*сумо)/i, /deadlift/i],
    headsHit: ['hamstrings'],
    headsPartial: ['back_thickness', 'glutes'],
    setup: ['Спина нейтраль весь подход', 'Таз ниже плеч, грудь вперёд', 'Гриф скользит по ногам'],
    resistanceLine: 'Задняя цепь целиком, но это сила, а не изоляция: для гипертрофии бицепса бедра RDL точнее, для спины — тяги',
    peakPoint: 'lengthened',
    needsPause: false,
    stability: 'high',
    cheating: [
      { deviation: 'кругление поясницы', steals: 'межпозвоночные диски (травма вместо задней цепи)' },
      { deviation: 'гриф далеко от ног', steals: 'поясница вместо ног' },
      { deviation: 'рывок с пола', steals: 'техника разваливается — сбрось вес' },
    ],
    rirTarget: [2, 3],
    rom: 'Пол с паузой-натяжением ↔ полное выпрямление',
  },
  {
    key: 'leg_curl_iso',
