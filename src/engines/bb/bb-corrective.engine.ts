...
export const BB_CORRECTIVES: BBCorrective[] = [
  ...
  // ── ROUND-10: домашний зал (dumbbell/bodyweight) — у 7 зон был лишь 1 вариант ──
  c('dm-home-single-raise', 'Махи одной рукой с опорой (домашний зал)', 'lateral_raise_single', ['delt_mid', 'shoulders'], ['activation', 'volume'], 'technique', 'any',
    { sets: 3, repsMin: 12, repsMax: 15, rir: 1, tempo: '3-1-2-0', restSec: 60, freqPerWeek: 2 },
    ['Опора второй рукой — корпус не раскачивается', 'Ведёшь локтем, не кистью', 'Опускание 2с'],
    'Вес +1 шаг при 15', 'Махи с резиной', 'Средняя дельта: +повторы за 3 нед', 'Schoenfeld (постоянное натяжение)', ['cable_lateral']),
  c('dr-home-rear-db', 'Разведения в наклоне с гантелями (задняя дельта)', 'rear_delt_fly_v2', ['delt_rear', 'shoulders'], ['activation', 'volume'], 'technique', 'any',
    { sets: 3, repsMin: 12, repsMax: 15, rir: 2, tempo: '3-1-2-0', restSec: 60, freqPerWeek: 2 },
    ['Корпус почти параллельно полу', 'Разведение по дуге', 'Без рывка корпусом'],
    'Вес +1 шаг при 15', 'Разведения с резиной', 'Задняя дельта: +повторы за 3 нед', 'NSCA (ретракция/posterior delt)', ['band_facepull']),
  c('cu-home-incline-pushup', 'Отжимания с наклоном (верх груди, домашний зал)', 'pushup_incline', ['chest_upper', 'chest'], ['activation', 'volume'], 'technique', 'any',
    { sets: 3, repsMin: 10, repsMax: 15, rir: 1, tempo: '3-1-1-0', restSec: 75, freqPerWeek: 2 },
    ['Стопы на возвышении, руки чуть шире плеч', 'Лопатки сведены, грудь к опоре', 'Без провала поясницы'],
    'Стопы выше / доб. вес', 'Отжимания от пола', 'Верх груди: +повторы за 3 нед', 'Noteboom 2024 (угол)', ['incline_db']),
  c('bw-home-pullup', 'Подтягивания (ширина спины, домашний зал)', 'pullup', ['back_width', 'back'], ['volume', 'activation'], 'strength', 'any',
    { sets: 4, repsMin: 5, repsMax: 10, rir: 1, tempo: '3-1-1-0', restSec: 120, freqPerWeek: 2 },
    ['Локти вниз, грудь к перекладине', 'Без раскачки', 'Полная амплитуда (или резина в помощь)'],
    'Строгие +1 повтор/нед', 'Тяга блока/резины', 'Ширина спины: +повторы за 3 нед', 'Schoenfeld lengthened', ['pullup_neutral']),
  c('tri-home-overhead-db-both', 'Разгибание из-за головы двумя руками (домашний зал)', 'overhead_tricep_db_both', ['triceps'], ['volume', 'activation'], 'strength', 'any',
    { sets: 3, repsMin: 10, repsMax: 12, rir: 1, tempo: '3-1-2-0', restSec: 75, freqPerWeek: 2 },
    ['Одна гантель двумя руками, локти вперёд', 'Пауза 1с в растянутой', 'Без разведения локтей'],
    'Вес +1 шаг при 12', 'Разгибание с резиной', 'Трицепс: +повторы за 3 нед', 'Maeo lengthened', ['overhead_tricep_ext']),
  c('cv-home-standing-calf', 'Подъём на носки стоя у опоры (свой вес)', 'standing_calf', ['calves'], ['volume'], 'stability', 'any',
    { sets: 3, repsMin: 15, repsMax: 20, rir: 0, tempo: '2-2-1-0', restSec: 45, freqPerWeek: 3 },
    ['Опора рукой — только баланс', 'Полная амплитуда, пауза 2с внизу', 'Без пружины'],
    'Одна нога / рюкзак', 'Подъём на носки сидя', 'Икры: +повторы за 3 нед', 'Schoenfeld (икры часто)', ['calf_raise']),
  c('fa-home-wrist-db', 'Сгибание кисти с гантелью (предплечья, домашний зал)', 'curl_wrist_db', ['forearms'], ['volume'], 'stability', 'any',
