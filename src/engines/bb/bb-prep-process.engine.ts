...
export const PREP_LAB_PANEL: PrepLabItem[] = [
  ...
  { name: 'RED-S-панель (женщины): ТТГ/св.Т4, ЛГ/ФСГ, эстрадиол, ферритин, IGF-1, кортизол, SHBG', when: 'До + середина + пост-шоу', why: 'IOC REDs CAT2 / Triad 2025: аменорея, низкие T3/IGF-1 — маркеры энергодефицита; восстановление 1–6 мес, +300–600 ккал/день.' },
