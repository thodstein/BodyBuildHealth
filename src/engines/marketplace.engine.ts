...
export const MOCK_MARKETPLACE_DB: MarketplaceItem[] = [
  {
    ...
    synergy: '+Небилет: АД/ЧСС контроль',
    purchaseOptions: [
  ...
  },
  {
    ...
    mechanisms: ['hepatic_3', 'hepatic_2'],
    synergy: '+TUDCA: гепатопротекция',
    purchaseOptions: [
  ...
  },
  {
    ...
    category: 'supplement',
    dailyDose: '400 мг вечер',
    mechanisms: ['neuro_2', 'neuro_3'],
    synergy: '+L-теанин: сон/стресс',
    purchaseOptions: [
