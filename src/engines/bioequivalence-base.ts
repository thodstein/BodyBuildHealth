...
export const FORM_PROFILES: Record<string, FormProfile> = {
  ...
  // ── ВИТАМИНЫ B ──
  b12_methyl_form: {
    id: 'b12_methyl_form', name: 'B12 метилкобаламин (активная форма)',
    type: 'active_form', elementalFactor: 1.0, bioavailability: 0.55,
    absorptionNotes: 'Активная форма, не требует конверсии в печени',
    bestTakenWith: 'anytime', preferredFor: ['MTHFR мутация', 'Нейропатия', 'Веганы'],
    advantages: ['Не требует конверсии', 'Лучше для MTHFR'],
    disadvantages: ['Дороже цианкобаламина'],
    notes: '500-1000 мкг/день. Сублингвально ×3 эффективнее.',
    evidence: 'A',
  },
  b12_cyano_form: {
    id: 'b12_cyano_form', name: 'B12 цианокобаламин',
    type: 'standardized_extract', elementalFactor: 1.0, bioavailability: 0.02,
    absorptionNotes: 'Пассивная диффузия ~1-2%. При высоких дозах (1000+ мкг) достаточно для коррекции',
    bestTakenWith: 'anytime', preferredFor: ['Бюджет'],
    advantages: ['Дёшево', 'Стабильная форма'],
    disadvantages: ['Биодоступность 2%', 'Нужна конверсия в печени'],
    notes: '1000 мкг цианокобаламина = ~20 мкг усвоится. Достаточно для коррекции дефицита.',
    evidence: 'A',
  },
  b12_hydroxo_form: {
    id: 'b12_hydroxo_form', name: 'B12 гидроксокобаламин',
    type: 'standardized_extract', elementalFactor: 1.0, bioavailability: 0.40,
    absorptionNotes: 'Промежуточная биодоступность между циано и метил',
    bestTakenWith: 'anytime', preferredFor: ['Детокс (связывает цианид)'],
    advantages: ['Длительный T½', 'Связывает цианид'],
    disadvantages: ['Дороже циано'],
    notes: '1000 мкг/день.',
    evidence: 'B',
  },
  folate_mthf_form: {
    id: 'folate_mthf_form', name: 'Фолат 5-MTHF (метилфолат)',
    type: 'active_form', elementalFactor: 1.0, bioavailability: 0.95,
    absorptionNotes: 'Активная форма, не требует DHFR конверсии',
    bestTakenWith: 'anytime', preferredFor: ['MTHFR мутация', 'Беременность'],
    advantages: ['Не требует конверсии', 'Безопасен при MTHFR'],
    disadvantages: ['Дороже фолиевой кислоты'],
    notes: '400-800 мкг/день. НЕ фолиевая кислота!',
    evidence: 'A',
  },
  folate_fa_form: {
    id: 'folate_fa_form', name: 'Фолиевая кислота (синтетическая)',
    type: 'standardized_extract', elementalFactor: 1.0, bioavailability: 0.50,
    absorptionNotes: 'Требует DHFR конверсии. При MTHFR homo → только 30%',
    bestTakenWith: 'with_food', preferredFor: ['Бюджет'],
    advantages: ['Дёшево'],
    disadvantages: ['ОПАСНО при MTHFR мутации', 'Может маскировать B12 дефицит'],
    notes: '⚠ Только при подтверждённом отсутствии MTHFR мутации!',
    evidence: 'A',
  },
  b6_p5p_form: {
    id: 'b6_p5p_form', name: 'B6 пиридоксаль-5-фосфат (P5P)',
    type: 'active_form', elementalFactor: 1.0, bioavailability: 0.95,
    absorptionNotes: 'Активная форма, не требует конверсии в печени',
    bestTakenWith: 'anytime', preferredFor: ['Заболевания печени', 'MTHFR'],
    advantages: ['Не требует конверсии', 'Безопаснее при высоких дозах'],
    disadvantages: ['Дороже пиридоксина'],
    notes: '50-100 мг/день. UL 100 мг (периферическая нейропатия при >200 мг).',
    evidence: 'A',
  },
  // ── МИНЕРАЛЫ ──
  se_selenomethionine_form: {
    id: 'se_selenomethionine_form', name: 'Селен селенометионин',
    type: 'chelate', elementalFactor: 0.40, bioavailability: 0.90,
    absorptionNotes: 'Органическая форма, встраивается в белки вместо метионина',
    bestTakenWith: 'with_food', preferredFor: ['Иммунитет', 'Щитовидная железа'],
    advantages: ['90% биодоступность', 'Длительный T½'],
    disadvantages: ['Дороже селенита'],
    notes: '100-200 мкг/день. UL 400 мкг.',
    evidence: 'A',
  },
  cr_picolinate_form: {
    id: 'cr_picolinate_form', name: 'Хром пиколинат',
    type: 'chelate', elementalFactor: 0.12, bioavailability: 0.40,
    absorptionNotes: 'Пиколиновая кислота улучшает абсорбцию',
    bestTakenWith: 'with_food', preferredFor: ['Инсулинорезистентность'],
    advantages: ['Хорошая абсорбция'],
    disadvantages: ['⚠ Только при инсулине!'],
    notes: '200-1000 мкг/день. Без инсулина — избыточно.',
    evidence: 'B',
  },
  iodine_ki_form: {
    id: 'iodine_ki_form', name: 'Йодид калия (KI)',
    type: 'salt', elementalFactor: 0.76, bioavailability: 0.90,
    absorptionNotes: 'Высокая биодоступность, быстрая абсорбция',
    bestTakenWith: 'with_food', preferredFor: ['Щитовидная железа'],
    advantages: ['90% биодоступность', 'Стабильная форма'],
    disadvantages: ['Риск при гипертиреозе'],
    notes: '150-500 мкг/день. UL 1100 мкг.',
    evidence: 'A',
  },
  // ── АНТИОКСИДАНТЫ ──
  glutathione_lipo_form: {
    id: 'glutathione_lipo_form', name: 'Глутатион липосомальный',
    type: 'liposomal', elementalFactor: 1.0, bioavailability: 0.85,
    absorptionNotes: 'Липосомы защищают от разрушения в ЖКТ',
    bestTakenWith: 'empty_stomach', preferredFor: ['Детокс', 'Печень', 'Антиоксидант'],
    advantages: ['85% биодоступность vs 10% восстановленного'],
    disadvantages: ['Дорого'],
    notes: '250-500 мг/день натощак.',
    evidence: 'B',
  },
  glutathione_reduced_form: {
    id: 'glutathione_reduced_form', name: 'Глутатион восстановленный (GSH)',
    type: 'standardized_extract', elementalFactor: 1.0, bioavailability: 0.10,
    absorptionNotes: 'Разрушается в ЖКТ. NAC эффективнее как предшественник.',
    bestTakenWith: 'empty_stomach', preferredFor: ['Нет'],
    advantages: ['Дёшево'],
    disadvantages: ['Биодоступность 10%', 'NAC эффективнее'],
    notes: 'NAC 600-1200 мг эффективнее как источник глутатиона.',
    evidence: 'A',
  },
  nmn_sublingual_form: {
    id: 'nmn_sublingual_form', name: 'NMN сублингвальный',
    type: 'active_form', elementalFactor: 1.0, bioavailability: 0.80,
    absorptionNotes: 'Сублингвальный путь минует first-pass метаболизм',
    bestTakenWith: 'empty_stomach', preferredFor: ['Антивозрастной', 'NAD+'],
    advantages: ['80% биодоступность', 'Быстрое повышение NAD+'],
    disadvantages: ['Очень дорого'],
    notes: '250-500 мг/день сублингвально.',
    evidence: 'B',
  },
  // ── ПОЛИФЕНОЛЫ ──
  quercetin_phytosome_form: {
    id: 'quercetin_phytosome_form', name: 'Кверцетин фитосома',
    type: 'liposomal', elementalFactor: 1.0, bioavailability: 0.50,
    absorptionNotes: 'Фосфолипидная оболочка ↑ абсорбцию в 10-20× vs стандарт',
    bestTakenWith: 'with_food', preferredFor: ['Противовоспалительное', 'Антигистаминное'],
    advantages: ['50% биодоступность vs 2% стандартного'],
    disadvantages: ['Дорого'],
    notes: '500 мг 2 р/день.',
    evidence: 'B',
  },
  // ── КОЛЛАГЕН ──
  collagen_peptides_form: {
    id: 'collagen_peptides_form', name: 'Коллагеновые пептиды (гидролизат)',
    type: 'standardized_extract', elementalFactor: 1.0, bioavailability: 0.85,
    absorptionNotes: 'Гидролизованные пептиды 2-5 кДа, быстрая абсорбция',
    bestTakenWith: 'anytime', preferredFor: ['Суставы', 'Кожа', 'Кости'],
    advantages: ['85% биодоступность', 'С вит. C → синтез коллагена'],
    disadvantages: ['Неполный аминокислотный профиль'],
    notes: '5-10 г/день. С витамином C для синтеза.',
    evidence: 'A',
  },
  hyaluronic_oral_form: {
    id: 'hyaluronic_oral_form', name: 'Гиалуроновая кислота пероральная',
    type: 'standardized_extract', elementalFactor: 1.0, bioavailability: 0.10,
    absorptionNotes: 'Низкая пероральная биодоступность. Инъекционная — значительно лучше.',
    bestTakenWith: 'with_food', preferredFor: ['Суставы (перорально)'],
    advantages: ['Дёшево'],
    disadvantages: ['Биодоступность 10%', 'Инъекционная значительно эффективнее'],
    notes: '100-200 мг/день. С вит. C.',
    evidence: 'B',
  },
};
