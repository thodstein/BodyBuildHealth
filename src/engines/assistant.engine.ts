...
const QA_DB: QAPair[] = [
  ...
  { q:'Как восстановить тестостерон после курса?', a:'ПКТ: кломифен 50→25 мг/день 4 нед + HCG 500 МЕ 2р/нед, 3/1. Цинк 30 мг, селен 100 мкг, вит.E 400 МЕ. Контроль TT/LH/FSH через 6 нед.', tags:['pct','clomiphene','hcg','recovery'] },
  ...
  { q:'Как проводится ПКТ после длинных эфиров?', a:'ПКТ начинается через 14-18 дней после последней инъекции длинного эфира (тестостерон энантат). Схема: кломифен 50мг/день 2 нед → 25мг/день 2 нед. HCG 500 МЕ 2р/нед, 3/1 до ПКТ. Тамоксифен 10мг/день как альтернатива. Контроль гормонов через 3-4 нед.', tags:['pct','clomiphene','hcg','enanthate','recovery'] },
