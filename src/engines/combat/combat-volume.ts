...
export const COMBAT_LANDMARKS: Record<Level, Record<string, Landmarks>> = {
  beginner: {
    ...
    plyo: { mev: 2, mav: 4, mrv: 6 },
    unilateral: { mev: 3, mav: 6, mrv: 10 },
  ...
  intermediate: {
    ...
    plyo: { mev: 3, mav: 5, mrv: 8 },
    unilateral: { mev: 4, mav: 8, mrv: 12 },
  ...
  advanced: {
    ...
    plyo: { mev: 4, mav: 6, mrv: 10 },
    unilateral: { mev: 4, mav: 8, mrv: 14 },
  ...
  enhanced: {
    ...
    plyo: { mev: 4, mav: 8, mrv: 12 },
    unilateral: { mev: 6, mav: 10, mrv: 16 },
