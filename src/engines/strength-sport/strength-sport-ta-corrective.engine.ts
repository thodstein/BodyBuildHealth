...
export const TA_CORRECTIVES: TACorrectiveExercise[] = [
  ...
  // ── ROUND-10 (причина × фаза ≥3): добор тонких ячеек ──
  P('clean_pull_v2', 'Тяга взятийная объёмом (техника)', ['clean_off_floor', 'clean_mid'],
    ['early_pull', 'bar_forward'], ['volume', 'technique'], 'novice', 'technique',
    { sets: 4, reps: 3, pct: 65, rir: 3, tempo: 'X-1-X-0', restSeconds: 120 },
    ['Одинаковый старт все сеты', 'Гриф по бёдрам, локти прямые', 'Финиш вертикально'],
    'Объём тяг → классика с тем же кью', 'Тяга с паузой 2с', 'Catalyst volume; Everett'),
  P('overhead_squat', 'Оверхед-сед объёмом (стабильность)', ['snatch_catch', 'snatch_overhead'],
    ['unstable_overhead', 'chest_collapse'], ['volume', 'technique'], 'intermediate', 'stability',
    { sets: 3, reps: 5, pct: 50, rir: 3, tempo: '3-1-1-0', restSeconds: 120 },
    ['Лопатки вместе, рёбра вниз', 'Гриф над серединой стопы', 'Без спешки вниз'],
    'Пауза 2с внизу → вес +5%', 'Оверхед-сед с палкой', 'T-spine stability volume'),
  P('smith_split_squat', 'Сплит-присед в Смите (щадящая разножка)', ['squat_bottom', 'squat_mid'],
    ['split_short', 'chest_collapse'], ['fatigue'], 'novice', 'strength',
    { sets: 3, reps: 5, pct: 55, rir: 3, tempo: '2-1-1-0', restSeconds: 120 },
    ['Разножка ровная, траектория задана', 'Таз между стоп', 'Без рывка из низа'],
    '+2.5%/нед при чистой разножке', 'Сплит без веса у стойки', 'Big Bend (fatigue-friendly)'),
  P('squat_overhead', 'Оверхед-удержание/сед при усталости (стабильность)', ['snatch_overhead', 'snatch_catch'],
    ['unstable_overhead', 'soft_catch'], ['fatigue'], 'novice', 'stability',
    { sets: 3, reps: 8, pct: 20, rir: 3, tempo: 'X-2-X-0', restSeconds: 60 },
    ['Рёбра вниз, палка неподвижна', 'Дыхание ровное', 'Стоп при потере контроля'],
    'Дольше удержание → оверхед-сед', 'Кошка-верблюд', 'T-spine/core stability (fatigue)'),
  P('snatch', 'Рывок классический объёмом (сила + объём)', ['snatch_off_floor', 'snatch_mid'],
    ['early_pull', 'bar_forward', 'weak_extension'], ['volume', 'strength'], 'intermediate', 'strength',
    { sets: 5, reps: 3, pct: 70, rir: 2, tempo: 'X-0-X-0', restSeconds: 150 },
    ['Одинаковая скорость всех троек', 'Гриф по бёдрам', 'Финиш без дожима'],
    '+2.5%/нед до 5×3 @75%', 'Рывок с паузой у пола', 'Catalyst volume; Everett'),
  P('kb_snatch', 'Рывок гирей (мобильность + техника)', ['snatch_mid', 'snatch_pull_under'],
    ['early_pull', 'slow_turnover'], ['mobility', 'technique'], 'novice', 'technique',
    { sets: 3, reps: 6, pct: 40, rir: 3, tempo: 'X-1-X-0', restSeconds: 90 },
    ['Держи гирю близко', 'Уход без спешки', 'Дыхание ровное'],
    'Дольше чисто → гиря тяжелее', 'Рывок с палкой', 'KB-перенос (мобильность)'),
  P('deadlift_snatch_grip', 'Становая рывковым хватом (щадящая техника старта)', ['pull_lockout', 'snatch_off_floor'],
    ['hips_rise', 'chest_collapse'], ['fatigue', 'technique'], 'novice', 'technique',
    { sets: 3, reps: 4, pct: 55, rir: 3, tempo: 'X-1-X-0', restSeconds: 120 },
    ['Спина одним углом', 'Старт ногами, не спиной', 'Стоп при «плывущей» нейтрали'],
    'До 60% → классика с тем же кью', 'Тяга с паузой у пола', 'NSCA (fatigue-friendly)'),
  // ── ROUND-10 (третья ступень): каждая причина-лимитер × фаза ≥4 ──
  P('snatch_pause_knee', 'Рывок с паузой у колена (объём в технике, щадящая усталость)', ['snatch_off_floor', 'clean_off_floor'],
    ['early_pull', 'hips_rise'], ['volume', 'technique', 'mobility', 'fatigue'], 'novice', 'technique',
    { sets: 5, reps: 2, pct: 60, rir: 3, tempo: 'X-2-X-0', restSeconds: 120 },
    ['Пауза 2с у колена — поза держится', 'Плечи над грифом, спина одним углом', 'Уход в полусед без спешки'],
    '+2.5% при чистой позе паузы', 'Пауза у колена без отрыва (только поза)', 'Catalyst (объём техники, fatigue-friendly)'),
  P('clean_volume_pull', 'Силовые подъёмы-тяги объёмом (сила + переносимость)', ['squat_mid', 'clean_mid'],
    ['hips_rise', 'slow_turnover'], ['volume', 'strength', 'fatigue'], 'intermediate', 'strength',
    { sets: 5, reps: 3, pct: 72, rir: 2, tempo: 'X-1-X-0', restSeconds: 150 },
    ['Скорость грифа ровная от пола', 'Толкай пол, не тяни спиной', 'Шум броска — контроль не потерян'],
    '+2.5–5 кг/нед при ровной скорости', 'Меньше подходов ×2 репа', 'Everett (объём тяг) / Онлайн-канон'),
  P('catch_series_ta', 'Серии приёма в усталости: стабильность под утомлением', ['snatch_catch', 'clean_catch'],
    ['soft_catch', 'slow_turnover', 'bar_forward'], ['volume', 'fatigue', 'technique'], 'intermediate', 'stability',
    { sets: 6, reps: 1, pct: 65, rir: 2, tempo: 'X-1-X-1', restSeconds: 90 },
    ['Каждый приём — движение вниз, не жим', 'Локти «через уши» в конце', 'Плечо над штангой в приёмe'],
    '+2.5% при N-1 чистых из N', 'Короткая серия 3×1 со паузой', 'Torokhtiy (стабильность приёма)'),
];
...
const CORRECTIVE_META: Record<string, CorrectiveMeta> = {
  ...
  clean_pull_v2: { equipment: 'barbell', fatigueCost: 7 },
  overhead_squat: { equipment: 'barbell', fatigueCost: 5 },
  smith_split_squat: { equipment: 'machine', fatigueCost: 4 },
  squat_overhead: { equipment: 'barbell', fatigueCost: 2 },
  snatch: { equipment: 'barbell', fatigueCost: 8 },
  kb_snatch: { equipment: 'kettlebell', fatigueCost: 5 },
  deadlift_snatch_grip: { equipment: 'barbell', fatigueCost: 6 },
};
...
const CORRECTIVE_HOW_NOT: Record<string, string> = {
  ...
  snatch_pause_knee: 'Не задерживать дыхание на паузе — короткий вдох, поза и вверх',
  clean_volume_pull: 'Не гнаться за весом — объём ради переносимости, скорость грифа ровная',
  catch_series_ta: 'Не добивать серию через «жим» — как только приём на руках, серия окончена',
  ...
  clean_pull_v2: 'Не сгибать руки в тяге — локти прямые до финиша',
  overhead_squat: 'Не заваливать гриф вперёд — держи над серединой стопы',
  smith_split_squat: 'Не «ездить» по траектории — разножка под гриф',
  squat_overhead: 'Не гнуть поясницу — рёбра вниз, работает грудной',
  snatch: 'Не дожимать вверху — финиш активный, руки прямые',
  kb_snatch: 'Не отпускать гирю от себя — держи близко к корпусу',
  deadlift_snatch_grip: 'Не поднимать таз раньше груди — старт ногами',
};
