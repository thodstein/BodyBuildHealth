...
export function buildMonitoringSchedule(
  ...
  baseline.push({ marker: 'Системные панели (полный набор): печень, кардио-липиды, почки+ОАМ, кровь, гормоны, метаболизм, щитовидная, витамины/минералы', reason: 'Все панели мониторинга — до курса целиком' });
