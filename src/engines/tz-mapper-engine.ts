...
export function buildMonitoringSchedule(
  ...
  baseline.push({ marker: 'Системные панели до курса — ПОЛНЫЙ список: 1) Печёночная: АЛТ, АСТ, ГГТ, ЩФ, билирубин общий/прямой, альбумин, ПТИ; 2) Кардио-липидная: ЛПНП, ЛПВП, ТГ, АпоВ, Лп(а), hs-СРБ, Д-димер, тропонин I; 3) Почечная: креатинин, рСКФ (CKD-EPI), цистатин C, мочевина, мочевая кислота, электролиты (Na⁺/K⁺/Cl⁻), белок мочи, микроальбуминурия, ОАМ (удельный вес, белок, глюкоза, эритроциты, лейкоциты); 4) Кровь: HCT, Hgb, RBC, PLT, WBC, СОЭ/ESR, ретикулоциты, ферритин, сыв. железо, коагулограмма (МНО/АЧТВ/фибриноген/D-димер); 5) Гормональная: тестостерон общ./своб., эстрадиол (чувств.), пролактин, ЛГ, ФСГ, SHBG, кортизол (утро), ДГТ, прогестерон; 6) Метаболическая: глюкоза натощак, HbA1c, инсулин, HOMA-IR, ИФР-1 (при GH), гомоцистеин, СРБ; 7) Тиреоидная: ТТГ, Т3 своб., Т4 своб., АТ-ТПО; 8) Витамины/минералы: D3 (25-OH), B12, фолат, ферритин, Mg²⁺, Zn²⁺, Se, Ca²⁺ общ., фосфор', reason: 'Все панели мониторинга с полным перечнем маркеров — сдаются до курса целиком' });
