...
const PCT_PROTOCOLS: PCTProtocol[] = [
  ...
  },
  {
    ...
    totalWeeks: 6,
    timeline: [
      { week: -3, compounds: [{ name: 'ХГЧ', dosage: '500 МЕ', frequency: '2×/нед' }], bloodWork: [], notes: 'ХГЧ за 2-3 недели ДО начала ПКТ (пока эфиры выходят). Схема 3/1: 3 нед приема, 1 нед отдыха.' },
      { week: -2, compounds: [{ name: 'ХГЧ', dosage: '500 МЕ', frequency: '2×/нед' }], bloodWork: [], notes: 'Стимуляция яичек до приёма SERM. Схема 3/1: 3 нед приема, 1 нед отдыха.' },
  ...
  },
  {
    ...
    totalWeeks: 8,
    timeline: [
      { week: -4, compounds: [{ name: 'ХГЧ', dosage: '500 МЕ', frequency: '2×/нед' }], bloodWork: [], notes: 'ХГЧ во время курса для предотвращения атрофии (на długих циклах). Схема 3/1: 3 нед приема, 1 нед отдыха.' },
      { week: -3, compounds: [{ name: 'ХГЧ', dosage: '500 МЕ', frequency: '2×/нед' }], bloodWork: [], notes: 'Схема 3/1: 3 нед приема, 1 нед отдыха.' },
      { week: -2, compounds: [{ name: 'ХГЧ', dosage: '500 МЕ', frequency: '2×/нед' }], bloodWork: [], notes: 'Увеличение дозы за 2 недели до ПКТ. Схема 3/1: 3 нед приема, 1 нед отдыха.' },
      { week: -1, compounds: [{ name: 'ХГЧ', dosage: '500 МЕ', frequency: '2×/нед' }], bloodWork: [], notes: 'Максимальная стимуляция перед SERM. Схема 3/1: 3 нед приема, 1 нед отдыха.' },
