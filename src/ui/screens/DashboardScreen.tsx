...
export const DashboardScreen: React.FC<Props> = ({ onNavigate }) => {
  ...
  return (
    ...
    <div style={{ position:'fixed', inset:0, width:'100%', height:'var(--tg-viewport-height, 100dvh)', minHeight:'var(--tg-viewport-height, 100dvh)', maxHeight:'var(--tg-viewport-height, 100dvh)', display:'flex', flexDirection:'column', overflow:'hidden', background:'#07070a', isolation:'isolate', contain:'paint' as any }}>
      <HeroImg webp="/hero-main.webp?v=20260910" src="/hero-main.png?v=20260910" alt="" decoding="async" fetchPriority={'high' as any} draggable={false} className="hero-fullscreen-img dashboard-hero-img" style={{ position:'absolute', inset:0, width:'100%', height:'100%', objectFit:'contain', objectPosition:'center top', background:'#07070a', transform:'translateZ(0)', willChange:'auto', backfaceVisibility:'hidden' as any, pointerEvents:'none' }} />
