...
export const DashboardScreen: React.FC<Props> = ({ onNavigate }) => {
  ...
  return (
    <div style={{ position:'fixed', inset:0, width:'100%', height:'100dvh', minHeight:'100dvh', display:'flex', flexDirection:'column', overflow:'hidden', background:'#07070a' }}>
      <img src="/hero-main.png?v=20250827f" alt="" className="hero-fullscreen-img" style={{ position:'absolute', inset:0, width:'100%', height:'100%', objectFit:'cover', objectPosition:'center center', background:'#07070a', filter:'saturate(1.05) contrast(1.04) brightness(1.06)' }} />
