      ...
      <div className="card" style={{ padding: 14, marginBottom: 12 }}>
        ...
        {showTargets && (
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 6, marginBottom: 8 }}>
            <div><label style={{ fontSize: 10, color: 'var(--text-dim)' }}>\u041A\u043A\u0430\u043B</label><input type="number" value={targets?.kcal ?? 2500} onChange={e => setTargets(t => t ? {...t, kcal: +e.target.value} : {kcal: +e.target.value, protein: 160, fat: 80, carbs: 300, fiber: 35, water: 2.5})} style={inputStyle} /></div>
            <div><label style={{ fontSize: 10, color: 'var(--text-dim)' }}>\u0411\u0435\u043B\u043A\u0438 (\u0433)</label><input type="number" value={targets?.protein ?? 160} onChange={e => setTargets(t => t ? {...t, protein: +e.target.value} : {kcal: 2500, protein: +e.target.value, fat: 80, carbs: 300, fiber: 35, water: 2.5})} style={inputStyle} /></div>
            <div><label style={{ fontSize: 10, color: 'var(--text-dim)' }}>\u0416\u0438\u0440\u044B (\u0433)</label><input type="number" value={targets?.fat ?? 80} onChange={e => setTargets(t => t ? {...t, fat: +e.target.value} : {kcal: 2500, protein: 160, fat: +e.target.value, carbs: 300, fiber: 35, water: 2.5})} style={inputStyle} /></div>
            <div><label style={{ fontSize: 10, color: 'var(--text-dim)' }}>\u0423\u0433\u043B\u0435\u0432\u043E\u0434\u044B (\u0433)</label><input type="number" value={targets?.carbs ?? 300} onChange={e => setTargets(t => t ? {...t, carbs: +e.target.value} : {kcal: 2500, protein: 160, fat: 80, carbs: +e.target.value, fiber: 35, water: 2.5})} style={inputStyle} /></div>
            <div><label style={{ fontSize: 10, color: 'var(--text-dim)' }}>\u041A\u043B\u0435\u0442\u0447\u0430\u0442\u043A\u0430 (\u0433)</label><input type="number" value={targets?.fiber ?? 35} onChange={e => setTargets(t => t ? {...t, fiber: +e.target.value} : {kcal: 2500, protein: 160, fat: 80, carbs: 300, fiber: +e.target.value, water: 2.5})} style={inputStyle} /></div>
            <div><label style={{ fontSize: 10, color: 'var(--text-dim)' }}>\u0412\u043E\u0434\u0430 (\u043B)</label><input type="number" step="0.1" value={targets?.water ?? 2.5} onChange={e => setTargets(t => t ? {...t, water: +e.target.value} : {kcal: 2500, protein: 160, fat: 80, carbs: 300, fiber: 35, water: +e.target.value})} style={inputStyle} /></div>
          </div>
        )}
        ...
        {showAddFood && (
          <div style={{ display: 'grid', gap: 6, marginBottom: 10 }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr 1fr', gap: 6 }}>
              <div><label style={{ fontSize: 10, color: 'var(--text-dim)' }}>\u041A\u043A\u0430\u043B</label><input type="number" value={newFood.kcal || ''} onChange={e => setNewFood({...newFood, kcal: +e.target.value})} style={inputStyle} /></div>
              <div><label style={{ fontSize: 10, color: 'var(--text-dim)' }}>\u0411\u0435\u043B\u043A\u0438</label><input type="number" value={newFood.protein || ''} onChange={e => setNewFood({...newFood, protein: +e.target.value})} style={inputStyle} /></div>
              <div><label style={{ fontSize: 10, color: 'var(--text-dim)' }}>\u0416\u0438\u0440\u044B</label><input type="number" value={newFood.fat || ''} onChange={e => setNewFood({...newFood, fat: +e.target.value})} style={inputStyle} /></div>
              <div><label style={{ fontSize: 10, color: 'var(--text-dim)' }}>\u0423\u0433\u043B\u0435\u0432\u043E\u0434\u044B</label><input type="number" value={newFood.carbs || ''} onChange={e => setNewFood({...newFood, carbs: +e.target.value})} style={inputStyle} /></div>
            </div>
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 6 }}>
              <div><label style={{ fontSize: 10, color: 'var(--text-dim)' }}>\u041A\u043B\u0435\u0442\u0447\u0430\u0442\u043A\u0430</label><input type="number" value={newFood.fiber || ''} onChange={e => setNewFood({...newFood, fiber: +e.target.value})} style={inputStyle} /></div>
