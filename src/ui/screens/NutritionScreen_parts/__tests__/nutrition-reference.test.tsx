...
describe('nutrition-reference data P0', () => {
  ...
  it('правила с числами имеют источники', () => {
    const mustHaveSource = ['Гидратация', 'Натрий и электролиты', 'Термический эффект', 'Коллаген', 'голодание', 'Сон и питание', 'Антиоксиданты', 'Старение', 'Осторожность с молочкой', 'Питание до тренировки', 'Гликемический контроль', 'Циклирование', 'Читмил', 'загрузка', 'Белково-углеводное', 'Здоровье ЖКТ', 'Обработка пищи', 'Жиры — качество', 'Сезонность', 'Женский цикл'];
