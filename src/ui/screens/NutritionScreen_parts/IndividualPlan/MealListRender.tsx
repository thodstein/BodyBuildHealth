            ...
            <div key={mi} style={{
              ...
              <div style={{
                ...
                <div style={{display:'flex',alignItems:'center',gap:7,flexWrap:'wrap'}}>
                  ...
                  {m.recipeApplied && !!m.recipeAppliedData?.appliedScale && Math.abs((m.recipeAppliedData.appliedScale||1)-1)>0.05 && <span title={`Порция рецепта масштабирована ×${(m.recipeAppliedData.appliedScale||1).toFixed(2)} к цели приёма (пропорции авторские)`} style={{fontSize:10,padding:'1px 5px',borderRadius:4,background:'rgba(139,92,246,0.12)',border:'1px solid rgba(139,92,246,0.22)',color:'#c4b5fd',fontWeight:700}}>🍳 ×{(m.recipeAppliedData.appliedScale||1).toFixed(2)}</span>}
