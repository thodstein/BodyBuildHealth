...
describe('Этап 6: бюджет-зависимые порционные лимиты (максимум = сходимость)', () => {
  it('высококалорийный план на бюджете max сходится к цели не хуже medium', () => {
    ...
    // большой углеводный бюджет добирается без «упора в порции» — отклонение ≤8%.
    // Р-2.1 (Aug 28): полы реалистичных порций (белок ≥40 г в осн. приёмах) стоят
    // ~1% углеводной точности на высококалорийных целях — задокументированная цена.
    ...
    expect(dev).toBeLessThanOrEqual(0.08);
