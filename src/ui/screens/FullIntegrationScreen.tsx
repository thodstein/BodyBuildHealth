...
export const FullIntegrationScreen: React.FC = () => {
  ...
  const labels: Record<string,string> = {calc:'🧮 Расчёты',pk:'💊 PK',stack:'📦 Стек',synergy:'⚡ Синергия',risk:'⚠ Риски',brain:'🧠 Мозг',recovery:'🔄 Восст',meal:'🍽 Питание',programs:'📋 Программы',ordering:'📐 Порядок',variation:'🔄 Вариации',coaching:'🎯 Коучинг',labs:'🧪 Лабы',tempo:'⏱ Темп',warmup:'🔥 Разминка',pipeline:'🔧 Пайплайн'};
