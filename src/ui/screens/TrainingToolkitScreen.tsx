...
export const TrainingToolkitScreen: React.FC = () => {
  ...
  const tabs = ['movement','peaking','calendar','autoreg','reps','diary'];
  const labels: Record<string,string> = {movement:'🏃 Движение',peaking:'🏔 Пикинг',calendar:'📅 Календарь',autoreg:'⚙ Авторег',reps:'🔁 Повторы',diary:'📓 Дневник'};
