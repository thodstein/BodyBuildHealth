...
const ReportsTab: React.FC<{ foodEntries: DiaryEntry[]; profile?: any; targets?: { kcal: number; protein: number; fats: number; carbs: number } }> = ({ foodEntries, profile, targets }) => {
  ...
  const reportBtn = (isActive: boolean, onClick: () => void, children: React.ReactNode) => (
    <button onClick={onClick} style={{ padding:'10px 14px', borderRadius:10, fontSize:11, cursor:'pointer', minHeight:44, border: isActive ? '1px solid #00e68a' : '1px solid rgba(255,255,255,0.06)', background: isActive ? 'linear-gradient(135deg,rgba(0,230,138,0.2),rgba(0,200,160,0.12))' : '#202023', color: isActive ? '#00e68a' : 'rgba(255,255,255,0.85)', fontWeight: isActive ? 700 : 500 }}>{children}</button>
  );
  ...
  return (<div style={{ display:'flex', flexDirection:'column', gap:8 }}>
      ...
      {data.length === 0 ? (
        ...
        <div style={{ display:'flex', flexDirection:'column', gap:6, maxHeight:'calc(100vh - 320px)', overflowY:'auto' }}>
          ...
          <div style={{ padding:'6px 10px', borderRadius:8, background:'#202023' }}>
            ...
            <div style={{ display:'flex', gap:6, marginBottom:4 }}>
              <div style={{ flex:1, background:'rgba(59,130,246,0.08)', borderRadius:6, padding:'4px 6px' }}>
                <div style={{ fontSize:9, color:'rgba(255,255,255,0.7)' }}>Базовая</div>
              ...
              <div style={{ flex:1, background:'rgba(139,92,246,0.08)', borderRadius:6, padding:'4px 6px' }}>
                <div style={{ fontSize:9, color:'rgba(255,255,255,0.7)' }}>Усиленная</div>
                <div style={{ fontSize:12, fontWeight:700, color:'#8b5cf6', display:'flex', alignItems:'center', gap:2 }}>
                  ...
                  <span style={{ fontSize:9, color:'rgba(255,255,255,0.8)', fontWeight:400 }}>({fullReport.weightDynamicsEnhanced.confidence === 'high' ? '✓' : '?'})</span>
                </div>
              </div>
            </div>
            <div style={{ fontSize:8, color:'rgba(255,255,255,0.7)', lineHeight:1.4 }}>{fullReport.weightDynamicsBasic.explanation}</div>
            {fullReport.weightDynamicsEnhanced.factors.length > 0 && <div style={{ fontSize:9, color:'rgba(255,255,255,0.9)', marginTop:2 }}>Факторы: {fullReport.weightDynamicsEnhanced.factors.join('; ')}</div>}
          </div>
          ...
          <div style={{ padding:'6px 10px', borderRadius:8, background:'#202023' }}>
            ...
            {fullReport.microDeficiencies.length > 0 && <div style={{ fontSize:9, color:'#f59e0b', marginTop:4, lineHeight:1.4 }}>Рекомендации: {fullReport.microDeficiencies.slice(0,3).join('; ')}</div>}
          </div>
          ...
          <div style={{ padding:'6px 10px', borderRadius:8, background:'#202023' }}>
            ...
            <div style={{ display:'flex', alignItems:'center', gap:6 }}>
              ...
              <div style={{ fontSize:9, color:'rgba(255,255,255,0.7)' }}>Средний тир: {fullReport.foodQualityDetails.avgTier} · {fullReport.foodQualityDetails.bestItems.length} лучших</div>
            </div>
          </div>
          ...
          <div style={{ padding:'6px 10px', borderRadius:8, background:'#202023' }}>
            ...
            <div style={{ display:'flex', gap:4, marginBottom:2 }}>
              <div style={{ flex:1, background:'rgba(6,182,212,0.06)', borderRadius:6, padding:'4px', textAlign:'center' }}>
                <div style={{ fontSize:9, color:'rgba(255,255,255,0.7)' }}>Выпито</div>
              ...
              <div style={{ flex:1, background:'rgba(6,182,212,0.06)', borderRadius:6, padding:'4px', textAlign:'center' }}>
                <div style={{ fontSize:9, color:'rgba(255,255,255,0.7)' }}>Норма</div>
                <div style={{ fontSize:11, fontWeight:700, color:'#fff' }}>{fullReport.waterBalance.targetMl} мл</div>
              </div>
              <div style={{ flex:1, background:'rgba(6,182,212,0.06)', borderRadius:6, padding:'4px', textAlign:'center' }}>
                <div style={{ fontSize:9, color:'rgba(255,255,255,0.7)' }}>мл/кг</div>
            ...
            {fullReport.waterBalance.deficitMl > 0 && <div style={{ fontSize:9, color:'#f59e0b' }}>Дефицит {fullReport.waterBalance.deficitMl} мл</div>}
            <div style={{ fontSize:9, color:'rgba(255,255,255,0.7)', marginTop:2, lineHeight:1.4 }}>{fullReport.waterBalance.recommendation}</div>
          </div>
          ...
          <div style={{ padding:'6px 10px', borderRadius:8, background:'#202023' }}>
            ...
            <div style={{ display:'flex', gap:4, marginBottom:2 }}>
              <div style={{ flex:1, background:'rgba(251,191,36,0.06)', borderRadius:6, padding:'4px', textAlign:'center' }}>
                <div style={{ fontSize:9, color:'rgba(255,255,255,0.7)' }}>Na</div>
              ...
              <div style={{ flex:1, background:'rgba(59,130,246,0.06)', borderRadius:6, padding:'4px', textAlign:'center' }}>
                <div style={{ fontSize:9, color:'rgba(255,255,255,0.7)' }}>K</div>
              ...
              <div style={{ flex:1, background:'rgba(139,92,246,0.06)', borderRadius:6, padding:'4px', textAlign:'center' }}>
                <div style={{ fontSize:9, color:'rgba(255,255,255,0.7)' }}>Na/K</div>
            ...
            <div style={{ fontSize:9, color:'rgba(255,255,255,0.7)', lineHeight:1.4 }}>{fullReport.sodiumPotassium.recommendation}</div>
          </div>
          ...
          <div style={{ padding:'6px 10px', borderRadius:8, background:'#202023' }}>
            ...
            <div style={{ display:'flex', gap:4, marginBottom:2 }}>
              <div style={{ flex:1, background:'rgba(59,130,246,0.06)', borderRadius:6, padding:'4px', textAlign:'center' }}>
                <div style={{ fontSize:9, color:'rgba(255,255,255,0.7)' }}>Равномерность</div>
              ...
              <div style={{ flex:1, background:'rgba(59,130,246,0.06)', borderRadius:6, padding:'4px', textAlign:'center' }}>
                <div style={{ fontSize:9, color:'rgba(255,255,255,0.7)' }}>Макс разрыв</div>
            ...
            {fullReport.proteinTiming.gaps.length > 0 && <div style={{ fontSize:9, color:'#f59e0b', lineHeight:1.3 }}>{fullReport.proteinTiming.gaps.slice(0, 2).join('; ')}</div>}
            <div style={{ fontSize:9, color:'rgba(255,255,255,0.7)', marginTop:2, lineHeight:1.4 }}>{fullReport.proteinTiming.recommendation}</div>
          </div>
          ...
          <div style={{ padding:'6px 10px', borderRadius:8, background:'#202023' }}>
            ...
            <div style={{ display:'flex', gap:4, marginBottom:2 }}>
              <div style={{ flex:1, background:'rgba(251,191,36,0.06)', borderRadius:6, padding:'4px', textAlign:'center' }}>
                <div style={{ fontSize:9, color:'rgba(255,255,255,0.7)' }}>Общая ГН</div>
              ...
              <div style={{ flex:1, background:'rgba(251,191,36,0.06)', borderRadius:6, padding:'4px', textAlign:'center' }}>
                <div style={{ fontSize:9, color:'rgba(255,255,255,0.7)' }}>Средний GI</div>
              ...
              <div style={{ flex:1, background:'rgba(251,191,36,0.06)', borderRadius:6, padding:'4px', textAlign:'center' }}>
                <div style={{ fontSize:9, color:'rgba(255,255,255,0.7)' }}>Макс/приём</div>
            ...
            <div style={{ fontSize:9, color:'rgba(255,255,255,0.7)', lineHeight:1.4 }}>{fullReport.glycemicLoad.recommendation}</div>
          </div>
          ...
          <div style={{ padding:'6px 10px', borderRadius:8, background:'#202023' }}>
            ...
            <div style={{ display:'flex', gap:4, marginBottom:2 }}>
              <div style={{ flex:1, background:'rgba(251,191,36,0.06)', borderRadius:6, padding:'4px', textAlign:'center' }}>
                <div style={{ fontSize:9, color:'rgba(255,255,255,0.7)' }}>Насыщ.</div>
              ...
              <div style={{ flex:1, background:'rgba(59,130,246,0.06)', borderRadius:6, padding:'4px', textAlign:'center' }}>
                <div style={{ fontSize:9, color:'rgba(255,255,255,0.7)' }}>Омега-3</div>
              ...
              <div style={{ flex:1, background:'rgba(139,92,246,0.06)', borderRadius:6, padding:'4px', textAlign:'center' }}>
                <div style={{ fontSize:9, color:'rgba(255,255,255,0.7)' }}>Ом-6/3</div>
            ...
            <div style={{ fontSize:9, color:'rgba(255,255,255,0.7)', lineHeight:1.4 }}>{fullReport.fatQuality.recommendation}</div>
          </div>
          ...
          <div style={{ padding:'6px 10px', borderRadius:8, background:'#202023' }}>
            ...
            <div style={{ fontSize:9, color:'rgba(255,255,255,0.7)', lineHeight:1.4 }}>{fullReport.mealTiming.recommendation}</div>
          </div>
          ...
          <div style={{ padding:'6px 10px', borderRadius:8, background:'#202023' }}>
            ...
            <div style={{ display:'flex', gap:4, alignItems:'center' }}>
              <div style={{ flex:1, background:'rgba(34,197,94,0.06)', borderRadius:6, padding:'4px', textAlign:'center' }}>
                <div style={{ fontSize:9, color:'rgba(255,255,255,0.7)' }}>Факт</div>
              ...
              <div style={{ flex:1, background:'rgba(34,197,94,0.06)', borderRadius:6, padding:'4px', textAlign:'center' }}>
                <div style={{ fontSize:9, color:'rgba(255,255,255,0.7)' }}>Цель</div>
                <div style={{ fontSize:11, fontWeight:700, color:'#fff' }}>{fullReport.fiberAnalysis.targetG}г</div>
              </div>
              <div style={{ flex:1, background:'rgba(34,197,94,0.06)', borderRadius:6, padding:'4px', textAlign:'center' }}>
                <div style={{ fontSize:9, color:'rgba(255,255,255,0.7)' }}>%</div>
            ...
            <div style={{ fontSize:9, color:'rgba(255,255,255,0.7)', marginTop:2, lineHeight:1.4 }}>{fullReport.fiberAnalysis.recommendation}</div>
          </div>
          ...
          <div style={{ padding:'6px 10px', borderRadius:8, background:'#202023' }}>
            ...
            <div style={{ fontSize:9, color:'rgba(255,255,255,0.7)', lineHeight:1.4 }}>{fullReport.calciumMagnesium.recommendation}</div>
          </div>
    ...
    {reportSubTab === 'overview' && (<div style={{ padding:14, ...modernCardBg }}>
      ...
      }} style={{ width:'100%', padding:'12px', borderRadius:12, border:'1px solid rgba(0,230,138,0.25)', background:'rgba(0,230,138,0.06)', color:'#00e68a', cursor:'pointer', fontSize:12, fontWeight:700, minHeight:48, marginBottom:8 }}>📄 Сгенерировать и сохранить отчёт</button>
      {reportMode === 'week' && <div style={{ display:'flex', gap:2, marginBottom:8 }}>
        {Array.from({length:7}, (_,i) => { const d = new Date(new Date(weekStart)); d.setDate(d.getDate()+i); const ds = d.toISOString().split('T')[0]; const hasData = !!raw[ds]; return <div key={i} style={{ flex:1, textAlign:'center', padding:'6px 2px', borderRadius:8, background: hasData ? 'rgba(0,230,138,0.12)' : '#202023', fontSize:9, color: hasData ? '#00e68a' : 'rgba(255,255,255,0.8)' }}>
      ...
      <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr 1fr 1fr 1fr', gap:6, marginBottom:8 }}>
        {[{l:'Ккал',v:Math.round(totals.kcal),c:'#00e68a'},{l:'Белки',v:Math.round(totals.p),c:'#3b82f6'},{l:'Жиры',v:Math.round(totals.f),c:'#f59e0b'},{l:'Угл.',v:Math.round(totals.c),c:'#f97316'},{l:'Ед.',v:totals.count,c:'#a78bfa'}].map((s,i) => <div key={i} style={{ background:'#202023', borderRadius:8, padding:'5px', textAlign:'center' }}>
          <div style={{ fontSize:9, color:'rgba(255,255,255,0.85)' }}>{s.l}</div><div style={{ fontSize:15, fontWeight:800, color:s.c }}>{s.v}</div>
        </div>)}
      </div>
      {(function() {
        try {
