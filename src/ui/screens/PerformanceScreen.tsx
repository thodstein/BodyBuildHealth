...
export const PerformanceScreen: React.FC = () => {
  ...
  const labels: Record<string,string> = {blood:'🩸 Кровь',stacks:'💊 Стеки',macro:'🧮 Макро',periodization:'📈 Период.',meet:'🏆 Турнир',bbprep:'💪 Подготовка',pct:'🔄 ПКТ',predict:'🔮 Прогноз'};
  ...
  return (<div className="screen">
    ...
    {tab==='macro' && <div className="card">
      ...
      <h5 style={{ margin:'10px 0 4px', fontSize:11 }}>Цель: {macroGoal === 'bulk' ? 'Набор' : macroGoal === 'cut' ? 'Сушка' : 'Поддержание'}</h5>
