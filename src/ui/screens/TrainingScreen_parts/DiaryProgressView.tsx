...
export const DiaryProgressView: React.FC<{ hub: DiaryHubCtx }> = ({ hub }) => {
  ...
  return (
        <div className="train-diaryprogress">
          <div className="card pg-measure" style={{ marginBottom: 8, padding: 10 }}>
          ...
          {measurements.length > 0 && (
            <div className="card pg-hist" style={{ marginBottom: 8, padding: 10 }}>
          ...
          {measureAnalytics && (
            <div className="card pg-body" style={{ padding: 10 }}>
          ...
          {measurements.length >= 3 && (
            <div className="card pg-trends" style={{ padding: 10, marginBottom: 8 }}>
          ...
          {repData && (
            <div className="card pg-report" style={{ padding: 10, marginTop: 8 }}>
          ...
          {historyWorkouts.length >= 2 && (() => {
            ...
            return (
              <div className="card pg-pr" style={{ padding: 10, marginTop: 8 }}>
          ...
          {historyWorkouts.length >= 4 && (() => {
            ...
            return (
              <div className="card pg-e1rm" style={{ padding: 10, marginTop: 8 }}>
          ...
          {historyWorkouts.length >= 5 && (() => {
            ...
            return (
              <div className="card pg-cal" style={{ padding: 10, marginTop: 8 }}>
          ...
          {historyWorkouts.length > 0 && (() => {
            ...
            return (
              <div className="card pg-radar" style={{ padding: 10 }}>
          ...
          {historyWorkouts.length > 0 && <div className="pg-charts"><ProgressChartsCard historyWorkouts={historyWorkouts} /></div>}
        </div>
  );
};
