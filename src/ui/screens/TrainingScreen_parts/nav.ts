...
export const ZONES: Record<TrainingZone, ZoneDef> = {
  ...
  calculators: {
    ...
    tabs: [
      'intelligence_hub', 'strength_analysis', 'quality_hub', 'diagnostics_hub', 'arm_diagnostics_hub', 'arm_lifting_diagnostics', 'wl_diagnostics_hub', 'strongman_diagnostics_hub', 'bb_diagnostics_hub', 'combat_diagnostics', 'joints_ortho', 'periodization_taper_hub',
    ...
    categories: [
      ...
      { label: 'Качество и диагностика', icon: 'shield', tabs: ['quality_hub', 'diagnostics_hub', 'arm_diagnostics_hub', 'arm_lifting_diagnostics', 'wl_diagnostics_hub', 'strongman_diagnostics_hub', 'bb_diagnostics_hub', 'combat_diagnostics', 'joints_ortho'] },
...
(TAB_TO_ZONE as Record<string, TrainingZone>)['combat_diagnostics'] = 'calculators';
