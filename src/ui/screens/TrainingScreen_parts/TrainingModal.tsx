  ...
  return (
    ...
    >
      <div
        ...
        aria-modal="true"
        aria-label={title}
        className="training-modal-dialog"
        tabIndex={-1}
        style={{ width: '100%', maxWidth: wide ? 980 : 760, maxHeight: 'calc(100dvh - 24px)', overflowY: 'auto', overscrollBehaviorY: 'contain', WebkitOverflowScrolling: 'touch', background: 'var(--card-bg, #18181b)', border: '1px solid var(--border-light, rgba(255,255,255,0.12))', borderRadius: 16, padding: 12, outline: 'none', boxShadow: '0 20px 70px rgba(0,0,0,0.5)' }}
      >
