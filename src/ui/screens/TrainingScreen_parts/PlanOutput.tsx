...
export const BadgeLegend: React.FC = () => (
  <div className="train-badgelegend" style={{ fontSize: 10, color: '#fff', opacity: 0.85, marginBottom: 8, lineHeight: 1.45, padding: '7px 9px', background: 'rgba(255,255,255,0.03)', borderRadius: 8, border: '1px solid rgba(255,255,255,0.05)' }}>
...
export const ExerciseRow: React.FC<{ ex: PlanExerciseView }> = ({ ex }) => {
  ...
  return (
    <div className="train-exerciserow" style={{
...
export const PhaseBanner: React.FC<{ phase: PhaseKey; desc?: string }> = ({ phase, desc }) => (
  <div className="train-phasebanner" style={{
...
export const WeekStrip: React.FC<{
  ...
  <div className="train-weekstrip" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(40px, 1fr))', gap: 4 }}>
