  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
      <div style={{ ...diaryCard, border: '1px solid rgba(234,179,8,0.2)' }}>
        ...
        <div style={{ fontSize: 10, color: 'rgba(255,255,255,0.45)' }}>Сохранённые планы с тапером: разгрузка выполнена, прикиды готовы к выходу на пик (до {MEET_STRATEGY_PCT_LABEL[plans[0]?.strategy as 'balanced'] ?? '105%'}).</div>
      </div>
            ...
            {isOpen && (
              <>
                    ...
                    {rec.meetAttempts.map(l => (
                      <div key={l.name} style={{ padding: 6, borderRadius: 8, background: 'rgba(234,179,8,0.08)', border: '1px solid rgba(234,179,8,0.25)', fontSize: 10 }}>
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 3, marginTop: 4 }}>
                          <div style={{ textAlign: 'center', background: 'rgba(255,255,255,0.04)', borderRadius: 6, padding: '3px 1px' }}><div style={{ color: 'rgba(255,255,255,0.5)', fontSize: 9 }}>1-я</div><b>{l.opener}</b></div>
                          <div style={{ textAlign: 'center', background: 'rgba(255,255,255,0.04)', borderRadius: 6, padding: '3px 1px' }}><div style={{ color: 'rgba(255,255,255,0.5)', fontSize: 9 }}>2-я</div><b>{l.second}</b></div>
                          <div style={{ textAlign: 'center', background: 'rgba(234,179,8,0.14)', borderRadius: 6, padding: '3px 1px', border: '1px solid rgba(234,179,8,0.4)' }}><div style={{ color: 'rgba(255,255,255,0.5)', fontSize: 9 }}>3-я</div><b style={{ color: '#eab308' }}>{l.third}</b></div>
                        </div>
                        <div style={{ fontSize: 9, color: 'rgba(255,255,255,0.4)', marginTop: 3 }}>×1 сингл · RIR 2/1/0</div>
                      </div>
                    ))}
                  </div>
                )}
                ...
                <div style={{ marginTop: 8 }}>
                  <div style={{ fontSize: 10, fontWeight: 700, color: 'rgba(255,255,255,0.5)', marginBottom: 4 }}>Состав мезоцикла</div>
