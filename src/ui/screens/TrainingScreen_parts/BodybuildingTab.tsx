...
import { BODYBUILDING_PROGRAMS } from "../../lib/training/data/programs";

export const BodybuildingTab: React.FC = () => {
  const program = BODYBUILDING_PROGRAMS[0]; // Use first program for simplicity
...
export default BodybuildingTab;
