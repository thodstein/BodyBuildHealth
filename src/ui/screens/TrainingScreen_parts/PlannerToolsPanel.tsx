...
const TOOLS: Record<'pl' | 'bb', ToolDef[]> = {
  ...
  pl: [
    ...
    { id: 'quality', title: 'Качество программы', icon: '⭐', accent: '#a855f7', short: 'Оценка 0-100 · MEV/MAV/MRV · PED dose-aware · графики', desc: 'ББ/ПЛ/Гибрид · Israetel MEV/MAV/MRV · паттерны/углы/растяжка/техника — без дублей', render: () => <QualityWrap /> },
    ...
    { id: 'safety', title: 'Безопасность и нагрузка', icon: '🛡', accent: '#ef4444', short: 'Ортопедия, нагрузка, авторегуляция, восстановление', desc: 'Быстрый орто-чек + sRPE/ACWR/Banister + RPE/e1RM + сон/HRV/чек-ин — без дублей формул', render: () => <TrainingSafetyHub /> },
    { id: 'periodization', title: 'Периодизация и тапер', icon: '🔄', accent: '#f59e0b', short: 'Дизайнер · микро · делод · прогрессия · трекер · тейпер/пик', desc: 'Блочная модель Issurin/Bompa + ПЛ 3 нед / ББ 4 нед тапер + шоу-пик — всё синхронизировано', render: () => <PeriodizationHub /> },
    ...
    { id: 'rir', title: 'RIR + Прогноз', icon: '🎯', accent: '#f97316', short: 'Калибровка RIR + Хольт-прогноз готовности', desc: 'RIR bias/консистентность/топ-5 + Хольт 95% ДИ + история — единый дневник-источник', render: () => <RirForecastHub /> },
  ...
  bb: [
    ...
    { id: 'tempo', title: 'Темп повторений', icon: '⏱️', accent: '#f59e0b', short: 'Эксцентрика/пауза/концентрика/пауза по цели.', desc: 'Темп по цели тренировки: эксцентрика/паузы/концентрика', render: () => <TempoTab /> },
    ...
    // — Интеллект (те же 13 карточек, что в ПЛ) —
    { id: 'intel', title: 'Интеллект тренировки', icon: '⚡', accent: '#00e68a', short: 'Единый пульт: нагрузка → восстановление → авторегуляция → прогноз', desc: 'ACWR/Banister/monotony · сон/HRV/готовность · PRI/RPE-вес · Хольт/what-if — один снапшот, без дублей', render: () => <UnifiedIntelligenceHub /> },
    { id: 'strength', title: 'Анализ силы', icon: '🏋️', accent: '#3b82f6', short: '1RM (7 формул), VBT, относительная сила, нормативы, аналитика', desc: 'Один снапшот пол/вес/присед/жим/тяга → 5 секций: 1RM · VBT · отн.сила · нормативы · аналитика', render: () => <StrengthAnalysisHub /> },
    { id: 'quality', title: 'Качество программы', icon: '⭐', accent: '#a855f7', short: 'Оценка 0-100 · MEV/MAV/MRV · PED dose-aware · графики', desc: 'ББ/ПЛ/Гибрид · Israetel MEV/MAV/MRV · паттерны/углы/растяжка/техника — без дублей', render: () => <QualityWrap /> },
    { id: 'diagnostics', title: 'Диагностика движения', icon: '🔬', accent: '#60a5fa', short: '9 лифтов: углы, траектория штанги, скорость, видео', desc: 'Мастер 9 движений + мёртвые точки + лимитеры + VBT + видео — точечные коррекции в план', render: () => <DiagnosticsWrap /> },
