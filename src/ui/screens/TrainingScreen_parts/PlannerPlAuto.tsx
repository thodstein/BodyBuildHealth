...
export const PlannerPlAuto: React.FC = () => {
  return (
    <div className="hub-pl" style={{ display: 'flex', flexDirection: 'column', gap: 8, width: '100%', minWidth: 0, maxWidth: '100%' }}>
      <div className="hub-head" style={{ background:'linear-gradient(135deg, rgba(0,230,138,0.12), rgba(59,130,246,0.08))', border:'1px solid rgba(0,230,138,0.18)', borderRadius:14, padding:'12px 14px', display:'flex', alignItems:'center', gap:10 }}>
