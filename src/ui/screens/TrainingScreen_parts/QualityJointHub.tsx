...
const MODE_DEFS: Array<{ m: QualityJointMode; label: string; icon: string; desc: string }> = [
  { m: 'quality', label: 'Качество + Диагностика', icon: '🎯', desc: 'Оценка 0-100, MEV/MAV/MRV, мастер жима/суставы/срывы' },
  { m: 'joints', label: 'Суставы + AI', icon: '🦴', desc: 'JSI теплокарта, 8 блоков, FMS, прехаб' },
];
