  ...
  return (
    <div style={{ maxWidth: 720, margin: '0 auto', padding: 12, color: '#fff' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
        {analysis.rows.map(r => (
          <div key={r.g} style={{ display: 'grid', gridTemplateColumns: '1.1fr 0.4fr 0.8fr 0.7fr 0.9fr', gap: 4, fontSize: 11, color: 'rgba(255,255,255,0.85)', alignItems: 'center', padding: '6px 8px', borderRadius: 8, background: 'rgba(255,255,255,0.03)' }}>
