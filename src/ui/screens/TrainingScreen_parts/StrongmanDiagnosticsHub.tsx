  ...
  return (
    <div className="train-strongdiag" style={{ padding: '14px 12px 22px', color: '#fff', maxWidth: 880, margin: '0 auto', display: 'flex', flexDirection: 'column', gap: 14 }}>
      ...
      <div style={{ ...CARD, padding: '18px 18px 16px', background: 'linear-gradient(135deg,rgba(239,68,68,0.12),rgba(245,158,11,0.12))', border: '1px solid rgba(239,68,68,0.22)', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 8, flexWrap: 'wrap' }}>
          ...
          <div style={{ flex: '1 1 180px', minWidth: 0 }}>
            ...
            <div style={{ fontSize: 12, color: '#fff', lineHeight: 1.45, opacity: 0.85, marginTop: 4 }}>16 фаз × углы + биомеханика + VBT + OHS + хват + sway + симулятор.</div>
          </div>
      ...
      <div style={{ ...CARD, padding: 14, position: 'sticky', top: 0, zIndex: 20, backdropFilter: 'blur(20px)', WebkitBackdropFilter: 'blur(20px)', boxShadow: '0 10px 28px rgba(0,0,0,0.45)' }}>
            ...
            {state.pressWeak.map(id=>{
              ...
              return (
                <div key={id} style={{ padding:'12px 14px', borderRadius:14, background:'rgba(22,30,52,0.88)', border:'1px solid rgba(140,190,255,0.16)', borderLeft:'3px solid #ef4444', marginBottom:8 }}>
                  <div style={{ fontSize:14, fontWeight:800, color:'#fff' }}>{bio.label} <span style={{ color:DIM, fontWeight:500 }}>· {bio.joint} {bio.angleRangeDeg[0]}-{bio.angleRangeDeg[1]}° · {bio.keyJoint}</span></div>
            ...
            {state.carryWeak.map(id=>{
              ...
              return (
                <div key={id} style={{ padding:'12px 14px', borderRadius:14, background:'rgba(22,30,52,0.88)', border:'1px solid rgba(140,190,255,0.16)', borderLeft:'3px solid #f59e0b', marginBottom:8 }}>
                  <div style={{ fontSize:14, fontWeight:800, color:'#fff' }}>{bio.label} <span style={{ color:DIM, fontWeight:500 }}>· {bio.angleRangeDeg.join('-')}°</span></div>
        ...
        {tab==='video' && (
          <div>
            <div style={{ fontSize:15, fontWeight:800, color:'#fff', marginBottom:10, paddingLeft:12, borderLeft:'3px solid #00e68a', lineHeight:1.35 }}>Видео — Kinovea sway + carry VBT</div>
