  ...
  const categories: Category[] = [
    ...
    },
    {
      ...
      tools: [
        ...
        { icon: '🏋️', label: 'Армлифтинг-диагностика', desc: 'Снаряды: RT/Axle/Pinch/CoC/Hub/Excalibur → %WR → в Арм-конструктор (армлифтинг)', tab: 'arm_lifting_diagnostics' as any },
        ...
        { icon: '🥋', label: 'Диагностика единоборств', desc: 'Удары/тейкдауны × bar-path/трекер + школа постановки → в конструктор единоборств', tab: 'combat_diagnostics' as any },
      ],
    },
    {
