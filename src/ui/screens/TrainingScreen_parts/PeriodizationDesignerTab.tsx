...
import { PhOverlay, PhSelect } from './PeriodizationPopups';
import { PeriodizationTaperSection } from './PeriodizationTaperSection';
import {
...
/** Попапы переехали в ./PeriodizationPopups (реэкспорт для совместимости). */
export { PhOverlay, PhSelect } from './PeriodizationPopups';
      ...
      {current && (
        <>
          ...
          <div className="constructor-surface pd-card-mobile" style={{ ...CARD, borderLeft: `3px solid ${accent}`, background: `linear-gradient(135deg, ${accent}08, rgba(0,0,0,0))` }}>
            ...
            {unifiedMode === 'taper' && (
              <PeriodizationTaperSection current={current} discipline={effectiveDiscipline} accent={accent} />
            )}
          </div>
