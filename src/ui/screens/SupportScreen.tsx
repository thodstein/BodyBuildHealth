...
export const SupportScreen: React.FC<{ initialTab?: SupportTab }> = ({ initialTab }) => {
  ...
  const SUPPORT_LEVELS: Record<string, { label: string; desc: string; subs: string[]; dosages: Record<string, { mg: number; timing: string }> }> = {
    basic: { label: '🟢 База', desc: 'Минимальный набор — 8 добавок, покрывающих все 8 систем', subs: ['nac', 'omega3', 'vitamin_d3', 'zinc', 'magnesium', 'folate', 'taurine', 'selenium'], dosages: { nac: { mg: 600, timing: 'утро, натощак' }, omega3: { mg: 2000, timing: 'с едой, завтрак' }, vitamin_d3: { mg: 5000, timing: 'с едой, завтрак (МЕ)' }, zinc: { mg: 15, timing: 'на ночь' }, magnesium: { mg: 200, timing: 'на ночь' }, folate: { mg: 800, timing: 'с едой (мкг)' }, taurine: { mg: 1000, timing: 'натощак' }, selenium: { mg: 200, timing: 'с едой (мкг)' } } },
    mid: { label: '🟡 Средний', desc: 'Стандартная поддержка — 14 добавок, глубокое покрытие', subs: ['nac', 'omega3', 'tudca', 'magnesium', 'vitamin_d3', 'coq10', 'zinc', 'vitamin_k2', 'vitamin_b12', 'glucosamine', 'collagen', 'alpha_lipoic', 'taurine', 'selenium'], dosages: { nac: { mg: 1200, timing: 'утро, натощак' }, omega3: { mg: 3000, timing: 'с едой, завтрак' }, tudca: { mg: 500, timing: 'перед едой' }, magnesium: { mg: 400, timing: 'на ночь' }, vitamin_d3: { mg: 5000, timing: 'с едой, завтрак (МЕ)' }, coq10: { mg: 200, timing: 'с едой, завтрак' }, zinc: { mg: 30, timing: 'на ночь, натощак' }, vitamin_k2: { mg: 200, timing: 'с едой, обед (мкг)' }, vitamin_b12: { mg: 1000, timing: 'утро (мкг)' }, glucosamine: { mg: 1500, timing: 'с едой' }, collagen: { mg: 10000, timing: 'с едой, утро (мг)' }, alpha_lipoic: { mg: 600, timing: 'натощак' }, taurine: { mg: 1500, timing: 'натощак' }, selenium: { mg: 200, timing: 'с едой (мкг)' } } },
