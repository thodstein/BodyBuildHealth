...
export const THERAPEUTIC_WINDOWS: Record<string, { minMg: number; optMg: number; maxMg: number; ul: number; note: string; unit?: string }> = {
  ...
  ashwagandha: { minMg: 300, optMg: 600, maxMg: 1200, ul: 2000, note: 'KSM-66 или Sensoril. >600 мг → сонливость.' },
  milk_thistle: { minMg: 200, optMg: 600, maxMg: 1200, ul: 1500, note: 'Силимарин 80%. 2-3 р/д с едой.' },
  tudca: { minMg: 250, optMg: 500, maxMg: 1500, ul: 2000, note: '2-3 р/д натощак. >1000 мг → диарея.' },
  glycine: { minMg: 1000, optMg: 3000, maxMg: 5000, ul: 9999, note: 'Нет UL. Перед сном 3-5 г.' },
  theanine: { minMg: 100, optMg: 200, maxMg: 400, ul: 900, note: '100-200 мг 1-2 р/д. >400 мг → гипотония.' },
  taurine: { minMg: 500, optMg: 2000, maxMg: 5000, ul: 9999, note: 'Нет UL. 1-3 г натощак.' },
  l_carnitine: { minMg: 500, optMg: 2000, maxMg: 4000, ul: 9999, note: 'Нет UL. Натощак. ALCAR предпочтительнее.' },
  quercetin: { minMg: 250, optMg: 500, maxMg: 1500, ul: 3000, note: 'Фитосома лучше. С едой.' },
  garlic: { minMg: 600, optMg: 1200, maxMg: 3600, ul: 9999, note: 'Аллицин 3600-7200 мкг/д. Нет UL.' },
  bergamot: { minMg: 250, optMg: 500, maxMg: 1500, ul: 3000, note: '500 мг 2 р/д с едой.' },
  astaxanthin: { minMg: 2, optMg: 4, maxMg: 12, ul: 50, note: 'С жирной едой. >12 мг → окрашивание стула.' },
  pycnogenol: { minMg: 50, optMg: 150, maxMg: 300, ul: 600, note: '50-100 мг 2 р/д с едой.' },
  hesperidin: { minMg: 250, optMg: 500, maxMg: 2000, ul: 9999, note: 'С диосмином. Нет UL.' },
  niacin: { minMg: 100, optMg: 500, maxMg: 2000, ul: 3000, note: 'Титровать! Flush при >500 мг. SR-форма.' },
  serrapeptase: { minMg: 10, optMg: 60, maxMg: 240, ul: 9999, note: 'Натощак. 60000-120000 СПЕ/д.' },
  nattokinase: { minMg: 50, optMg: 200, maxMg: 400, ul: 9999, note: 'Натощак. 2000-4000 FU/д.' },
  bromelain: { minMg: 200, optMg: 500, maxMg: 2000, ul: 9999, note: 'Натощак для системного эффекта.' },
  collagen: { minMg: 2500, optMg: 10000, maxMg: 20000, ul: 9999, note: 'Гидролизат. С вит. C для синтеза.' },
  ...
  phosphatidylserine: { minMg: 100, optMg: 300, maxMg: 800, ul: 9999, note: 'С едой. 100-300 мг 1-3 р/д.' },
  phosphatidylcholine: { minMg: 400, optMg: 1200, maxMg: 4000, ul: 9999, note: 'С едой.' },
  lecithin: { minMg: 500, optMg: 1200, maxMg: 5000, ul: 9999, note: 'С едой. Источник холина.' },
  vitamin_k2: { minMg: 45, optMg: 100, maxMg: 200, ul: 9999, note: 'МК-7. С жирной едой. С D3.' },
  copper: { minMg: 0.5, optMg: 2, maxMg: 10, ul: 10, note: 'Отдельно от Zn. UL 10 мг.' },
  potassium: { minMg: 100, optMg: 400, maxMg: 1000, ul: 9999, note: 'С едой. Контроль K+ в крови.' },
  astragalus: { minMg: 250, optMg: 500, maxMg: 2000, ul: 9999, note: 'С едой. Адаптоген + почки.' },
  cordyceps: { minMg: 500, optMg: 1000, maxMg: 3000, ul: 9999, note: 'С едой. Энергия + почки.' },
