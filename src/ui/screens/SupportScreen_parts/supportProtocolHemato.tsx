                  ...
                  {[
                    { phase:'ФАЗА 1 · ПРОФИЛАКТИКА', label:'Базовый курс (Hct {'<'}48%)', color:'#22c55e', condition:'Hct {'<'}48%, PLT в норме', desc:'Профилактика гиперкоагуляции на любом курсе ААС',
                      items:[
                        ...
                        { name:'Омега-3 (EPA+DHA)', dose:'2-4 г/день', timing:'С едой', note:'Реологический эффект слабый; MACE не снижает (STRENGTH 2020) — не замена снижению дозы/донации. Безрецептурный рыбий жир ≠ икозапент 4 г (REDUCE-IT — только hyperTG на статине). При >4 г — ↑кровоточивости + риск ФП' },
