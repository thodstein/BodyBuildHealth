          ...
          <InfoErrorBoundary label="RAAS">
            <div className="sup-proto-raas" style={{ paddingBottom:30, display:'flex', flexDirection:'column', gap:8 }}>
              ...
              <ContraBanner items={[
                ...
                'Телмисартан/иАПФ при беременности — FDA категория D (2-3 триместр: олигогидрамнион, почки плода): планирующим/беременным — НЕ назначать, см. протокол «Женщины и ААС»',
                'RAAS-гард: телмисартан — ОДИН на все модули (кардио/почки/RAAS/метаболизм), суммарно ≤80 мг/сут; K⁺ + креатинин/СКФ через 2 нед после старта/↑ дозы, затем 1×/мес; стоп при K⁺ >5.0 или ↓СКФ >25%',
              ]} />
                ...
                <div style={{ display:'flex', flexDirection:'column', gap:8 }}>
                  {[
                    ...
                    {phase:'ФАЗА 2 · АГ 1 СТЕПЕНИ (АД 130-139/80-89)', label:'Монотерапия телмисартаном', color:'#f59e0b', condition:'АД 130-139/80-89, UACR 30-300, СКФ 60-90', desc:'Старт RAAS-блокады',
                      items:[
                        {name:'Телмисартан 20-40 мг 💊', dose:'20-40 мг', timing:'Утро/вечер', note:triageBadge('ess')+' ARB. ↓ АД на 10-15/5-10. ↓ протеинурия. PPARγ-агонист (метаболические плюсы). Старт 20 мг. K⁺ + креатинин/СКФ через 2 нед после старта. Беременность — противопоказан (FDA D) [A]'},
                    ...
                    {phase:'ФАЗА 3 · АГ 2 СТЕПЕНИ / РЕФРАКТЕРНАЯ (АД >140/90)', label:'Комбинированная терапия', color:'#f97316', condition:'АД >140/90 на телмисартане 40 мг / иАПФ ранее', desc:'Add-on терапия',
                      items:[
                        ...
                        {name:'+ Эплеренон 25-50 мг 💊', dose:'25-50 мг', timing:'Утро', note:triageBadge('ess')+' Селективный антагонист минералокортикоидных рецепторов. ↓ АД +5-10. Антифибротический. БЕЗ антиандрогенных эффектов (в отличие от спиронолактона). НЕ дублировать с эплереноном из других модулей. Мониторинг: K⁺ + креатинин/СКФ 1×/нед; стоп при K⁺ >5.0 или ↓СКФ >25%'},
                        {name:'Петлевой диуретик (фуросемид/торасемид) 💊', dose:'20-40 мг', timing:'Утро ТОЛЬКО при отёках/ХБП', note:triageBadge('rec')+' НЕ базисная АГ-терапия (для АГ — тиазидоподобные хлорталидон/индапамид ежедневно по врачу). Петля — только задержка жидкости/ХБП, курсом по врачу. Контроль K⁺, Mg, Na⁺'},
                    ...
                    {phase:'ФАЗА 4 · ПРОТЕИНУРИЯ / ХБП (UACR >300 / СКФ <60)', label:'Нефропротекция', color:'#ef4444', condition:'UACR >300 мг/г / СКФ <60 / микроальбуминурия', desc:'Максимальная нефропротекция',
                      items:[
                        ...
                        {name:'+ Эплеренон 25-50 мг 💊', dose:'25-50 мг', timing:'Утро', note:triageBadge('ess')+' Селективный антагонист минералокортикоидных рецепторов. Антифибротический + ↓ протеинурии. БЕЗ антиандрогенных эффектов (в отличие от спиронолактона). НЕ дублировать с другими модулями. Мониторинг: K⁺ + креатинин/СКФ 1×/нед; стоп при K⁺ >5.0 или ↓СКФ >25%'},
