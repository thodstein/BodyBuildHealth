                ...
                <div style={{ display:'flex', flexDirection:'column', gap:8 }}>
                  {[
                    ...
                    {phase:'ФАЗА 2 · АГ 1 СТЕПЕНИ (АД 130-139/80-89)', label:'Монотерапия телмисартаном', color:'#f59e0b', condition:'АД 130-139/80-89, UACR 30-300, СКФ 60-90', desc:'Старт RAAS-блокады',
                      items:[
                        {name:'Телмисартан 20-40 мг 💊', dose:'20-40 мг', timing:'Утро/вечер', note:triageBadge('ess')+' ARB. ↓ АД на 10-15/5-10. ↓ протеинурия. PPARγ-агонист (метаболические плюсы). Старт 20 мг. K⁺ + креатинин/СКФ через 2 нед после старта. Беременность — противопоказан (FDA D)'},
