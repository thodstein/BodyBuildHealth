                ...
                <div style={{ display:'flex', flexDirection:'column', gap:8 }}>
                  ...
                  {[
                    { phase:'ФАЗА 1 · ПРОФИЛАКТИКА', label:'Липиды + глюкоза — норма', color:'#22c55e', condition:'ЛПНП {'<'}130, ЛПВП {'>'}40, глюкоза {'<'}5.6', desc:'Поддержка метаболического здоровья на курсе',
                      items:[
                        { name:'Омега-3 (EPA+DHA)', dose:'2-4 г/день', timing:'С едой', note:'↓ ЛПНП, ↓ триглицеридов, ↑ ЛПВП (только липиды; MACE не снижает). Базовая метаболическая поддержка [B — только липиды]' },
                        { name:'Берберин 500 мг', dose:'500 мг', timing:'2×/день до еды', note:'Активатор AMPK → ↓ инсулинорезистентности, ↓ глюкозы, ↓ липидов. CYP3A4-ингибитор: разнос 2+ ч с оральными ААС/статинами' },
                    ...
                    { phase:'ФАЗА 2 · КОРРЕКЦИЯ ДИСЛИПИДЕМИИ', label:'ЛПНП 130-160 / ЛПВП {'<'}35', color:'#f59e0b', condition:'ЛПНП 130-160, ЛПВП {'<'}35', desc:'Целенаправленная коррекция липидного профиля',
                      items:[
                        ...
                        { name:'Красный рис (монаколин K) 1200-2400 мг (≈10 мг монаколина К)', dose:'1200-2400 мг', timing:'Вечер', note:'Ингибитор HMG-CoA редуктазы (природный статин). ↓ ЛПНП на 20-30%. Честно: доказанной CV-пользы нет (ESC/EAS) — ступенью не является, не рекомендуется; риски как у статина. Контроль АЛТ/АСТ' },
                        { name:'Берберин 500 мг', dose:'500 мг', timing:'2×/день', note:'↓ ЛПНП ещё на 15-20% дополнительно к эзетимибу (CYP3A4-разнос — см. Ф1)' },
                      ]},
                    { phase:'ФАЗА 3 · КОРРЕКЦИЯ ИР/ГЛЮКОЗЫ', label:'Глюкоза 5.6-7.0 / HOMA-IR {'>'}2.5', color:'#f97316', condition:'Глюкоза {'>'}5.6 или HOMA-IR {'>'}2.5', desc:'Снижение инсулинорезистентности (особенно на оксандролоне/метандростенолоне)',
                      items:[
                        { name:'Метформин 500-1000 мг 💊', dose:'500 мг', timing:'2×/день с едой', note:'Снижает продукцию глюкозы печенью. ↑ чувствительность к инсулину. ↓ риска СД 2 типа. Рецептурный препарат — только по назначению врача [A]' + RX_NOTE },
                        { name:'Берберин 500 мг', dose:'500 мг', timing:'2×/день', note:'Синергия с метформином через AMPK. ↓ гликированного гемоглобина на 0.5-1% (CYP3A4-разнос — см. Ф1)' },
                    ...
                    { phase:'ФАЗА 4 · КОРРЕКЦИЯ ЭЛЕКТРОЛИТОВ', label:'K⁺/Mg²⁺ низкие / отёки', color:'#ef4444', condition:'K⁺ {'<'}3.5 / Mg²⁺ {'<'}0.75 / отёки 2+', desc:'Восстановление водно-электролитного баланса',
                      items:[
                        { name:'Калия цитрат 500-1500 мг', dose:'500-1500 мг соли (≈2-6 ммоль K⁺)', timing:'2-3×/день с едой', note:'Целевой K⁺ 4.0-5.0. Соль цитрата ≈16-22% элементного K: лечебный дефицит закрывать ммолями (20-40 ммоль/сут KCl-эквивалента) под контролем. Контроль K⁺ каждые 1-2 нед при терапии' },
                        ...
                        { name:'Эплеренон (селективный антагонист MR) 💊', dose:'25-50 мг', timing:'Утро', note:'Селективный антагонист минералокортикоидных рецепторов. Снижает задержку Na⁺/H₂O. Сохраняет K⁺. БЕЗ антиандрогенного действия (в отличие от спиронолактона). НЕ дублировать с RAAS/электролитами. Мониторинг: K⁺ + креатинин/СКФ 1×/нед; стоп при K⁺ >5.0' },
                      ]},
                  ].map((p: any, i: any) => (
                ...
                <div style={cardBg}>
                  ...
                  {[
                    ...
                    { time:'☀️ День (12:00–16:00)', color:'#f97316', items:[
                      ...
                      { n:'Берберин 500 мг до обеда', why:'За 30 мин до еды. AMPK-активация. ↓ глюкозы в среднем на 20-30% (контроль глюкометром) [B]' },
                    ]},
