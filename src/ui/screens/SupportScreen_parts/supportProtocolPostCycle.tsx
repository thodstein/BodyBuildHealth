          ...
          <InfoErrorBoundary label="Постцикл">
            <div className="sup-proto-postcycle" style={{ paddingBottom:30, display:'flex', flexDirection:'column', gap:8 }}>
              ...
              {postCycleTab==='lipids'&&(<div style={cardBg}>
                ...
                {[{n:'Омега-3 EPA 4 г/день',d:'4 г',t:'2+2 г с едой',o:'↑ ЛПВП 10-15%, ↓ ТГ 25-30%'},{n:'Эзетимиб 10 мг 💊 (первая линия)',d:'10 мг',t:'Утро',o:'↓ ЛПНП 15-20%. Стандартизирован, без миопатии. Аддитивно к статинам'},{n:'Бергамот 1000 мг',d:'1000 мг',t:'2×/д до еды',o:'↓ ЛПНП 30-40%, ↑ ЛПВП 20-25%'},{n:'Ниацин B3 500 мг',d:'500 мг',t:'После еды 2-3×/д',o:'↑ ЛПВП 20-30% — мощный. Старт 100 мг титровать'},{n:'Кр. ферм. рис (монаколин K) — НЕ ступень',d:'1200-2400 мг',t:'Вечер',o:'Нет доказанной CV-пользы (ESC/EAS) — не рекомендуется; риски как у статина. Только БЕЗ цитринина + CoQ10. Контроль АЛТ/КФК. Не со статином'}].map((x:any,i:any)=>renderRow(x,i,'#8b5cf6'))}
              </div>)}
