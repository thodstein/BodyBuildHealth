            ...
            <div className="sup-proto-postcycle" style={{ paddingBottom:30, display:'flex', flexDirection:'column', gap:8 }}>
              ...
              {postCycleTab==='phases'&&(<div style={cardBg}>
                ...
                <div style={{ padding:'8px 10px', borderRadius:8, marginBottom:6, background:'rgba(139,92,246,0.04)' }}>
                  ...
                  <div style={{ fontSize:8, color:'var(--text-dim)', lineHeight:1.3 }}>• Отмена ААС. Восстановление HPTA — ДВЕ опции (выбрать одну):<br/>&nbsp;&nbsp;— <b>hCG-bridge</b>: при инъекционных ААС длительного действия — hCG 500-1000 МЕ 2×/нед × 2-3 нед (до старта SERM) для восстановления тестикулярного объёма, затем SERM [C — нет РКИ]<br/>&nbsp;&nbsp;— <b>SERM-моно</b>: при коротких эфирах или лёгких курсах — SERM сразу без hCG (hCG НЕ обязателен)<br/>• SERM (тамоксифен 20 мг ИЛИ энкломифен 12.5-25 мг ИЛИ кломифен 25-50 мг/день) — старт после последней инъекции коротких эфиров или через 2-3 нед после последней инъекции длинных эфиров [B — когорта BJU-2026, не РКИ]<br/>• AI — только при высоком E2. Каберголин 0.25×2/нед при ↑ PRL — режим строго по протоколу «Пролактин» (титрация +0.25/4+ нед, кап 1 мг 2×/нед, ЭхоКГ, активный расспрос об импульсивности)<br/>• Контроль T,E2,PRL,АЛТ,HCT каждые 2 нед</div>
                </div>
                <div style={{ padding:'8px 10px', borderRadius:8, marginBottom:6, background:'rgba(139,92,246,0.04)' }}>
                  <div style={{ fontSize:9, fontWeight:700, color:'#a78bfa', marginBottom:2 }}>ФАЗА 2 · ПКТ (4-8 нед)</div>
                  <div style={{ fontSize:8, color:'var(--text-dim)', lineHeight:1.3 }}>• SERM (ОДИН из): тамоксифен 20 мг/день ИЛИ энкломифен 12.5-25 мг/день ИЛИ кломифен 25-50 мг/день. Комбинация SERM не рекомендована — одинаковый механизм, ↑ риска побочных эффектов без дополнительной пользы<br/>• Поддержка: цинк 50 мг, Mg 400 мг, D3 2000-4000 МЕ, B6 100 мг<br/>• Адаптогены: ашвагандха 600 мг (суммарно со всеми модулями ≤600 мг/сут; DILI: АЛТ/АСТ через 4-8 нед), фосфатидилсерин 200 мг<br/>• Контроль: T, ЛГ, ФСГ, кортизол каждые 2 нед</div>
                </div>
                <div style={{ padding:'8px 10px', borderRadius:8, marginBottom:6, background:'rgba(139,92,246,0.04)' }}>
              ...
              {postCycleTab==='lipids'&&(<div style={cardBg}>
                ...
                {[{n:'Омега-3 EPA 4 г/день',d:'4 г',t:'2+2 г с едой',o:'↑ ЛПВП 10-15%, ↓ ТГ 25-30% (только липиды; MACE не снижает — STRENGTH) [B]'},{n:'Эзетимиб 10 мг 💊 (первая линия)',d:'10 мг',t:'Утро',o:'↓ ЛПНП 15-20%. Стандартизирован, без миопатии. Аддитивно к статинам [A]'},{n:'Бергамот 1000 мг',d:'1000 мг',t:'2×/д до еды',o:'↓ ЛПНП 30-40%, ↑ ЛПВП 20-25% (средние литературные, не гарантия — контроль липидами) [B]'},{n:'Ниацин B3 500 мг',d:'500 мг',t:'После еды 2-3×/д',o:'↑ ЛПВП 20-30% (средние данные, не гарантия; по исходам CV-пользы нет — AIM-HIGH/HPS2) [C]. Старт 100 мг титровать'},{n:'Кр. ферм. рис (монаколин K) — НЕ ступень',d:'1200-2400 мг',t:'Вечер',o:'Нет доказанной CV-пользы (ESC/EAS) — не рекомендуется; риски как у статина. Только БЕЗ цитринина + CoQ10. Контроль АЛТ/КФК. Не со статином'}].map((x:any,i:any)=>renderRow(x,i,'#8b5cf6'))}
              </div>)}
              {postCycleTab==='hemato'&&(<div style={cardBg}>
                ...
                {[{n:'Кровопускание 400-500 мл',d:'—',t:'При HCT >54 до <50',o:'Золотой стандарт. Донорство. Повтор через 4-6 нед'},{n:'Аспирин 75-100 мг + ИПП',d:'75-100 мг',t:'Утро после еды',o:'↓ агрегация тромбоцитов. Только при ≥2 факторах тромботического риска (HCT>52, ↑вязкость, ↑ТГ, курение, возраст>40). Не сочетать с НПВС/антикоагулянтами без врача'},{n:'Чеснок Kyolic 1200 мг',d:'1200 мг',t:'2×/день',o:'↓ вязкость крови'},{n:'Гидратация 3+ л/день',d:'>3 л',t:'Постоянно',o:'Разжижение крови'},{n:'Наттокиназа 100 мг',d:'100 мг',t:'Утро натощак',o:'Фибринолитик. При HCT >50'}].map((x:any,i:any)=>renderRow(x,i,'#8b5cf6'))}
              </div>)}
