                ...
                <div style={{ display:'flex', flexDirection:'column', gap:8 }}>
                  {[
                     { phase:'ФАЗА 1 · ПРОФИЛАКТИКА', label:'E2 в норме', color:'#22c55e', condition:'E2 20-60 пг/мл', desc:'Мониторинг + превентивные меры. ЦЕЛЬ E2: 20-40 пг/мл (не ниже, не выше)',
                      items:[
                        { name:'DIM (дииндолилметан)', dose:'200-400 мг', timing:'2×/день', note:'Модулятор метаболизма E2: ↑ 2-OH (антипролиферативный), ↓ 16α-OH (пролиферативный). Уровень C (нет РКИ у мужчин на ААС) — профилактика, не замена AI при E2 >60' },
