          ...
          <InfoErrorBoundary label="Пролактин">
            <div style={{ paddingBottom:30, display:'flex', flexDirection:'column', gap:8 }}>
              ...
              {prolactinTab==='monitoring' && monitoringBlock([
                ...
                {marker:'Эхокардиография', target:'Без фиброза клапанов', when:'Каждые 6-12 мес на каберголине', action:'ЭхоКГ-мониторинг фиброза клапанов: при ЛЮБОЙ дозе каберголина >6 мес — базовое ЭхоКГ, затем каждые 6-12 мес. При >2 мг/нед — обязательное ЭхоКГ до начала и каждые 6 мес'},
              ])}
            </div>
          </InfoErrorBoundary>
  );
