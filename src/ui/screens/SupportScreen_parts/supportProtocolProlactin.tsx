                ...
                <div style={{ display:'flex', flexDirection:'column', gap:8 }}>
                  ...
                  {[
                    {phase:'ФАЗА 1 · ПРОФИЛАКТИКА (PRL <600 мМЕ/л)', label:'Базовая поддержка нормы', color:'#22c55e', condition:'Все ААС-курсы с нандролоном/тренболоном', desc:'Профилактика гиперпролактинемии без каберголина',
                      items:[
                        {name:'Витамин B6 (пиридоксин) 50-100 мг', dose:'50-100 мг', timing:'Утро', note:triageBadge('ess')+' Кофактор дофамин-синтеза. Поддерживает D2-тонус. ↓ PRL в среднем на 15-25% по наблюдениям (не РКИ) [C]'},
                    ...
                    {phase:'ФАЗА 3 · ВЫСОКАЯ (PRL 1000-2000 мМЕ/л)', label:'Каберголин — титрация', color:'#f97316', condition:'PRL 1000-2000 / галакторея / гипогонадизм', desc:'Увеличение дозы каберголина',
                      items:[
                        {name:'Каберголин 0.5 мг', dose:'0.5 мг', timing:'1-2×/нед', note:triageBadge('ess')+' Титрация от 0.25→0.5 мг (+0.25 мг каждые 4+ нед, макс. 1 мг 2×/нед по лейблу). Разделить приём на 2×/нед (напр. ср+вс), с едой. ⚠ Импульсивные расстройства — спрашивать активно (азарт, секс, траты); при появлении — ↓/отмена. Ортостаз с АГП [A]'},
