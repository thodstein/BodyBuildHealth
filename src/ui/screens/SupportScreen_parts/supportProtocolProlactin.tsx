                  ...
                  {[
                    {phase:'ФАЗА 1 · ПРОФИЛАКТИКА (PRL <600 мМЕ/л)', label:'Базовая поддержка нормы', color:'#22c55e', condition:'Все ААС-курсы с нандролоном/тренболоном', desc:'Профилактика гиперпролактинемии без каберголина',
                     ...
                     {phase:'ФАЗА 2 · УМЕРЕННАЯ (PRL 600-1000 мМЕ/л)', label:'Каберголин — старт', color:'#f59e0b', condition:'PRL 600-1000 / симптомы: ↓ либидо, галакторея, олигоменорея', desc:'Медикаментозная коррекция',
                      items:[
                        {name:'Каберголин (Достинекс) 💊', dose:'0.25 мг', timing:'1-2×/нед', note:triageBadge('ess')+' D2-агонист. Старт 0.25 мг × 1/нед. Контроль PRL через 2 нед. ⚠ Риск импульсивных расстройств (лудомания, гиперсексуальность, компульсивное поведение) — особенно на фоне тренболона'},
                    ...
                    {phase:'ФАЗА 3 · ВЫСОКАЯ (PRL 1000-2000 мМЕ/л)', label:'Каберголин — титрация', color:'#f97316', condition:'PRL 1000-2000 / галакторея / гипогонадизм', desc:'Увеличение дозы каберголина',
                      items:[
                        {name:'Каберголин 0.5 мг', dose:'0.5 мг', timing:'1-2×/нед', note:triageBadge('ess')+' Титрация от 0.25→0.5 мг. Разделить приём на 2×/нед (напр. ср+вс). ⚠ Риск импульсивных расстройств (лудомания, гиперсексуальность) — особенно на тренболоне'},
                    ...
                    {phase:'ФАЗА 4 · КРИТИЧЕСКАЯ (PRL >2000 + галакторея/аденома)', label:'Каберголин + эндокринолог', color:'#ef4444', condition:'PRL >2000 / макропролактинома / галакторея', desc:'Терапия под контролем эндокринолога',
                      items:[
                        {name:'Каберголин 1-2 мг', dose:'1-2 мг', timing:'2×/нед', note:triageBadge('ess')+' Высокие дозы. Контроль PRL ежемесячно. Эхокардиография каждые 6-12 мес (риск фиброза клапанов). ⚠ Риск импульсивных расстройств (лудомания, гиперсексуальность, компульсивное поведение) — мониторинг психического статуса'},
