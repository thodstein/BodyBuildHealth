                ...
                <div style={{ display:'flex', flexDirection:'column', gap:8 }}>
                  ...
                  {[
                    { phase:'ФАЗА 1 · НАТУРАЛЬНАЯ МОДУЛЯЦИЯ', label:'Природные GLP-1 секретагоги', color:'#22c55e', condition:'Преддиабет/ожирение (ИМТ {'>'}27)', desc:'Повышение эндогенного GLP-1 без инъекционных препаратов',
                      items:[
                        { name:'Берберин 500 мг', dose:'500 мг', timing:'2-3×/день до еды', note:'↑ GLP-1 через ↑ активности L-клеток. ↓ глюкозы в среднем на 20-30% (контроль глюкометром) [B]. AMPK-активатор. CYP3A4-ингибитор: разнос 2+ ч с оральными ААС/статинами' },
                    ...
                    { phase:'ФАЗА 2 · НИЗКИЕ ДОЗЫ АГОНИСТОВ', label:'Семаглутид/лираглутид', color:'#f59e0b', condition:'ИМТ {'>'}30 / глюкоза {'>'}6.0 / ИР', desc:'Старт GLP-1 агонистов',
                      items:[
                        { name:'Семаглутид (Оземпик/Вегови) 💊', dose:'0.25-0.5 мг', timing:'1×/нед п/к', note:'Старт 0.25 мг × 4 нед. Титрация → 0.5 мг. ↓ веса на 5-10% за 6 мес (STEP-РКИ) [A]. Контроль глюкозы' },
                    ...
                    { phase:'ФАЗА 3 · ТИТРАЦИЯ/ПОДДЕРЖАНИЕ', label:'Средние дозы', color:'#f97316', condition:'ИМТ {'>'}35 / глюкоза {'>'}7.0', desc:'Увеличение дозы для клинического эффекта',
                      items:[
                        { name:'Семаглутид 1.0-2.4 мг', dose:'1.0-2.4 мг', timing:'1×/нед п/к', note:'Максимальная доза. ↓ веса до 15% за 12 мес (STEP-РКИ) [A]. Контроль HbA1c, глюкозы, АЛТ/АСТ' },
                    ...
                    { phase:'ФАЗА 4 · ПОБОЧНЫЕ ЭФФЕКТЫ/ОСЛОЖНЕНИЯ', label:'ЖКТ-токсичность', color:'#ef4444', condition:'Непереносимость / тошнота / рвота / панкреатит', desc:'Управление побочными эффектами GLP-1',
                      items:[
                        { name:'Симптоматическая терапия тошноты', dose:'Ондансетрон 4-8 мг', timing:'За 30 мин до еды', note:'Антагонист 5-HT3. Препарат выбора при тошноте от GLP-1. Домперидон/метоклопрамид противопоказаны — повышают пролактин (D2-антагонизм)' },
                        ...
                        { name:'Плановая операция/наркоз — отмена заранее', dose:'—', timing:'Еженедельные — за 1 нед; ежедневные — за 1 день', note:'Замедление опорожнения желудка → полный желудок при индукции → аспирация (ASA 2023). См. чеклист «Экстренные → Подготовка к операции». При экстренной — УЗИ желудка' },
