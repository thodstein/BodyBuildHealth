  ...
  return (
    <InfoErrorBoundary label="Оптимизация стоимости">
      <div style={{ paddingBottom:30, display:'flex', flexDirection:'column', gap:8 }}>
        <div style={cardBg}>
          <div style={{ fontSize:13, fontWeight:800, color:'#22c55e', marginBottom:2 }}>💰 Оптимизация стоимости поддержки (тир-подход)</div>
          <p style={{ fontSize:9, color:'var(--text-dim)', margin:0, lineHeight:1.3 }}>Не всё одинаково важно. 🔴 Core = обязательно на любом курсе. 🟡 Advanced = значительно улучшает защиту. 🟢 Optional = дополнительная оптимизация.</p>
        </div>
        ...
        {costTab === 'liver' && (
          <div style={{ display:'flex', flexDirection:'column', gap:6 }}>
            {[
              { tier:'🔴 CORE (≈1500 ₽/мес)', items:[
                { sub:'NAC 1200 мг/день (600 мг ×2)', cost:'~600 ₽/мес', why:'Предшественник глутатиона. Без него защита печени не работает.' },
                { sub:'TUDCA 500-1000 мг/день', cost:'~900 ₽/мес', why:'Снижение ER-стресса, желчеотток. Обязательно при оральных ААС.' },
              ]},
              { tier:'🟡 ADVANCED (+2000 ₽/мес)', items:[
                ...
                { sub:'АЛЬК (альфа-липоевая кислота) 600 мг', cost:'~600 ₽/мес', why:'Активатор Nrf2. Регенерация глутатиона. Хелатор металлов.' },
        ...
        {costTab === 'cardio' && (
          <div style={{ display:'flex', flexDirection:'column', gap:6 }}>
            {[
              { tier:'🔴 CORE (≈1000 ₽/мес)', items:[
                { sub:'Омега-3 (EPA+DHA) 2-3 г/день', cost:'~600 ₽/мес', why:'База: ↓ ТГ, ↓ воспаления, стабилизация мембран. Минимум 60% EPA.' },
                { sub:'CoQ10 (убихинол) 100-200 мг', cost:'~400 ₽/мес', why:'Митохондриальная защита кардиомиоцитов. Особенно важно при статинах (↓ CoQ10).' },
              ]},
              { tier:'🟡 ADVANCED (+2500 ₽/мес)', items:[
                { sub:'Телмисартан 40-80 мг 💊', cost:'~500-1000 ₽/мес', why:'ARB + PPARγ. При АД >130/85. Рецептурный — только врач.' },
                { sub:'Небиволол 2.5-5 мг 💊', cost:'~600 ₽/мес', why:'β1-блокатор + NO-модуляция. При тахикардии >90. Рецептурный.' },
                { sub:'Красный дрожжевой рис 1200 мг', cost:'~600 ₽/мес', why:'При ЛПНП >130 мг/дл. ≈10 мг монаколина K. Контроль АЛТ + CoQ10.' },
                { sub:'L-карнитин 2-3 г', cost:'~800 ₽/мес', why:'Энергия миокарда. Жиросжигание. Дорого — опционально при нормолипидемии.' },
              ]},
              { tier:'🟢 OPTIONAL', items:[
                { sub:'Эзетимиб 10 мг 💊', cost:'~1500 ₽/мес', why:'Дорого. Только при ЛПНП >160 на максимальной терапии.' },
                { sub:'Аспирин кардио 100 мг 💊', cost:'~100 ₽/мес', why:'Дёшево, но риск ЖКТ-кровотечения. Только при ≥2 факторах тромбориска.' },
              ]},
            ].map((g: any, gi: any) => (
              <div key={gi} style={{ borderRadius:10, padding:'10px 12px', background:'rgba(34,197,94,0.06)', border:'1px solid rgba(34,197,94,0.15)' }}>
                <div style={{ fontSize:10, fontWeight:800, color:'#22c55e', marginBottom:6 }}>{g.tier}</div>
            ...
            {[
              {
                ...
                tiers: costTab==='kidney'?[
                  { tier:'🔴 CORE', items:[{ sub:'Гидратация 2.5-3.5 л/день', cost:'0 ₽', why:'Бесплатно и эффективно. Основа нефропротекции.' },{ sub:'Астрагал 1-3 г', cost:'~400 ₽/мес', why:'↓ креатинина. Доказательства уровня B.' }]},
                  ...
                  { tier:'🟡 ADVANCED', items:[{ sub:'Аспирин 100 мг 💊', cost:'~100 ₽/мес', why:'При Hct >52% + ≥2 факторах риска. Только врач.' },{ sub:'Наттокиназа 100 мг (2000 FU)', cost:'~600 ₽/мес', why:'Фибринолиз. Альтернатива аспирину — меньше ЖКТ-риск.' }]},
