            ...
            {[
              {
                ...
                tiers: costTab==='kidney'?[
                  ...
                  { tier:'🟡 ADVANCED', items:[{ sub:'Ашвагандха 600 мг', cost:'~400 ₽/мес', why:'↑ свободного T в среднем на 15-25% по РКИ. ↓ кортизола.' },{ sub:'DIM 200 мг (при E2 >40)', cost:'~500 ₽/мес', why:'Метаболизм E2 в 2-OH (защитный путь).' }]},
