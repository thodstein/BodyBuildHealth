          ...
          <div style={{ display:'flex', flexDirection:'column', gap:6 }}>
            {[
              ...
              { tier:'🟡 ADVANCED (усиленная защита)', items:[
                ...
                { sub:'Красный дрожжевой рис 1200 мг', cost:'~600 ₽/мес', why:'НЕ ступень: нет доказанной CV-пользы (ESC/EAS) — не рекомендуется. ≈10 мг монаколина K (=ловастатин), риски как у статина. Только БЕЗ цитринина + CoQ10. Контроль АЛТ/КФК.' },
            ...
            {[
              {
                ...
                tiers: costTab==='kidney'?[
                  ...
                  { tier:'🟡 ADVANCED', items:[{ sub:'Ашвагандха 600 мг', cost:'~400 ₽/мес', why:'↑ свободного T в среднем на 15-25% по РКИ [B]. ↓ кортизола.' },{ sub:'DIM 200 мг (при E2 >40)', cost:'~500 ₽/мес', why:'Метаболизм E2 в 2-OH (защитный путь).' }]},
