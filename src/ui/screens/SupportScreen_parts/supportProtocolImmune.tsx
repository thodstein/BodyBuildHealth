                ...
                <div style={{ display:'flex', flexDirection:'column', gap:8 }}>
                  {[
                    { phase:'ФАЗА 1 · БАЗОВАЯ', label:'Профилактика', color:'#22c55e', condition:'Нет симптомов, инфекции {'<'}2/год', desc:'Базовая иммуноподдержка на любом курсе',
                      items:[
                        { name:'Витамин D3', dose:'2000-4000 МЕ', timing:'С жирной едой', note:'Модулятор врождённого и адаптивного иммунитета. ↓ риск респираторных инфекций в среднем по мета-анализам (эффект сильнее при дефиците) [B]. >4000 МЕ — контроль 25-OH-D и Ca²⁺' },
                    ...
                    { phase:'ФАЗА 3 · ТЕРАПЕВТИЧЕСКАЯ', label:'Острая инфекция + курс', color:'#f97316', condition:'ОРВИ/ангина на курсе', desc:'Иммунотерапия + симптоматическая поддержка',
                      items:[
                        ...
                        { name:'Витамин C в/в (аскорбат Na) 10-15 г', dose:'10-15 г', timing:'В/в капельно — только стационар', note:'При пневмонии/тяжёлой инфекции. Дома не вводить. Противовирусный + антиоксидантный эффект' },
                ...
                <div style={cardBg}>
                  ...
                  {[
                    ...
                    { time:'☀️ День (12:00–16:00)', color:'#f97316', items:[
                      ...
                      { n:'Витамин D3 2000-4000 МЕ', why:'С жирной едой. Макс. абсорбция. Сумма со всеми модулями ≤4000 МЕ/сут без врача; выше — контроль 25-OH-D и Ca. Контроль 25-OH-D' },
