                ...
                <div style={{ display:'flex', flexDirection:'column', gap:8 }}>
                  {[
                    ...
                    {phase:'ФАЗА 2 · УМЕРЕННЫЙ СТЕАТОЗ (CAP 250-300 dB/м)', label:'Лечение стеатоза', color:'#f59e0b', condition:'УЗИ: стеатоз 1-2 ст. / CAP 250-300 / АЛТ 40-80', desc:'Терапия стеатоза',
                      items:[
                        {name:'Берберин 500 мг (макс. 1500 мг/сут)', dose:'500 мг', timing:'3×/день до еды', note:triageBadge('ess')+' ↑ дозу, но НЕ выше 500 мг 3×/день суммарно (ЖКТ + гипогликемия). ↓ HOMA-IR на 30%. ↓ стеатоза по данным МРТ'},
