          ...
          <InfoErrorBoundary label="Стеатоз">
            <div className="sup-proto-steatosis" style={{ paddingBottom:30, display:'flex', flexDirection:'column', gap:8 }}>
              ...
              {steatosisTab==='timing' && timingBlock('steatosis', [
                ...
                {time:'🌙 Вечер', items:[{n:'TUDCA 500-1000 мг',why:'Натощак за 2 ч до сна'},{n:'Омега-3 2 г (EPA)',why:'С ужином'},{n:'Берберин 500 мг',why:'До ужина'},{n:'Витамин E 200-400 МЕ',why:'С ужином (жирорастворимый)'}]},
              ])}
