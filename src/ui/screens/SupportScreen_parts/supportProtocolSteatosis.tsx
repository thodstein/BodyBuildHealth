          ...
          <InfoErrorBoundary label="Стеатоз">
            <div className="sup-proto-steatosis" style={{ paddingBottom:30, display:'flex', flexDirection:'column', gap:8 }}>
                ...
                <div style={{ display:'flex', flexDirection:'column', gap:8 }}>
                  {[
                    {phase:'ФАЗА 1 · ПРОФИЛАКТИКА (стеатоза нет)', label:'Гепатопротекция + метаболическая поддержка', color:'#22c55e', condition:'АЛТ/АСТ/ГГТ в норме, УЗИ печени без изменений', desc:'Профилактика стеатоза на курсе ААС',
                      items:[
                        {name:'Берберин 500 мг', dose:'500 мг', timing:'2-3×/день до еды', note:triageBadge('ess')+' AMPK-активатор → ↓ de novo липогенеза. ↓ глюкозы, ↓ ИР. Доказан при НАЖБП. CYP3A4-ингибитор: разнос 2+ ч с оральными ААС/статинами'},
                    ...
                    {phase:'ФАЗА 2 · УМЕРЕННЫЙ СТЕАТОЗ (CAP 250-300 dB/м)', label:'Лечение стеатоза', color:'#f59e0b', condition:'УЗИ: стеатоз 1-2 ст. / CAP 250-300 / АЛТ 40-80', desc:'Терапия стеатоза',
                      items:[
                        {name:'Берберин 500 мг (макс. 1500 мг/сут)', dose:'500 мг', timing:'3×/день до еды', note:triageBadge('ess')+' ↑ дозу, но НЕ выше 500 мг 3×/день суммарно (ЖКТ + гипогликемия). ↓ HOMA-IR в среднем на 30% по РКИ (индивидуально — по анализам) [B]. ↓ стеатоза по данным МРТ'},
                        {name:'TUDCA 500-750 мг', dose:'500-750 мг', timing:'Вечер натощак', note:triageBadge('ess')+' ↑ BSEP, ↓ стеатоз. Синергия с берберином (CYP3A4-разнос — см. Ф1) [C]'},
                        {name:'Омега-3 (EPA) 4 г', dose:'4 г', timing:'С едой (2+2 г)', note:triageBadge('ess')+' EPA 4 г — минимальная эффективная доза для ↓ стеатоза'},
                        {name:'Витамин E (RRR-α-токоферол) 200-400 МЕ', dose:'200-400 МЕ', timing:'С едой', note:triageBadge('rec')+' Антиоксидант. ↓ стеатоза (PIVENS trial). Диапазон 200-400 МЕ. ⚠ >400 МЕ длительно — ↑ риск рака простаты (SELECT/HOPE-TOO). Контроль ПСА'},
                    ...
                    {phase:'ФАЗА 3 · ТЯЖЁЛЫЙ СТЕАТОЗ/НАСГ/ФИБРОЗ (CAP >300 / FIB-4 >2.67)', label:'НАСГ + риск цирроза', color:'#ef4444', condition:'CAP >300 / АЛТ >80 / FIB-4 >2.67 / эластография >8 кПа', desc:'Терапия под контролем гепатолога',
                      items:[
                        {name:'Берберин 500 мг 3×/день (макс.) + TUDCA по весу', dose:'500×3 + TUDCA 13-15 мг/кг', timing:'Берберин 3× до еды, TUDCA с едой 2×', note:triageBadge('ess')+' Берберин НЕ выше 1500 мг/сут. TUDCA — по весу с едой + разнос 3-4 ч от орального ААС. CYP3A4-разнос берберина (см. Ф1) [C]. Add-on: метформин/пиоглитазон'},
                        {name:'Омега-3 (EPA) 6 г', dose:'6 г', timing:'3+3 г с едой', note:triageBadge('ess')+' Максимальная доза. ⚠ При >4 г/сут: ↑ кровоточивости (не сочетать с аспирином/антикоагулянтами без врача) + риск ФП. ↑ окисления жирных кислот'},
                        {name:'Пиоглитазон 15-30 мг 💊', dose:'15-30 мг', timing:'Утро', note:triageBadge('rec')+' ↓ ИР + ↓ стеатоза. Контроль веса (+2-4 кг). ⚠ FDA warning: риск рака мочевого пузыря (контроль: макрогематурия, УЗИ). Противопоказан при СН NYHA III-IV. Переломы у женщин И мужчин. Контроль АЛТ. ↑ риска переломов (женщины) [B]'},
              ...
              {steatosisTab==='timing' && timingBlock('steatosis', [
                ...
                {time:'🌙 Вечер', items:[{n:'TUDCA по весу (13-15 мг/кг/сут) с едой',why:'В 2 приёма с едой + разнос 3-4 ч от орального ААС'},{n:'Омега-3 2 г (EPA)',why:'С ужином'},{n:'Берберин 500 мг',why:'До ужина'},{n:'Витамин E 200-400 МЕ',why:'С ужином (жирорастворимый)'}]},
              ])}
