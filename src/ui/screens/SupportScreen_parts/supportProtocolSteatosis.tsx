                  ...
                  {[
                    ...
                    {phase:'ФАЗА 3 · ТЯЖЁЛЫЙ СТЕАТОЗ/НАСГ/ФИБРОЗ (CAP >300 / FIB-4 >2.67)', label:'НАСГ + риск цирроза', color:'#ef4444', condition:'CAP >300 / АЛТ >80 / FIB-4 >2.67 / эластография >8 кПа', desc:'Терапия под контролем гепатолога',
                      items:[
                        ...
                        {name:'Пиоглитазон 15-30 мг 💊', dose:'15-30 мг', timing:'Утро', note:triageBadge('rec')+' ↓ ИР + ↓ стеатоза. Контроль веса (+2-4 кг). ⚠ FDA warning: риск рака мочевого пузыря (контроль: макрогематурия, УЗИ). Противопоказан при СН NYHA III-IV. Переломы у женщин И мужчин. Контроль АЛТ. ↑ риска переломов (женщины)'},
