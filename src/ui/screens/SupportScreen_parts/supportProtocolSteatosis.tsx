                ...
                <div style={{ display:'flex', flexDirection:'column', gap:8 }}>
                  {[
                    ...
                    {phase:'ФАЗА 3 · ТЯЖЁЛЫЙ СТЕАТОЗ/НАСГ/ФИБРОЗ (CAP >300 / FIB-4 >2.67)', label:'НАСГ + риск цирроза', color:'#ef4444', condition:'CAP >300 / АЛТ >80 / FIB-4 >2.67 / эластография >8 кПа', desc:'Терапия под контролем гепатолога',
                      items:[
                        {name:'Берберин 500 мг 3×/день (макс.) + TUDCA по весу', dose:'500×3 + TUDCA 13-15 мг/кг', timing:'Берберин 3× до еды, TUDCA с едой 2×', note:triageBadge('ess')+' Берберин НЕ выше 1500 мг/сут. TUDCA — по весу с едой + разнос 3-4 ч от орального ААС. Add-on: метформин/пиоглитазон'},
