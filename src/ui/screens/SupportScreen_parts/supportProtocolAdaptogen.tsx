                ...
                <div style={{ display:'flex', flexDirection:'column', gap:8 }}>
                  {[
                    {phase:'ФАЗА 1 · ПОДДЕРЖКА HPA-ОСИ (кортизол в норме)', label:'Адаптогены + Mg', color:'#22c55e', condition:'Без симптомов дисбаланса кортизола', desc:'Профилактика HPA-дисфункции на курсе ААС',
                      items:[
                        {name:'Ашвагандха (Withania somnifera) 300-600 мг', dose:'300-600 мг', timing:'Вечер, за 30-60 мин до сна', note:triageBadge('ess')+' ↓ кортизол на 15-28% за 60 дн. ↑ свободный T. Синергия с магнием. ⚠ DILI-кейсы: АЛТ/АСТ через 4-8 нед. Сумма со всеми модулями ≤600 мг/сут'},
