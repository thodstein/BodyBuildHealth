                ...
                {[
                  ...
                  },
                  {
                    ...
                    items:[
                      ...
                      { name:'Изотретиноин (Роаккутан) 💊', dose:'0.5-1 мг/кг/день', timing:'С жирной едой', note:'⚠ Категория X (беременность). Строгая контрацепция за 1 мес до, во время и 1 мес после. Риск депрессии/суицида (FDA). НЕ комбинировать с витамином A (гипервитаминоз) — отмена вит. A за 2 нед до начала. ⚠ ТОЛЬКО по назначению дерматолога. Контроль АЛТ/АСТ, липидов. Тератогенность!' },
