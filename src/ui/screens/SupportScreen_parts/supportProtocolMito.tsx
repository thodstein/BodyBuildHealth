                ...
                <div style={{ display:'flex', flexDirection:'column', gap:8 }}>
                  {[
                    ...
                    {phase:'ФАЗА 2 · ОПТИМАЛЬНАЯ (курс 8+ нед / высокий объём)', label:'+ NAD⁺-бустеры', color:'#f59e0b', condition:'Курс >8 нед, высокий тренировочный объём, возраст >35', desc:'Усиление митохондриального биогенеза',
                      items:[
                        {name:'NMN / NR (никотинамид-рибозид) 250-500 мг', dose:'250-500 мг', timing:'Утро натощак', note:triageBadge('rec')+' NAD⁺-прекурсор. ↑ NAD⁺ на 40-80% по биомаркеру. ⚠ Уровень C: твёрдых исходов (сила/выживаемость) в РКИ нет — дорогой эксперимент, не база [C]'},
                        {name:'PQQ (пирролохинолинхинон) 10-20 мг', dose:'10-20 мг', timing:'Утро', note:triageBadge('opt')+' Стимулятор митохондриального биогенеза (PGC-1α) — в основном доклиника. Уровень C. Синергия с CoQ10 [C]'},
                        {name:'D-рибоза 5 г', dose:'5 г', timing:'После тренировки', note:triageBadge('opt')+' Субстрат для синтеза АТФ. Доказательства слабые; возможны ЖКТ-побочки. Только при высоком объёме [C]'},
                        {name:'Берберин 500 мг (макс. 1500 мг/сут)', dose:'500 мг', timing:'2×/день до еды', note:triageBadge('rec')+' AMPK-активатор → PGC-1α → биогенез митохондрий. Не превышать 500 мг 3×/день (ЖКТ + гипогликемия). CYP3A4-ингибитор: разнос 2+ ч с тадалафилом/анастрозолом'},
                      ]},
