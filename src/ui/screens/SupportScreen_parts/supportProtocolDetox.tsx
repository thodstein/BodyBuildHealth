                  ...
                  {[
                    { phase:'ФАЗА 1 · БАЗОВАЯ ДЕТОКСИКАЦИЯ', label:'NAC + АЛК + TUDCA', color:'#22c55e', condition:'Нормальные АЛТ/АСТ, нет оральных 17α-алкилов', desc:'Базовая поддержка детоксикации на любом курсе',
                      items:[
                        ...
                        { name:'TUDCA (тауроурсодезоксихолевая)', dose:'500-1000 мг', timing:'С едой в 2 приёма (едино с протоколом Печени)', note:'Снижает ER-стресс, улучшает желчеотток, защищает гепатоциты. Доза суммарно по весу ≈13-15 мг/кг/сут; TUDCA — экстраполяция рецептурной УДХК (РКИ при AAS-DILI нет). Разнос 3-4 ч с оральным ААС' },
                    ...
                    { phase:'ФАЗА 2 · УСИЛЕННАЯ (17α-алкилы)', label:'NAC ×2 + TUDCA + силимарин', color:'#f59e0b', condition:'Оральные 17α-алкилы (метандростенолон, станозолол, оксиметолон)', desc:'Усиленная детоксикация при токсичных ААС',
                      items:[
                        ...
                        { name:'TUDCA 1000 мг', dose:'1000 мг', timing:'С едой в 2 приёма (едино с протоколом Печени)', note:'Полная доза. Защита от ER-стресса, индуцированного 17α-алкилами. TUDCA — экстраполяция УДХК; разнос 3-4 ч с оральным ААС' },
