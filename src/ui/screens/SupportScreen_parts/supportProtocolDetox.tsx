          ...
          <InfoErrorBoundary label="Детокс">
            <div className="sup-proto-detox" style={{ paddingBottom: 30, display:'flex', flexDirection:'column', gap:8 }}>
                ...
                <div style={{ display:'flex', flexDirection:'column', gap:8 }}>
                  {[
                    { phase:'ФАЗА 1 · БАЗОВАЯ ДЕТОКСИКАЦИЯ', label:'NAC + АЛК + TUDCA', color:'#22c55e', condition:'Нормальные АЛТ/АСТ, нет оральных 17α-алкилов', desc:'Базовая поддержка детоксикации на любом курсе',
                      items:[
                        { name:'NAC (N-ацетилцистеин)', dose:'600-1200 мг', timing:'2×/день (утро/вечер)', note:'Предшественник глутатиона. Лимитирующий субстрат синтеза GSH. Связывает активные метаболиты токсинов [B]' },
                        ...
                        { name:'TUDCA (тауроурсодезоксихолевая)', dose:'500-1000 мг', timing:'С едой в 2 приёма (едино с протоколом Печени)', note:'Снижает ER-стресс, улучшает желчеотток, защищает гепатоциты. Доза суммарно по весу ≈13-15 мг/кг/сут; TUDCA — экстраполяция рецептурной УДХК (РКИ при AAS-DILI нет) [C]. Разнос 3-4 ч с оральным ААС' },
                    ...
                    { phase:'ФАЗА 2 · УСИЛЕННАЯ (17α-алкилы)', label:'NAC ×2 + TUDCA + силимарин', color:'#f59e0b', condition:'Оральные 17α-алкилы (метандростенолон, станозолол, оксиметолон)', desc:'Усиленная детоксикация при токсичных ААС',
                      items:[
                        { name:'NAC 1200 мг', dose:'1200 мг', timing:'2×/день (2400 мг/сут)', note:'Удвоенная доза для связывания токсичных метаболитов 17α-алкилов. Макс. 4000 мг/сут суммарно по всем модулям' },
                        { name:'Силимарин (экстракт расторопши)', dose:'280-560 мг', timing:'2×/день', note:'Стабилизирует мембраны гепатоцитов. ↑ РНК-полимеразу I. ↓ перекисного окисления липидов [B]' },
                        { name:'TUDCA 1000 мг', dose:'1000 мг', timing:'С едой в 2 приёма (едино с протоколом Печени)', note:'Полная доза. Защита от ER-стресса, индуцированного 17α-алкилами. TUDCA — экстраполяция УДХК [C]; разнос 3-4 ч с оральным ААС' },
              ...
              {detoxTab === 'timing' && (
                <div style={cardBg}>
                  ...
                  <p style={{ fontSize:8, color:'var(--text-dim)', margin:'0 0 8px', lineHeight:1.3 }}>NAC и АЛК натощак или с едой (при чувствительном ЖКТ). TUDCA — с едой в 2 приёма (едино с протоколом Печени, по лейблу УДХК); натощак на ночь — только при нормальной переносимости и вдали от орального ААС. Силимарин с едой.</p>
                  {[
                    ...
                    { time:'🌙 Вечер (19:00–22:00)', color:'#6366f1', items:[
                      ...
                      { n:'TUDCA 500-1000 мг', why:'С едой в 2 приёма (едино с Печенью). На ночь натощак — допустимо, но не с оральным ААС' },
            ...
            <div style={{ borderRadius:12, padding:12, background:'rgba(245,158,11,0.06)', border:'1px solid rgba(245,158,11,0.2)' }}>
              ...
              <div style={{ fontSize:8, color:'var(--text-dim)', lineHeight:1.5 }}>
                ...
                • ⚠ <b>Кросс-модульный лимит NAC:</b> NAC используется в Детоксе, Иммунитете (фаза 3) и Печени. Суммарно НЕ превышать 4000 мг/сут из всех протоколов
              </div>
            </div>
