            ...
            <div style={{ display:'flex', alignItems:'flex-start', gap:10 }}>
              ...
              <div>
                ...
                <div style={{ fontSize:10, fontWeight:700, color:'#fca5a5', marginBottom:6, lineHeight:1.4 }}>
                  Назначение препаратов, выбор схемы и метода лечения/коррекции осуществляется <b style={{color:'#ef4444'}}>ТОЛЬКО ВРАЧОМ</b> на основании очного осмотра, сбора анамнеза и лабораторных данных. Фазы 3–4 протоколов — <b style={{color:'#ef4444'}}>только врач</b> (дозы ниже — ориентиры для обсуждения, не схема приёма). Внутривенные формы — <b style={{color:'#ef4444'}}>только стационар</b>, дома не вводить.
                </div>
