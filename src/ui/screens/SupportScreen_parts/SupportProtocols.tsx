                ...
                <div style={{ display:'flex', flexDirection:'column', gap:8 }}>
                  <div style={cardBg}>
                    ...
                    {[{ marker:'Липидный профиль (ЛПНП, ЛПВП, ТГ, ЛП(а))', target:'ЛПНП {'<'}130', when:'Каждые 4-8 нед', action:'ЛПНП {'>'}160 — фаза 2. ТГ {'>'}2.3 — рассмотреть фенофибрат' },
                      ...
                      { marker:'Калий (K⁺)', target:'3.5-5.0 ммоль/л', when:'Каждые 2-4 нед', action:'{'<'}3.5 — калий. {'>'}5.5 — риск гиперкалиемии при эплереноне/РААС-блокаде' },
                  ...
                  {[
                    ...
                    { phase:'ФАЗА 4 · ВЫСОКИЕ ДОЗЫ / ТОКСИЧНОСТЬ', label:'GH {'>'}8 МЕ/день', color:'#ef4444', condition:'IGF-1 {'>'}500, симптомы акромегалии', desc:'Неотложная коррекция',
                      items:[
                        ...
                        { name:'Метформин 1000-2000 мг', dose:'1000-2000 мг', timing:'2×/день с едой', note:'↓ гипергликемии, вызванной GH. Не снижает IGF-1, но контролирует метаболические последствия' },
                  ...
                  {[
                    ...
                    {phase:'ФАЗА 2 · УМЕРЕННЫЙ РИСК (AAS 500-1000 мг + диуретики)', label:'Коррекция', color:'#f59e0b', condition:'Курс 500-1000 мг / тиазидные диуретики / GLP-1 / диарея', desc:'Превентивная коррекция при факторах риска',
                      items:[
                        ...
                        {name:'Калий-сберегающие (эплеренон) 💊', dose:'25-50 мг', timing:'Утро', note:triageBadge('rec')+' Селективный антагонист MR. БЕЗ антиандрогенных эффектов. При гипокалиемии <3.5. Контроль K⁺ через 5-7 дней после старта'},
                      ]},
