            ...
            <div className="sup-proto-electrolytes" style={{ paddingBottom:30, display:'flex', flexDirection:'column', gap:8 }}>
              ...
              {electrolytesTab==='emergency'&&(
                <div style={cardBg}>
                  ...
                  {[
                    {cond:'Гипокалиемия (K⁺ <3.5)', rec:'Увеличить калий до 800-1200 мг/день. Добавить эплеренон 25-50 мг (селективный MR-антагонист, без антиандрогенных эффектов). Отменить тиазиды. ЭКГ. При <3.0 — в/в только в стационаре/скорой', source:'KDIGO, 2023'},
