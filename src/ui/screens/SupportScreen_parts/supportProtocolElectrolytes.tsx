            ...
            <div className="sup-proto-electrolytes" style={{ paddingBottom:30, display:'flex', flexDirection:'column', gap:8 }}>
              ...
              {electrolytesTab==='emergency'&&(
                <div style={cardBg}>
                  ...
                  {[
                    {cond:'Гипокалиемия (K⁺ <3.5)', rec:'Увеличить калий до 800-1200 мг/день. Добавить эплеренон 25-50 мг (селективный MR-антагонист, без антиандрогенных эффектов). Отменить тиазиды. ЭКГ. При <3.0 — в/в только в стационаре/скорой [A]', source:'KDIGO, 2023'},
                    {cond:'Гиперкалиемия (K⁺ >5.0)', rec:'Отменить эплеренон. Отменить ингибиторы РААС (телмисартан). Петлевые диуретики. Глюконат Ca²⁺ в/в только в стационаре', source:'KDIGO, 2023'},
                    {cond:'Гипомагниемия (Mg <0.75)', rec:'Mg-цитрат 400-800 мг/день. При <0.65 — в/в MgSO₄ только в стационаре. Коррекция без Mg неэффективна для K⁺', source:'NICE, 2022'},
              ...
              {electrolytesTab==='monitoring' && monitoringBlock([
                ...
                {marker:'Mg²⁺ (магний)', target:'0.75-1.0 ммоль/л', when:'1×/нед', action:'<0.75 → ↑ Mg. <0.65 → в/в MgSO₄ только в стационаре'},
