                  ...
                  {[
                    ...
                    { phase:'ФАЗА 2 · НИЗКИЕ ДОЗЫ GH', label:'GH 2-4 МЕ/день', color:'#f59e0b', condition:'IGF-1 200-350 нг/мл, контроль глюкозы', desc:'Метаболическая доза. Анаболизм + жиросжигание',
                      items:[
                        ...
                        { name:'Метформин 500 мг 💊', dose:'500 мг', timing:'2×/день с едой', note:'Обязательно на GH! ↓ риска гипергликемии. Контроль глюкозы натощак через 2 нед. По назначению врача [A]' },
                    ...
                    { phase:'ФАЗА 3 · СРЕДНИЕ ДОЗЫ GH', label:'GH 4-8 МЕ/день', color:'#f97316', condition:'IGF-1 350-500 нг/мл', desc:'Анаболическая доза. Только для опытных',
                      items:[
                        ...
                        { name:'Инсулин — НЕ опция протокола вне СД ⚠', dose:'Только манифестный СД', timing:'Под эндокринологом', note:'⚠ Инсулин вне сахарного диабета = жизнеугрожающая гипогликемия, смерть. В протоколе НЕ предлагается как опция. При GH-гипергликемии первая линия: снижение/отмена GH + метформин 1000 мг. Инсулин — только манифестный СД, только эндокринолог' },
                ...
                <div style={{ display:'flex', flexDirection:'column', gap:8 }}>
                  <div style={cardBg}>
                    ...
                    {[{ marker:'IGF-1 (соматомедин C)', target:'150-350 нг/мл (возраст-зависимо)', when:'Каждые 4-8 нед на GH', action:'{'<'}150 — ↓ дозу GH/секретагога. {'>'}500 — ↓ дозу GH на 50%. {'>'}600 — отмена GH. Акромегалия!' },
                      { marker:'Глюкоза натощак', target:'{'<'}5.6 ммоль/л', when:'Еженедельно на GH (+ постпрандиальная при >5.6)', action:'5.6-7.0 — метформин 1000 мг + ↓/отмена GH. {'>'}7.0 — снизить/отменить GH + эндокринолог (инсулин — только манифестный СД у эндо). {'>'}11.1 — диабет. Эндокринолог' },
