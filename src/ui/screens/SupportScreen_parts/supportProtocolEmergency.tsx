              ...
              {[
                {
                  ...
                  whatToDo:'🚑 Немедленно скорую. Аспирин 300 мг разжевать (если нет аллергии). Нитроглицерин под язык (если АД >100 сист.). ЭКГ в первые 10 мин. Тропонин I через 3-6 ч. Не ждать — каждая минута промедления = гибель миокарда.',
                },
                {
