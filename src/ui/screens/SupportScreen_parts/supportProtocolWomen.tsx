        ...
        {womenTab === 'drugs' && (
          <div style={{ display:'flex', flexDirection:'column', gap:8 }}>
            <div style={cardBg}>
              ...
              {[
                { drug:'Оксандролон (Anavar) 5-10 мг/день', safety:'🟡 Только под гинекологом-эндокринологом', note:'Наименее андрогенный ААС (клиника: ожоги/ВИЧ-кахексия у женщин), но вирилизация 30%+ уже на 10 мг/8 нед — «условно» не значит «безопасно». База: запись голоса до старта + еженедельно; при первой хрипоте — отмена. Менструальный дневник + общ.T/св.T/SHBG каждые 4 нед.' },
