          ...
          <div style={{ display:'flex', flexDirection:'column', gap:8 }}>
            <div style={cardBg}>
              ...
              {[
                ...
                { drug:'Кленбутерол 20-40 мкг/день', safety:'🟡 Условно допустимо', note:'β2-агонист. Не андроген. Но: тремор, тахикардия, гипокалиемия. У женщин риск остеопороза при длительном приёме.' },
                ...
                { drug:'Каберголин 0.125-0.25 мг 2×/нед', safety:'🟢 Условно безопасно', note:'Дофаминовый агонист. При пролактине >25. Титрация под контроль ПРЛ. У женщин доза 0.125-0.25 мг 1-2р/нед (НЕ 0.25 мг 2р/нед — риск опиоидной зависимости).' },
              ].map((x: any, i: any) => (
                <div key={i} style={{ padding:'8px 10px', borderRadius:8, marginBottom:4, background:'rgba(244,114,182,0.04)', border:'1px solid rgba(244,114,182,0.08)' }}>
                  <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center' }}>
