        ...
        {womenTab === 'drugs' && (
          <div style={{ display:'flex', flexDirection:'column', gap:8 }}>
            <div style={cardBg}>
              ...
              <p style={{ fontSize:8, color:'var(--text-dim)', margin:'0 0 8px', lineHeight:1.3 }}>Официальные позиции безопасности. Справочные дозовые пороги (harm-reduction ориентиры), калькулятор Virilization Score и пептиды/SARMs — в табе «⚖️ Дозы веществ».</p>
              {[
