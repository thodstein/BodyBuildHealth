                ...
                <div style={{ display:'flex', flexDirection:'column', gap:8 }}>
                  {[
                    ...
                    { phase:'ФАЗА 2 · ДИСПЕПСИЯ', label:'Тяжесть, изжога, вздутие', color:'#f59e0b', condition:'Эпизодическая изжога, тяжесть', desc:'Симптоматическая терапия',
                      items:[
                        { name:'ИПП (омепразол 20 мг / пантопразол 40 мг) 💊', dose:'20-40 мг', timing:'Утро за 30 мин до еды', note:'Блокада протонной помпы. Курс 4-8 нед. ⚠ >8 нед — контроль B12, Mg²⁺, Fe сыворотки (риск дефицитов). По назначению врача [A]' },
