                  ...
                  {[
                    ...
                    { phase:'ФАЗА 3 · ТЯЖЁЛАЯ БЕССОННИЦА', label:'{'>'}60 мин засыпания', color:'#f97316', condition:'{'>'}60 мин засыпания, {'>'}3 пробуждения/ночь', desc:'Интенсивная терапия сна',
                      items:[
                        ...
                        { name:'Ашваганда (экстракт KSM-66)', dose:'600 мг', timing:'За 30 мин до сна', note:'Адаптоген. ↓ кортизола на 20-30%. ⚠ DILI-кейсы 2023: контроль АЛТ/АСТ через 4-8 нед; при ↑ — отмена. Сумма ашваганды со всеми модулями ≤600 мг/сут' },
