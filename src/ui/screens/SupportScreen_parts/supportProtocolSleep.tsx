                ...
                <div style={{ display:'flex', flexDirection:'column', gap:8 }}>
                  {[
                    { phase:'ФАЗА 1 · ГИГИЕНА СНА', label:'Базовая поддержка', color:'#22c55e', condition:'Лёгкие нарушения, {'<'}30 мин засыпания', desc:'Гигиена сна + базовые добавки',
                      items:[
                        { name:'Мелатонин (пролонгированный)', dose:'0.5-2 мг (макс. 5 мг)', timing:'За 30-60 мин до сна', note:'Старт 0.5-1 мг; чаще хватает 0.5-2 мг. Высокие дозы ↑ сонливости днём и ярких снов без выигрыша. Не применять {'>'}6 мес непрерывно [A]' },
                        { name:'Магний L-треонат / глицинат', dose:'200-400 мг', timing:'За 1 ч до сна', note:'Магний L-треонат проникает через ГЭБ — улучшает качество сна. ↓ кортизола. ⚠ Сумма со всеми модулями ≤800 мг/сут' },
                    ...
                    { phase:'ФАЗА 2 · УМЕРЕННАЯ БЕССОННИЦА', label:'30-60 мин засыпания', color:'#f59e0b', condition:'30-60 мин засыпания, 1-2 пробуждения', desc:'Фармакологическая поддержка',
                      items:[
                        ...
                        { name:'ГАМК (GABA) — НЕ рекомендуется', dose:'—', timing:'—', note:'Биодоступность через ГЭБ <1%, в крупных РКИ как снотворное не доказана. Из схемы убрать — оставить Mg L-треонат с доказанной ГЭБ-проницаемостью.' },
                      ]},
                    { phase:'ФАЗА 3 · ТЯЖЁЛАЯ БЕССОННИЦА', label:'{'>'}60 мин засыпания', color:'#f97316', condition:'{'>'}60 мин засыпания, {'>'}3 пробуждения/ночь', desc:'Интенсивная терапия сна',
                      items:[
                        { name:'Мелатонин пролонг — кап 5 мг', dose:'до 5 мг', timing:'За 1-2 ч до сна', note:'Не превышать 5 мг без врача: выше — сонливость, яркие сны, возможен ↑ пролактина. Контроль уровня кортизола!' },
                        ...
                        { name:'Ашваганда (экстракт KSM-66)', dose:'600 мг', timing:'За 30 мин до сна', note:'Адаптоген. ↓ кортизола в среднем на 20-30% по РКИ [B]. ⚠ DILI-кейсы 2023: контроль АЛТ/АСТ через 4-8 нед; при ↑ — отмена. Сумма ашваганды со всеми модулями ≤600 мг/сут' },
                    ...
                    { phase:'ФАЗА 4 · ТРЕБОЛОН/АПНОЭ', label:'Трен-сон / храп', color:'#ef4444', condition:'Кошмары (тренболон) / остановки дыхания', desc:'Специфическая терапия',
                      items:[
                        { name:'Празиозин 1-5 мг 💊', dose:'1-5 мг (старт 1 мг)', timing:'На ночь', note:'α1-блокатор off-label. ↓ кошмаров и ночных пробуждений (особенно на тренболоне). ⚠ Первая доза — синкопе/ортостатическая гипотония: старт 1 мг лёжа, вставать медленно; не сочетать с тадалафилом/АГП без врача. По назначению врача' },
                ...
                <div style={cardBg}>
                  ...
                  {[
                    ...
                    { time:'🌃 За 30-60 мин до сна', color:'#f97316', items:[
                      { n:'Мелатонин 0.5-5 мг (кап)', why:'За 30-60 мин. Пролонг — за 2 ч. Не выше 5 мг без врача' },
