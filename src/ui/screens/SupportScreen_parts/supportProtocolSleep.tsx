                ...
                <div style={{ display:'flex', flexDirection:'column', gap:8 }}>
                  {[
                    { phase:'ФАЗА 1 · ГИГИЕНА СНА', label:'Базовая поддержка', color:'#22c55e', condition:'Лёгкие нарушения, {'<'}30 мин засыпания', desc:'Гигиена сна + базовые добавки',
                      items:[
                        { name:'Мелатонин (пролонгированный)', dose:'0.5-2 мг (макс. 5 мг)', timing:'За 30-60 мин до сна', note:'Старт 0.5-1 мг; чаще хватает 0.5-2 мг. Высокие дозы ↑ сонливости днём и ярких снов без выигрыша. Не применять {'>'}6 мес непрерывно' },
