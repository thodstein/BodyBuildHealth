          ...
          <InfoErrorBoundary label="Кожа/Волосы">
                  ...
                  {[
                    { phase:'ФАЗА 1 · ПРОФИЛАКТИКА', label:'Нет симптомов', color:'#22c55e', condition:'Нет выпадения, нет акне', desc:'Базовая поддержка кожи/волос на курсе',
                      items:[
                        ...
                        { name:'Витамин D3', dose:'2000-4000 МЕ', timing:'С жирной едой', note:'Участвует в цикле волосяного фолликула. Дефицит D3 — выпадение. >4000 МЕ — контроль 25-OH-D и Ca²⁺' },
                    ...
                    { phase:'ФАЗА 2 · ВЫПАДЕНИЕ ВОЛОС', label:'{'>'}100 волос/день', color:'#f59e0b', condition:'Заметное выпадение', desc:'Анти-DHT и рост-стимулирующая терапия',
                      items:[
                        { name:'Финастерид 0.5-1 мг 💊 (только при АГА)', dose:'0.5-1 мг', timing:'Утро', note:'Ингибитор 5α-редуктазы 2 типа. ↓ DHT в коже на 60-70%. Эффект через 3-6 мес. ⚠ FDA: сексуальные/психические НЯ, ↓ фертильности/спермы (обратимо). Не делить капсулы при беременной партнёрше дома (тератоген). По назначению врача [A]' },
                        { name:'Дутастерид 0.5 мг 💊 (резистентность к финастериду)', dose:'0.5 мг', timing:'Утро', note:'Ингибитор 5α-редуктазы 1+2 типа. ↓ DHT на 90%. Сильнее, но больше побочек (те же FDA + дольше вывод). См. «Женщины и ААС» (кат. X). Только один из двух. По назначению врача [A]' },
                        { name:'Миноксидил 5% топический', dose:'1 мл', timing:'2×/день', note:'Вазодилататор фолликулов. Продлевает фазу анагена. Эффект через 4-6 мес. Первые 2-8 нед — shedding (норма). При одышке/боли в груди/отёках — к врачу (редкий перикардиальный выпот) [A]' },
                ...
                <div style={cardBg}>
                  ...
                  {[
                    ...
                    { time:'☀️ День (12:00–16:00)', color:'#f97316', items:[
                      { n:'D3 2000-4000 МЕ с обедом', why:'С жирной едой. Цикл волосяного фолликула' },
            ...
            <div style={{ borderRadius:12, padding:12, background:'rgba(245,158,11,0.06)', border:'1px solid rgba(245,158,11,0.2)' }}>
              ...
              <div style={{ fontSize:8, color:'var(--text-dim)', lineHeight:1.5 }}>
                ...
                • 🔴 <b>Акне:</b> См. отдельный протокол акне. Комплексная терапия — топики + системные антибиотики + БПО<br/>
                • ⚠ <b>Кросс-модульный лимит:</b> Zn ≤50 мг/сут суммарно (Акне+Волосы+Иммунитет). Финастерид/дутастерид — ТОЛЬКО один из двух, НЕ комбинировать
              </div>
            </div>
