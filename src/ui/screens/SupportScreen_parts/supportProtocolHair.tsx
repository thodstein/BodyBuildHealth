                ...
                <div style={{ display:'flex', flexDirection:'column', gap:8 }}>
                  {[
                    ...
                    { phase:'ФАЗА 2 · ВЫПАДЕНИЕ ВОЛОС', label:'{'>'}100 волос/день', color:'#f59e0b', condition:'Заметное выпадение', desc:'Анти-DHT и рост-стимулирующая терапия',
                      items:[
                        { name:'Финастерид 0.5-1 мг 💊 (только при АГА)', dose:'0.5-1 мг', timing:'Утро', note:'Ингибитор 5α-редуктазы 2 типа. ↓ DHT в коже на 60-70%. Эффект через 3-6 мес. По назначению врача' },
                        { name:'Дутастерид 0.5 мг 💊 (резистентность к финастериду)', dose:'0.5 мг', timing:'Утро', note:'Ингибитор 5α-редуктазы 1+2 типа. ↓ DHT на 90%. Сильнее, но больше побочек. По назначению врача' },
