                ...
                <div style={{ display:'flex', flexDirection:'column', gap:8 }}>
                  {[
                    ...
                    { phase:'ФАЗА 2 · ВЫПАДЕНИЕ ВОЛОС', label:'{'>'}100 волос/день', color:'#f59e0b', condition:'Заметное выпадение', desc:'Анти-DHT и рост-стимулирующая терапия',
                      items:[
                        { name:'Финастерид 0.5-1 мг 💊 (только при АГА)', dose:'0.5-1 мг', timing:'Утро', note:'Ингибитор 5α-редуктазы 2 типа. ↓ DHT в коже на 60-70%. Эффект через 3-6 мес. ⚠ FDA: сексуальные/психические НЯ, ↓ фертильности/спермы (обратимо). Не делить капсулы при беременной партнёрше дома (тератоген). По назначению врача' },
                        { name:'Дутастерид 0.5 мг 💊 (резистентность к финастериду)', dose:'0.5 мг', timing:'Утро', note:'Ингибитор 5α-редуктазы 1+2 типа. ↓ DHT на 90%. Сильнее, но больше побочек (те же FDA + дольше вывод). См. «Женщины и ААС» (кат. X). Только один из двух. По назначению врача' },
                        { name:'Миноксидил 5% топический', dose:'1 мл', timing:'2×/день', note:'Вазодилататор фолликулов. Продлевает фазу анагена. Эффект через 4-6 мес. Первые 2-8 нед — shedding (норма). При одышке/боли в груди/отёках — к врачу (редкий перикардиальный выпот)' },
