            ...
            <div className="sup-proto-hepatic" style={{ paddingBottom: 30, display:'flex', flexDirection:'column', gap:8 }}>
              ...
              {hepaticTab === 'mechanisms' && (
                <div style={cardBg}>
                  ...
                  {[
                    ...
                    { title:'Холестаз', desc:'Подавление BSEP, MDR3, MRP2 → нарушение оттока желчи. ЩФ, ГГТ повышаются. УДХК — лекарство с дозой по весу (13-15 мг/кг); TUDCA — её конъюгат/экстраполяция (РКИ при AAS-DILI нет, уровень ниже).' },
                    { title:'Bland-холестаз (паттерн 17α-алкил)', desc:'Билирубин/ЩФ↑ при почти нормальных АЛТ/АСТ + зуд, латентность 4-12 нед (LiverTox/CLD 2024). Первое действие — ОТМЕНА оралки, а не добавление гепатопротектора; желтуха/зуд после отмены могут держаться неделями.' },
                  ...
                  {[
                    {
                      ...
                      items:[
                        ...
                        { name:'TUDCA', dose:'250-500 мг 2×/день (суммарно ≈13-15 мг/кг/сут с едой)', timing:'С едой 2×/день, за 3-4 ч от орального ААС', note:'Гидрофильная желчная кислота. Снижение ER-стресса, стимуляция BSEP → желчеотток. Честно: TUDCA — экстраполяция рецептурной УДХК (РКИ при AAS-DILI нет); при доступной УДХК — она первее. Антиапоптотическое. Дозу считать по весу (≈13-15 мг/кг/сут как УДХК). С ЕДОЙ в 2 приёма (не однократно натощак). Разнести с оральным ААС на 3-4 ч (желчные кислоты связывают липофилы). Продолжить 2-4 нед ПОСЛЕ отмены оралки (пик АЛТ/билирубина позже отмены) [C]' },
                    ...
                    },
                    {
                      ...
                      items:[
                        ...
                        { name:'Берберин', dose:'500 мг 2-3×/день', timing:'С едой', note:'AMPK-активатор → снижение липогенеза и стеатоза. CYP3A4-ингибитор: разнос 2+ ч с оральными ААС/статинами/тадалафилом/анастрозолом. ⚠ С осторожностью при камнях в желчном пузыре или билиарном сладже — возможна желчная колика' },
                      ]
                    },
                    {
                      ...
                      items:[
                        ...
                        { name:'Урсодезоксихолевая кислота (УДХК)', dose:'10-15 мг/кг/сут в 2-3 приёма с едой', timing:'С едой 2-3×/день + разнос 3-4 ч от орального ААС', note:'При ГГТ/ЩФ ↑ (холестаз) — УДХК 10-15 мг/кг/сут С ЕДОЙ в 2-3 приёма (лейбл: 13-15 мг/кг). Если нет рецептурного УДХК — TUDCA в той же весовой дозе. Разнести с оральным ААС на 3-4 ч. Продолжить 2-4 нед после отмены оралки [A]' },
                        { name:'Берберин', dose:'500 мг 2-3р/сут', timing:'За 15-30 мин до еды', note:'⚠ AMPK-активатор, снижает липогенез, улучшает инсулинорезистентность. ⚠ РИСК ЖЕЛЧНОЙ КОЛИКИ при камнях ЖКБ (берберин стимулирует сокращение желчного пузыря). УЗИ ЖКБ ОБЯЗАТЕЛЬНО перед стартом. Контроль глюкозы (гипогликемия). CYP3A4-разнос 2+ ч (см. Ф1)' },
                    ...
                    },
                    {
                      ...
                      items:[
                        ...
                        { name:'Эссенциале в/в (фосфатидилхолин) 💊', dose:'5-10 мл/день в/в', timing:'Курс 10-14 дней — только стационар', note:'Внутривенная форма — макс. биодоступность. Прямое встраивание в мембраны гепатоцитов. Дома не вводить. Под наблюдением врача/медсестры' },
                        { name:'Гептрал (адеметионин) в/в 💊', dose:'400-800 мг/день в/в', timing:'Курс 14-21 день — только стационар', note:'В/в форма SAMe. Донор метильных групп без аммиак-образования. Синтез глутатиона + фосфатидилхолина. При холестазе и цитолизе. Дома не вводить. По назначению' },
              ...
              {hepaticTab === 'timing' && (
                <div style={cardBg}>
                  ...
                  <p style={{ fontSize:8, color:'var(--text-dim)', margin:'0 0 8px', lineHeight:1.3 }}>Гепатопротекторы распределяются на весь день. NAC и АЛК натощак, фосфолипиды с едой, УДХК/TUDCA — с едой в 2 приёма + разнос 3-4 ч от орального ААС, продолжить 2-4 нед после отмены оралки.</p>
                  {[
...
{ time:'☀️ День (12:00–14:00)', color:'#f59e0b', items:[
                    ...
                    { time:'🌙 Вечер/Ночь (19:00–22:00)', color:'#6366f1', items:[
                      { n:'УДХК по весу (10-15 мг/кг/сут) С ЕДОЙ в 2-3 приёма (Фаза 3-4)', why:'С едой — по лейблу (13-15 мг/кг). Разнос 3-4 ч от орального ААС. Продолжить 2-4 нед после отмены оралки. При фазе 4 — только УДХК, TUDCA запрещён' },
