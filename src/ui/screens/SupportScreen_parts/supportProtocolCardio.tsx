                  ...
                  {[
                    ...
                    },
                    {
                      ...
                      items:[
                        ...
                        { name:'Красный дрожжевой рис (монаколин К)', dose:'1200-2400 мг (≈10 мг монаколина К)', timing:'Вечер', note:'Природный статин (монаколин К = ловастатин). ↓ ЛПНП на 20-30%. ⚠ НЕ комбинировать с рецептурным статином (миопатия/рабдомиолиз)! Брать стандартизированный RYR БЕЗ цитринина (почечный токсин). Контроль АЛТ/АСТ и КФК' },
