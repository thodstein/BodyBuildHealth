                  ...
                  {[
                    {
                      ...
                      items:[
                        { name:'Omega-3 (EPA+DHA)', dose:'3-5 г', timing:'С едой 2×/день', note:'EPA >2 г: ↓ ТГ на 25-30%. Честно: безрецептурный рыбий жир ≠ икозапент 4 г (REDUCE-IT — только hyperTG на статине, см. фазу 4); MACE не снижает (STRENGTH 2020 — null), при высоких дозах — ↑риск ФП. Не замена снижению дозы/эзетимибу' },
