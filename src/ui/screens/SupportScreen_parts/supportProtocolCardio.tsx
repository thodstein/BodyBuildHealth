                  ...
                  {[
                    ...
                    },
                    {
                      ...
                      items:[
                        ...
                        { name:'Донация крови / флеботомия', dose:'300-450 мл', timing:'По Hct (см. примечание)', note:'Снижение Hct на 3-5% за процедуру. Режим: Hct 52-54% — флеботомия 300-400 мл 1-2×/нед до Hct <48%; Hct >54% — 400-500 мл вплоть до ежедневно до <48% под контролем АД/пульса. Донорство 1×/2-3 мес — только поддержание при Hct <50%, НЕ лечение Hct >52%. Перед решением — регидратация + повтор Hct (утренняя дегидратация завышает на 2-3%). Контроль ферритина/ОЖСС до и каждые 4-8 нед: повторные кровопускания → Fe-дефицит → реактивный тромбоцитоз → парадоксальный тромбоз; при ферритине <30 — пауза + Fe-коррекция с врачом. Риск тромбоза растёт с Hct >52%' },
