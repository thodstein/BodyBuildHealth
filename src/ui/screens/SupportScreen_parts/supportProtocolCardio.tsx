                  ...
                  {[
                    ...
                    },
                    {
                      ...
                      items:[
                        ...
                        { name:'Красный дрожжевой рис (монаколин К) ⚠ — ВТОРАЯ линия после эзетимиба', dose:'1200-2400 мг (≈10 мг монаколина К)', timing:'Вечер', note:'⚠ ПРИРОДНЫЙ СТАТИН (монаколин К = ловастатин): та же миопатия/гепатотоксичность, плюс разброс 0.09-5.48 мг между брендами + риск цитринина (нефротоксин). Лестница: сначала эзетимиб 10 мг (стандартизирован, без миопатии); RYR — только при непереносимости/недоступности эзетимиба + обязательно БЕЗ цитринина + CoQ10 200 мг. КОНТРАИНДИЦИРОВАН при АЛТ/АСТ >2×ВГН. НЕ комбинировать с рецептурным статином и CYP3A4-ингибиторами (макролиды/азолы/грейпфрут → рабдомиолиз). Контроль АЛТ/АСТ и КФК ОБЯЗАТЕЛЬНЫ' },
