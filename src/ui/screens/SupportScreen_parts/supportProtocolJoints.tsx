              ...
              <div style={{ display:'flex', flexDirection:'column', gap:8 }}>
                {[
                  ...
                  },
                  {
                    ...
                    items:[
                      { name:'BPC-157 ⚠', dose:'250-500 мкг', timing:'Утро + Вечер', note:'Пентадекапептид. Заживление сухожилий и связок. ⚠ Хранить при 2-8°C (холодовая цепь). После разведения — не более 7-14 дней. Не встряхивать — пузырьки денатурируют пептид. ⚠ Исследовательский пептид — не одобрен FDA/EMA к клиническому применению, контроль качества производителя' },
                      { name:'TB-500 (Thymosin β4) ⚠', dose:'2.5-5 мг', timing:'2×/нед', note:'Полимеризация G-актина. ⚠ Хранить при 2-8°C. После разведения — не более 7-14 дней. Регенерация тканей, антивоспалительное. ⚠ Исследовательский пептид — не одобрен FDA/EMA к клиническому применению' },
