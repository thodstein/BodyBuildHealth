                ...
                {[
                  {
                    ...
                    items:[
                      { name:'Коллаген II типа (UC-II)', dose:'40 мг', timing:'Утро натощак', note:'Нативный неденатурированный коллаген. Оральная толерантность. Снижение боли — эффект умеренный (Lugo/Crowley) [B]' },
                      ...
                      { name:'Витамин D3 + K2', dose:'2000-4000 МЕ + 100 мкг', timing:'С жирной едой', note:'Кальциевый обмен. D3 → абсорбция Ca²⁺. K2 → активация остеокальцина → Ca²⁺ в кости, не в сосуды. Контроль 25-OH-D и Ca²⁺' },
                        { name:'Желатин гидролизованный', dose:'10-15 г', timing:'Натощак / за 1 ч до тренировки', note:'Субстрат коллагена: глицин + пролин + гидроксипролин. + вит.C за 1 ч до нагрузки → синтез коллагена (малое РКИ Shaw) [B]' },
                    ]
                  },
                  {
                    ...
                    items:[
                        { name:'Глюкозамин сульфат', dose:'1500 мг', timing:'С едой', note:'Субстрат гликозаминогликанов. Стимуляция протеогликанов хондроцитами. Только сульфатная форма работает. При строгом concealment пользы по боли нет (мета 20 RCT) [C]' },
                        { name:'Хондроитин сульфат', dose:'800-1200 мг', timing:'С едой', note:'Ингибирование MMP-3/MMP-13. Удержание воды в матриксе хряща. Мол. масса 14-20 кДа [C]' },
