...
export const SUPPLEMENT_DAIRY: FoodItem[] = [
  ...
  {id:"psyllium_husk",name:"Псиллиум (шелуха подорожника)",category:"fat",kcal:200,protein:2.5,fat:0.5,carbs:85,fiber:80,gi:0,servingSize:"10 г",tier:"basic",bestFor:["cutting"],isVegan:true,isGlutenFree:true,micros:{Ca:30,Fe:1.5,Mg:15,P:20,K:200,Zn:0.2}},
