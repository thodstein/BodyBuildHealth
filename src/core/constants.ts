...
export const UCUM_MAP: Record<string, { prefUnit: string; coeff: number; uln: number; lln: number; name: string }> = {
  ...
  'CREATININE': { prefUnit: 'µmol/L', coeff: 88.42, uln: 110, lln: 60, name: 'Креатинин' },
  'UREA': { prefUnit: 'mmol/L', coeff: 1, uln: 7.1, lln: 2.5, name: 'Мочевина' },
  'UA': { prefUnit: 'µmol/L', coeff: 1, uln: 420, lln: 200, name: 'Мочевая к-та' },
  'FERRITIN': { prefUnit: 'µg/L', coeff: 1, uln: 300, lln: 30, name: 'Ферритин' },
