...
export const FOOD_DB: FoodItem[] = [
  ...
  { id: 'couscous', name: 'Кус-кус (вареный)', category: 'grain', kcal: 112, protein: 3.8, fat: 0.2, carbs: 23, fiber: 1.4, gi: 65, servingSize: '150 г', micros: { Mg: 8, P: 22, Fe: 0.4, Se: 27, VitB3: 1.0, K: 58 }, tier: 'basic', allergens: ['gluten'], isVegetarian: true, isVegan: true, isGlutenFree: false, isDairyFree: true, dietTags: [] },
  ...
  { id: 'edamame', name: 'Эдамаме (соевые бобы)', category: 'protein', kcal: 121, protein: 12, fat: 5, carbs: 9, fiber: 5.2, gi: 18, servingSize: '100 г', micros: { Fe: 2.3, Mg: 64, P: 160, K: 480, VitC: 6, VitK: 27, VitB9: 311, Ca: 63 }, tier: 'basic', allergens: ['soy'], isVegetarian: true, isVegan: true, isGlutenFree: true, isDairyFree: true, dietTags: [] },
  { id: 'mango', name: 'Манго', category: 'veg_fruit', kcal: 60, protein: 0.8, fat: 0.4, carbs: 15, fiber: 1.6, gi: 51, servingSize: '200 г', micros: { VitC: 36, VitA: 54, VitB6: 0.1, VitE: 0.9, K: 168, Cu: 0.1 }, tier: 'basic', allergens: [], isVegetarian: true, isVegan: true, isGlutenFree: true, isDairyFree: true, dietTags: [] },
  { id: 'dates', name: 'Финики сушёные', category: 'carb', kcal: 282, protein: 2.5, fat: 0.4, carbs: 75, fiber: 8, gi: 50, servingSize: '40 г', micros: { K: 656, Mg: 43, Fe: 0.9, VitB6: 0.1, Cu: 0.2, Mn: 0.3, P: 62 }, tier: 'basic', allergens: [], isVegetarian: true, isVegan: true, isGlutenFree: true, isDairyFree: true, dietTags: [] },
