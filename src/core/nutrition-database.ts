...
export const FOOD_DB: FoodItem[] = [
  ...
  { id: 'whole_grain_bread', name: 'Хлеб цельнозерновой', category: 'carb', kcal: 250, protein: 9, fat: 3, carbs: 47, fiber: 7, gi: 50, servingSize: '40г', description: 'Сложные углеводы + клетчатка', tier: 'mid', allergens: ['gluten'], isVegetarian: true, isVegan: true, isGlutenFree: false, isDairyFree: true, dietTags: [], micros: { Ca: 70, Fe: 2.5, Mg: 60, P: 170, K: 200, Na: 450, Zn: 1.5, Se: 20, VitB1: 0.2, VitB3: 3, VitB6: 0.15, VitE: 0.4 } },
