...
export const EVIDENCE_DOSAGES: Record<DosageId, EvidenceDosage> = {
  ...
  omega3: {
    ...
    duration: 'Длительно',
    references: [
      'FDA Lovaza (NDA 21-654) — 4 г/сут для гипертриглицеридемии',
      'AHA Scientific Statement 2018 — 2-4 г/сут EPA+DHA для триглицеридов',
    ],
    notes: 'EPA+DHA ≥60%. Для триглицеридов: 4 г/сут. На ААС: ≥3 г EPA+DHA.',
    adjustments: { phaseMultiplier: { course: 1.25, bridge: 1.0, pct: 1.0, fertility: 1.0 } },
    contraindications: ['Антикоагулянты (мониторинг МНО)', 'Аллергия на рыбу/морепродукты'],
  },
