...
export const ADMINISTRATION_RULES_DB: AdministrationRule[] = [
  ...
  { substanceId: 'milk_thistle', timing: 'с едой 2-3 раза в день', reason: 'силимарин — с едой для абсорбции; при приёме тадалафила или анастрозола разнести на ≥2 ч (CYP3A4: силимарин ↑ их концентрацию)' },
  ...
  { substanceId: 'iron', timing: 'натощак, вместе с витамином C', reason: 'витамин C ↑ всасывание железа в 2-3 раза; принимать отдельно от кальция, цинка и магния с интервалом ≥2 ч (они ↓ всасывание железа)' },
  { substanceId: 'calcium', timing: 'вечером', reason: 'кальций лучше всасывается ночью; не принимать вместе с железом — разнести на ≥4 ч' },
  { substanceId: 'zinc', timing: 'вечером', reason: 'цинк — стабильное время; не вместе с железом (≥2 ч) и медью (≥6 ч) — конкурируют за всасывание' },
  { substanceId: 'magnesium', timing: 'вечером/перед сном', reason: 'расслабление мышц и сон; не вместе с железом — разнести на ≥2 ч' },
  { substanceId: 'curcumin', timing: 'с едой (с пиперином)', reason: 'куркумин плохо всасывается; пиперин ↑ биодоступность; не вместе с аспирином — разнести на ≥2 ч (аддитивный ЖКТ/антиагрегантный эффект)' },
