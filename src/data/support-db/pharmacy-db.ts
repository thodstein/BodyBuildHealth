...
export const PHARMACY_DB: Record<string, TzSupportEntry[]> = {
  // ═══ СТАТИНЫ ═══
  atorvastatin: [ { organId:'cardio', mechId:'cv2', k:0.50, q:'A', source:'Снижение ЛПНП 50%, ↓ СС-событий' } ],
  rosuvastatin: [ { organId:'cardio', mechId:'cv2', k:0.55, q:'A', source:'Снижение ЛПНП 55%' } ],
  ...
  // ═══ АПФ-ИНГИБИТОРЫ ═══
  lisinopril: [ { organId:'cardio', mechId:'cv3', k:0.35, q:'A', source:'АПФ-ингибитор, ↓ АД' }, { organId:'renal', mechId:'ren3', k:0.30, q:'A', source:'↓ протеинурии' } ],
  enalapril: [ { organId:'cardio', mechId:'cv3', k:0.35, q:'A', source:'АПФ-ингибитор, ↓ АД' } ],
  ramipril: [ { organId:'cardio', mechId:'cv3', k:0.35, q:'A', source:'АПФ-ингибитор, ↓ АД' }, { organId:'renal', mechId:'ren3', k:0.30, q:'A', source:'↓ протеинурии' } ],
  perindopril: [ { organId:'cardio', mechId:'cv3', k:0.35, q:'A', source:'АПФ-ингибитор, ↓ АД' } ],
  captopril: [ { organId:'cardio', mechId:'cv3', k:0.35, q:'A', source:'АПФ-ингибитор, ↓ АД' } ],
  // ═══ БРА (САРТАНЫ) ═══
  losartan: [ { organId:'cardio', mechId:'cv3', k:0.45, q:'A', source:'ARB, ↓ АД' }, { organId:'renal', mechId:'ren3', k:0.40, q:'A', source:'↓ протеинурии' } ],
  valsartan: [ { organId:'cardio', mechId:'cv3', k:0.45, q:'A', source:'ARB, ↓ АД' }, { organId:'renal', mechId:'ren3', k:0.40, q:'A', source:'↓ протеинурии' } ],
  irbesartan: [ { organId:'cardio', mechId:'cv3', k:0.45, q:'A', source:'ARB, ↓ АД' }, { organId:'renal', mechId:'ren3', k:0.40, q:'A', source:'↓ протеинурии' } ],
  olmesartan: [ { organId:'cardio', mechId:'cv3', k:0.45, q:'A', source:'ARB, ↓ АД' }, { organId:'renal', mechId:'ren3', k:0.40, q:'A', source:'↓ протеинурии' } ],
  candesartan: [ { organId:'cardio', mechId:'cv3', k:0.45, q:'A', source:'ARB, ↓ АД' }, { organId:'renal', mechId:'ren3', k:0.40, q:'A', source:'↓ протеинурии' } ],
  // ═══ БЕТА-БЛОКАТОРЫ ═══
  ...
  // ═══ ДИУРЕТИКИ ═══
  furosemide: [ { organId:'cardio', mechId:'cv3', k:0.30, q:'A', source:'Петлевой диуретик' }, { organId:'renal', mechId:'ren4', k:0.20, q:'A', source:'Выведение Na/K' } ],
  hydrochlorothiazide: [ { organId:'cardio', mechId:'cv3', k:0.25, q:'A', source:'Тиазид, ↓ АД' }, { organId:'hematologic', mechId:'hem4', k:0.15, q:'B', source:'↓ K+' } ],
  chlorthalidone: [ { organId:'cardio', mechId:'cv3', k:0.25, q:'A', source:'Тиазид, ↓ АД' }, { organId:'hematologic', mechId:'hem4', k:0.15, q:'B', source:'↓ K+' } ],
  // ═══ АНТИКОАГУЛЯНТЫ ═══
  ...
  // ═══ САХАРОСНИЖАЮЩИЕ ═══
  metformin: [ { organId:'hematologic', mechId:'hem2', k:0.30, q:'A', source:'↓ глюкозы, ↑ HOMA-IR' } ],
  pioglitazone: [ { organId:'hematologic', mechId:'hem2', k:0.35, q:'A', source:'Тиазолидиндион' } ],
  acarbose: [ { organId:'hematologic', mechId:'hem2', k:0.20, q:'B', source:'↓ постпрандиальной глюкозы' } ],
  // ═══ ИММУНОСУПРЕССАНТЫ ═══
