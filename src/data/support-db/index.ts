...
export const DRUG_DB: Record<string, TzDrugEntry> = {
  ...
  test_prop: { name:'РўРµСЃС‚РѕСЃС‚РµСЂРѕРЅ РїСЂРѕРїРёРѕРЅР°С‚', class:'aas', form:'inject',
    ...
    mechanismWeights:{cv1:4, cv2:4, cv5:4, rep1:4, rep2:4, liv1:3, hem1:3, cns1:3, cv3:2, cv4:2, liv2:2, cns2:2, cns4:2, rep3:2, rep4:2, rep5:2, hem2:2, ren1:2, ren2:2}, doseModifier:1.0 },
  ...
  tren_acet: { name:'РўСЂРµРЅР±РѕР»РѕРЅ Р°С†РµС‚Р°С‚', class:'aas', form:'inject',
    ...
    mechanismWeights:{cv1:4, cv2:4, cv5:4, cns1:4, cns2:3, rep1:4, rep2:4, hem1:3, liv1:3, cv3:2, cv4:2, liv3:2, cns3:2, cns4:2, rep3:2, rep5:2, hem2:2, ren1:2, ren4:2}, doseModifier:1.5 },
  ...
  npp: { name:'РќР°РЅРґСЂРѕР»РѕРЅ С„РµРЅРёР»РїСЂРѕРїРёРѕРЅР°С‚', class:'aas', form:'inject',
    ...
    mechanismWeights:{cv2:3, rep1:3, rep2:3, hem1:3, cns1:2, cv4:2, cv3:1, cns2:2, cns4:2, rep3:2, rep5:2, hem2:2, ren1:1, ren2:1}, doseModifier:0.8 },
  ...
  trest_acet: { name:'РўСЂРµСЃС‚РѕР»РѕРЅ Р°С†РµС‚Р°С‚ (РњР•РќРў)', class:'aas', form:'inject',
    ...
    mechanismWeights:{cv1:4, cv2:4, cv5:3, rep1:4, rep2:4, rep4:3, hem1:3, liv1:2, cv3:2, liv2:2, cns1:2, cns2:2, cns4:2, rep3:2, rep5:2, hem2:2, ren1:2, ren4:2}, doseModifier:1.2 },
  ...
  bold_undec: { name:'Р‘РѕР»РґРµРЅРѕРЅ СѓРЅРґРµС†РёР»РµРЅР°С‚', class:'aas', form:'inject',
    ...
    mechanismWeights:{hem1:4, cv2:3, hem2:2, cv4:2, cv3:1, cns2:1, rep1:2, rep2:2, rep5:1, ren2:1, ren1:1}, doseModifier:0.9 },
  prim_enan: { name:'РњРµС‚РµРЅРѕР»РѕРЅ СЌРЅР°РЅС‚Р°С‚ (РџСЂРёРјРѕР±РѕР»Р°РЅ)', class:'aas', form:'inject',
    ...
    mechanismWeights:{rep1:3, rep2:3, cv2:2, hem2:2, cv3:1, rep3:1, hem1:1, ren1:1, cns1:1, rep5:1}, doseModifier:0.7 },
  drostanolone_prop: { name:'Р”СЂРѕСЃС‚Р°РЅРѕР»РѕРЅ РїСЂРѕРїРёРѕРЅР°С‚ (РњР°СЃС‚РµСЂРѕРЅ)', class:'aas', form:'inject',
    ...
    mechanismWeights:{rep1:3, rep2:3, rep4:2, cv2:2, hem1:2, cv3:1, cv4:1, rep3:1, rep5:1, hem2:1, cns1:1}, doseModifier:1.0 },
  ...
  methand: { name:'РњРµС‚Р°РЅРґРёРµРЅРѕРЅ', class:'aas', form:'oral',
    ...
    mechanismWeights:{liv1:4, cv2:4, cv1:3, cv5:3, rep1:3, rep2:3, hem1:3, rep4:2, cv3:2, cv4:2, liv2:3, rep3:2, rep5:2, hem2:2, ren4:2, cns1:2}, doseModifier:1.5 },
  oxan: { name:'РћРєСЃР°РЅРґСЂРѕР»РѕРЅ', class:'aas', form:'oral',
    ...
    mechanismWeights:{liv1:4, liv2:3, cv2:3, rep1:3, rep2:3, hem2:2, cv3:1, cv4:1, rep3:2, rep5:2, cns1:1, hem1:1}, doseModifier:1.3 },
  stan: { name:'РЎС‚Р°РЅРѕР·РѕР»РѕР»', class:'aas', form:'oral',
    ...
    mechanismWeights:{liv1:4, liv2:3, cv2:3, hem1:3, rep1:3, rep2:3, cv3:1, cv4:2, rep3:2, rep5:2, hem2:1, cns1:1}, doseModifier:1.4 },
  trena: { name:'РўСѓСЂРёРЅР°Р±РѕР»', class:'aas', form:'oral',
    targetOrgans:['cardio','hepatic','reproductive','hematologic'],
    organMechanisms:{ cardio:['cv2'], hepatic:['liv1','liv2'], reproductive:['rep1','rep2','rep5'], hematologic:['hem2'] },
    mechanismWeights:{liv1:4, liv2:3, cv2:3, rep1:3, rep2:3, rep5:2, cns1:2, hem1:2, hem2:1}, doseModifier:1.4 },
  halo: { name:'РҐР»РѕСЂРґРµРіРёРґСЂРѕРјРµС‚РёР»С‚РµСЃС‚РѕСЃС‚РµСЂРѕРЅ', class:'aas', form:'oral',
    ...
    mechanismWeights:{liv1:4, cv2:4, hem1:3, liv2:3, rep1:3, rep2:3, cv3:1, cv4:2, rep3:2, rep5:2, cns1:3}, doseModifier:1.5 },
  superdrol: { name:'РњРµС‚РёР»РґСЂРѕСЃС‚Р°РЅРѕР»РѕРЅ', class:'aas', form:'oral',
    targetOrgans:['cardio','hepatic','reproductive','hematologic'],
    organMechanisms:{ cardio:['cv2','cv4'], hepatic:['liv1','liv2'], reproductive:['rep1','rep2','rep5'], hematologic:['hem1','hem2'] },
    mechanismWeights:{liv1:4, cv2:4, hem1:3, liv2:3, rep1:3, rep2:3, cv4:2, cv3:1, rep3:2, rep5:2, hem2:1, cns1:1}, doseModifier:1.5 },
  anadrol: { name:'РћРєСЃРёРјРµС‚РѕР»РѕРЅ', class:'aas', form:'oral',
    ...
    mechanismWeights:{hem1:4, liv1:4, cv2:4, cv1:3, cv5:3, rep1:3, rep2:3, cv4:3, rep4:2, cv3:2, liv2:3, hem2:2, rep3:2, rep5:2, ren4:2, cns1:2}, doseModifier:1.5 },
