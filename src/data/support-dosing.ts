...
export const SUPPORT_DOSING: Record<string, DosingRecord> = {
  ...
  red_yeast_rice: {
    ...
    warnings: ['statin_myopathy_risk', 'avoid_with_statin', 'hepatotoxicity', 'second_line_after_ezetimibe', 'citrinin_free_only', 'coq10_mandatory', 'ck_alt_monitoring'],
    evidenceLevel: 'B',
    lastUpdated: '2024-07-19',
  ...
  anastrozole: {
    ...
    category: 'pharma',
    doseRange: { min: 0.25, max: 0.5, unit: 'mg', frequency: 'weekly_to_biweekly' },
    indications: ['estradiol_control', 'gynecomastia_prevention', 'aromatase_inhibition'],
    mechanisms: ['AROMATASE_INHIBITION', 'E2_SUPPRESSION'],
    warnings: ['e2_crash_risk', 'joint_pain', 'libido_loss', 'lipid_worsening', 'bone_loss_longterm', 'no_1mg_daily_onco_dose_men', 'start_0.25mg_weekly_titrate_q14d', 'target_E2_20_40_TE2_10_30'],
    evidenceLevel: 'A',
    lastUpdated: '2024-07-19',
  ...
  cabergoline: {
    ...
    category: 'pharma',
    doseRange: { min: 0.25, max: 1, unit: 'mg', frequency: '2x_weekly' },
    indications: ['prolactin_reduction', 'nandrolone_pct', 'libido_recovery'],
    mechanisms: ['D2_AGONISM', 'PROLACTIN_SUPPRESSION'],
    warnings: ['cardiac_valve_risk_longterm', 'nausea', 'dizziness', 'max_1mg_2x_weekly_FDA', 'baseline_echo_if_over_6mo', 'impulse_control_ask_actively', 'orthostatic_hypotension_with_antihypertensives'],
    evidenceLevel: 'A',
    lastUpdated: '2024-07-19',
  ...
  nac: {
    ...
    warnings: ['gastric_discomfort_fasting', 'unpleasant_taste', 'cross_module_cap_4000_mg_day'],
    evidenceLevel: 'A',
    lastUpdated: '2024-07-19',
  ...
  tudca: {
    ...
    category: 'supplement',
    doseRange: { min: 250, max: 500, unit: 'mg', frequency: 'bid_with_food' },
    phaseDosing: { 'Hepatic_Phase3': { min: 500, max: 1000, unit: 'mg', frequency: 'daily_divided_with_food' }, 'Hepatic_Phase4': { min: 0, max: 0, unit: 'mg', frequency: 'CONTRAINDICATED' } },
    indications: ['cholestasis', 'liver_protection', 'bile_flow'],
    mechanisms: ['BSEP_ACTIVATION', 'CHOLERESIS', 'ER_STRESS_REDUCTION'],
    warnings: ['diarrhea_initial', 'biliary_obstruction_contraindication', 'CONTRAINDICATED_at_ALT_5x_ULN', 'weight_based_13_15_mg_kg_day', 'separate_from_oral_AAS_3_4h', 'continue_2_4_weeks_after_oral_stop'],
    evidenceLevel: 'B',
    lastUpdated: '2024-07-19',
  ...
  aspirin: {
    ...
    category: 'pharma',
    doseRange: { min: 75, max: 100, unit: 'mg', frequency: 'daily_evening' },
    indications: ['antiplatelet', 'thrombosis_prevention', 'cardio_protection'],
    mechanisms: ['COX1_INHIBITION', 'TXA2_REDUCTION', 'PLATELET_AGGREGATION_INHIBITION'],
    warnings: ['bleeding_risk_gi', 'asthma_sensitivity', 'tinnitus_high_dose', 'additive_with_anticoagulants', 'ppi_mandatory', 'no_routine_primary_prevention_USPSTF2022', 'gate_2_thrombotic_risk_factors', 'no_nsaid_omega3_highdose_combo'],
    evidenceLevel: 'A',
    lastUpdated: '2026-08-10',
    protocolRefs: ['Hematologic_Phase1', 'Hematologic_Phase2', 'Hematologic_Phase3', 'Cardio_Phase4'],
    riskThresholdKey: 'aspirin',
  },
  bromelain: {
    id: 'bromelain', name: 'Bromelain', nameRu: 'Бромелайн (ананасовая протеаза)',
    category: 'supplement',
    doseRange: { min: 500, max: 1000, unit: 'mg', frequency: 'tid_fasting' },
    indications: ['fibrinolysis', 'platelet_aggregation_inhibition', 'inflammation_reduction'],
    mechanisms: ['FIBRINOLYSIS', 'PAI1_INHIBITION', 'COX2_INHIBITION', 'PLATELET_AGGREGATION_INHIBITION'],
    warnings: ['bleeding_risk', 'stop_before_surgery', 'tetracycline_interaction'],
    evidenceLevel: 'C',
    lastUpdated: '2026-08-10',
    protocolRefs: ['Hematologic_Phase1', 'Hematologic_Phase2'],
  },
  lumbrokinase: {
    ...
    category: 'supplement',
    doseRange: { min: 40, max: 80, unit: 'mg', frequency: 'bid_fasting' },
    indications: ['fibrinolysis', 'fibrinogen_reduction', 'thrombosis_prevention'],
    mechanisms: ['PLASMINOGEN_ACTIVATION', 'FIBRINOLYSIS', 'PAI1_INHIBITION', 'FIBRINOGEN_REDUCTION'],
    warnings: ['bleeding_risk', 'stop_before_surgery', 'additive_with_anticoagulants'],
    evidenceLevel: 'C',
    lastUpdated: '2026-08-10',
    protocolRefs: ['Hematologic_Phase3'],
  },
  garlic: {
    id: 'garlic', name: 'Garlic (Allicin)', nameRu: 'Чеснок (аллицин)',
    category: 'supplement',
    doseRange: { min: 600, max: 1200, unit: 'mg', frequency: 'bid' },
    indications: ['antiplatelet', 'blood_pressure_regulation', 'fibrinolysis'],
    mechanisms: ['ALICIN_PLATELET_INHIBITION', 'FIBRINOLYSIS', 'NO_PRODUCTION', 'BP_LOWERING'],
    warnings: ['bleeding_risk_with_anticoagulants', 'additive_with_aspirin', 'gi_discomfort'],
    evidenceLevel: 'B',
    lastUpdated: '2026-08-10',
    protocolRefs: ['Hematologic_Phase1', 'Hematologic_Phase2', 'Cardio_Phase3'],
  },
  ginkgo: {
    id: 'ginkgo', name: 'Ginkgo Biloba', nameRu: 'Гинкго Билоба',
    category: 'supplement',
    doseRange: { min: 120, max: 240, unit: 'mg', frequency: 'bid' },
    indications: ['antiplatelet_paf_antagonist', 'microcirculation', 'cognitive'],
    mechanisms: ['PAF_ANTAGONISM', 'PLATELET_AGGREGATION_INHIBITION', 'MICROCIRCULATION', 'NO_PRODUCTION'],
    warnings: ['bleeding_risk_with_anticoagulants', 'additive_with_aspirin'],
    evidenceLevel: 'B',
    lastUpdated: '2026-08-10',
    protocolRefs: ['Hematologic_Phase3'],
  },
  pycnogenol: {
    id: 'pycnogenol', name: 'Pycnogenol', nameRu: 'Пикногенол',
    category: 'supplement',
    doseRange: { min: 100, max: 200, unit: 'mg', frequency: 'bid' },
    indications: ['endothelial_protection', 'antiplatelet', 'microcirculation'],
    mechanisms: ['ENDOTHELIAL_PROTECTION', 'NO_PRODUCTION', 'COX_INHIBITION', 'MICROCIRCULATION'],
    warnings: ['bleeding_risk_with_anticoagulants'],
    evidenceLevel: 'B',
    lastUpdated: '2026-08-10',
    protocolRefs: ['Hematologic_Phase3', 'Cardio_Phase3'],
  },
  citrulline: {
    id: 'citrulline', name: 'L-Citrulline', nameRu: 'Л-Цитруллин',
    category: 'supplement',
    doseRange: { min: 3000, max: 8000, unit: 'mg', frequency: 'daily' },
    indications: ['no_donor', 'blood_viscosity_reduction', 'endothelial_protection'],
    mechanisms: ['NO_PRODUCTION', 'CITRULLINE_ARGININE_CYCLE', 'VASODILATION', 'MICROCIRCULATION'],
    warnings: ['hypotension', 'additive_with_pde5_inhibitors'],
    evidenceLevel: 'B',
    lastUpdated: '2026-08-10',
    protocolRefs: ['Hematologic_Phase2', 'Cardio_Phase3'],
  },
  arginine: {
    id: 'arginine', name: 'L-Arginine', nameRu: 'Л-Аргинин',
    category: 'supplement',
    doseRange: { min: 3000, max: 6000, unit: 'mg', frequency: 'bid' },
    indications: ['no_donor', 'blood_viscosity_reduction', 'endothelial_protection'],
    mechanisms: ['NO_PRODUCTION', 'NO_SYNTHESIS', 'NOS_STIMULATION', 'VASODILATION'],
    warnings: ['hypotension', 'sildenafil_interaction', 'additive_with_pde5_inhibitors'],
    evidenceLevel: 'B',
    lastUpdated: '2026-08-10',
    protocolRefs: ['Hematologic_Phase2'],
  },
  dipyridamole: {
    id: 'dipyridamole', name: 'Dipyridamole', nameRu: 'Дипиридамол',
    category: 'pharma',
    doseRange: { min: 75, max: 225, unit: 'mg', frequency: 'tid' },
    indications: ['antiplatelet', 'thrombosis_prevention', 'microcirculation'],
    mechanisms: ['PDE_INHIBITION', 'CAMP_ELEVATION', 'PLATELET_AGGREGATION_INHIBITION', 'VASODILATION'],
    warnings: ['bleeding_risk', 'coronary_spasm_rare', 'additive_with_anticoagulants'],
    evidenceLevel: 'A',
    lastUpdated: '2026-08-10',
    protocolRefs: ['Hematologic_Phase3'],
    riskThresholdKey: 'dipyridamole',
  },
  sulodexide: {
    id: 'sulodexide', name: 'Sulodexide', nameRu: 'Сулодексид',
    category: 'pharma',
    doseRange: { min: 250, max: 500, unit: 'IU', frequency: 'bid' },
    indications: ['fibrinolysis', 'endothelial_protection', 'anticoagulation_mild'],
    mechanisms: ['HEPARINOID', 'FIBRINOLYSIS', 'ENDOTHELIAL_PROTECTION', 'ANTICOAGULATION'],
    warnings: ['bleeding_risk', 'additive_with_anticoagulants'],
    evidenceLevel: 'B',
    lastUpdated: '2026-08-10',
    protocolRefs: ['Hematologic_Phase3', 'Hematologic_Phase4'],
    riskThresholdKey: 'sulodexide',
  },
  warfarin: {
    id: 'warfarin', name: 'Warfarin', nameRu: 'Варфарин',
    category: 'pharma',
    doseRange: { min: 2.5, max: 5, unit: 'mg', frequency: 'daily' },
    indications: ['anticoagulation', 'thrombosis_treatment', 'dvt_pe_prevention'],
    mechanisms: ['VITAMIN_K_ANTAGONISM', 'FACTOR_II_VII_IX_X_INHIBITION', 'ANTICOAGULATION'],
    warnings: ['bleeding_risk_major', 'INR_monitoring_required', 'dietary_vitamin_k_restriction', 'hepatic_metabolism_cyp2c9'],
    evidenceLevel: 'A',
    lastUpdated: '2026-08-10',
    protocolRefs: ['Hematologic_Phase4'],
  ...
  hydration: {
    ...
    category: 'supplement',
    doseRange: { min: 40, max: 45, unit: 'мл/кг/день', frequency: 'daily' },
    indications: ['erythrocytosis_prevention', 'plasma_volume_expansion', 'hematocrit_reduction'],
    mechanisms: ['PLASMA_VOLUME_EXPANSION', 'HEMATOCRIT_DILUTION', 'VISCOSITY_REDUCTION'],
    warnings: ['hyponatremia_if_without_electrolytes', 'renal_adjustment'],
    evidenceLevel: 'B',
    lastUpdated: '2026-08-10',
    protocolRefs: ['Hematologic_Phase1', 'Hematologic_Phase2', 'Hematologic_Phase3'],
  },
  cardio_aerobic: {
    id: 'cardio_aerobic', name: 'Cardio Aerobic', nameRu: 'Кардио (аэробная нагрузка)',
    category: 'supplement',
    doseRange: { min: 30, max: 45, unit: 'мин', frequency: '5x_week' },
    indications: ['erythrocytosis_prevention', 'plasma_volume_expansion', 'hematocrit_reduction'],
    mechanisms: ['PLASMA_VOLUME_EXPANSION', 'ENDOTHELIAL_NO', 'RBC_DEFORMABILITY'],
    warnings: ['overexertion_if_hct_gt_54'],
    evidenceLevel: 'B',
    lastUpdated: '2026-08-10',
    protocolRefs: ['Hematologic_Phase1', 'Hematologic_Phase2'],
  },
  electrolyte_balance: {
    id: 'electrolyte_balance', name: 'Electrolyte Balance', nameRu: 'Баланс электролитов (Na/K/Mg)',
    category: 'mineral',
    doseRange: { min: 1, max: 1, unit: 'комплекс', frequency: 'daily' },
    indications: ['plasma_volume_retention', 'hydration_efficiency', 'erythrocytosis_support'],
    mechanisms: ['SODIUM_RETENTION_INTRAVASCULAR', 'POTASSIUM_BALANCE', 'MAGNESIUM_BALANCE'],
    warnings: ['hypertension_if_na_high', 'hyperkalemia_if_k_high', 'renal_adjustment'],
    evidenceLevel: 'B',
    lastUpdated: '2026-08-10',
    protocolRefs: ['Hematologic_Phase1', 'Hematologic_Phase2'],
  },
  ...
  berberine: {
    ...
    warnings: ['hypoglycemia_with_diabetes_meds', 'gastrointestinal', 'max_1500_mg_day', 'cyp3a4_spacing_2h', 'biliary_colic_ultrasound_first'],
    evidenceLevel: 'B',
    lastUpdated: '2024-07-19',
  ...
  melatonin: {
    ...
    category: 'supplement',
    doseRange: { min: 0.5, max: 5, unit: 'mg', frequency: 'bedtime' },
    indications: ['sleep', 'circadian_rhythm', 'antioxidant'],
    mechanisms: ['MT1_MT2_AGONISM', 'CIRCADIAN_REGULATION'],
    warnings: ['daytime_sedation_high_dose', 'cap_5mg_without_doctor', 'not_over_6mo_continuous'],
    evidenceLevel: 'A',
    lastUpdated: '2024-07-19',
