...
export const SUBSTANCE_ANALOGS: Record<string, { id: string; name: string; reason: string }[]> = {
  nac: [{ id: 'nac', name: 'NAC', reason: 'Оригинал' }, { id: 'milk_thistle', name: 'Силимарин', reason: 'Гепатопротекция' }, { id: 'alpha_lipoic', name: 'АЛЬК', reason: 'Глутатион + антиоксидант' }],
  omega3: [{ id: 'omega3', name: 'Омега-3', reason: 'Оригинал' }, { id: 'egcg', name: 'EGCG', reason: 'Антиоксидант + липиды' }],
  tudca: [{ id: 'tudca', name: 'TUDCA', reason: 'Оригинал' }, { id: 'milk_thistle', name: 'Силимарин', reason: 'Гепатопротекция (слабее)' }, { id: 'phosphatidylcholine', name: 'Фосфатидилхолин', reason: 'Мембраны гепатоцитов' }],
  magnesium: [{ id: 'magnesium', name: 'Магний бисглицинат', reason: 'Оригинал' }, { id: 'taurine', name: 'Таурин', reason: 'Расслабление + антиоксидант' }],
  vitamin_d3: [{ id: 'vitamin_d3', name: 'Витамин D3', reason: 'Оригинал' }, { id: 'vitamin_k2', name: 'Витамин K2', reason: 'Направление Ca в кости' }],
  coq10: [{ id: 'coq10', name: 'CoQ10 убихинол', reason: 'Оригинал' }],
  zinc: [{ id: 'zinc', name: 'Цинк пиколинат', reason: 'Оригинал' }],
  berberine: [{ id: 'berberine', name: 'Берберин', reason: 'Оригинал' }],
  ashwagandha: [{ id: 'ashwagandha', name: 'Ашваганда KSM-66', reason: 'Оригинал' }],
  alpha_lipoic: [{ id: 'alpha_lipoic', name: 'АЛЬК R-форма', reason: 'Оригинал' }],
  selenium: [{ id: 'selenium', name: 'Селен метионин', reason: 'Оригинал' }],
  taurine: [{ id: 'taurine', name: 'Таурин', reason: 'Оригинал' }, { id: 'magnesium', name: 'Магний', reason: 'Кардиопротекция' }],
  milk_thistle: [{ id: 'milk_thistle', name: 'Силимарин', reason: 'Оригинал' }, { id: 'nac', name: 'NAC', reason: 'Глутатион + гепатопротекция' }],
  glucosamine: [{ id: 'glucosamine', name: 'Глюкозамин', reason: 'Оригинал' }],
  collagen: [{ id: 'collagen', name: 'Коллаген гидролизат', reason: 'Оригинал' }, { id: 'vitamin_c', name: 'Витамин C', reason: 'Синтез коллагена' }],
  curcumin: [{ id: 'curcumin', name: 'Куркумин + пиперин', reason: 'Оригинал' }],
  probiotics: [{ id: 'probiotics', name: 'Пробиотики', reason: 'Оригинал' }],
  vitamin_b12: [{ id: 'vitamin_b12', name: 'B12 метилкобаламин', reason: 'Оригинал' }],
  folate: [{ id: 'folate', name: 'Фолат 5-MTHF', reason: 'Оригинал' }],
  telmisartan: [{ id: 'telmisartan', name: 'Тельмисартан', reason: 'Оригинал' }],
  nebivolol: [{ id: 'nebivolol', name: 'Небиволол', reason: 'Оригинал' }],
  saw_palmetto: [{ id: 'saw_palmetto', name: 'Сабаль пальметто', reason: 'Оригинал' }],
  hcg: [{ id: 'hcg', name: 'ХГЧ', reason: 'Оригинал' }],
};

// Substance enhancers: what boosts each substance
export const SUBSTANCE_ENHANCERS: Record<string, { id: string; name: string; reason: string }[]> = {
  nac: [{ id: 'vitamin_c', name: 'Витамин C', reason: 'Регенерация глутатиона' }, { id: 'alpha_lipoic', name: 'АЛЬК', reason: 'Усиление антиоксидантной сети' }, { id: 'selenium', name: 'Селен', reason: 'Глутатионпероксидаза' }],
  omega3: [{ id: 'vitamin_e', name: 'Витамин E', reason: 'Защита от окисления EPA/DHA' }],
  tudca: [{ id: 'milk_thistle', name: 'Силимарин', reason: 'Синергия гепатопротекции' }, { id: 'phosphatidylcholine', name: 'Фосфатидилхолин', reason: 'Мембраны гепатоцитов' }],
  magnesium: [{ id: 'vitamin_b6', name: 'Витамин B6', reason: 'Улучшение усвоения Mg' }, { id: 'taurine', name: 'Таурин', reason: 'Синергия расслабления' }],
  coq10: [{ id: 'selenium', name: 'Селен', reason: 'Защита митохондрий' }, { id: 'alpha_lipoic', name: 'АЛЬК', reason: 'Регенерация CoQ10' }],
  vitamin_d3: [{ id: 'vitamin_k2', name: 'Витамин K2', reason: 'Направление Ca в кости' }, { id: 'magnesium', name: 'Магний', reason: 'Активация D3' }],
  zinc: [{ id: 'copper', name: 'Медь', reason: 'Баланс Zn/Cu' }, { id: 'vitamin_c', name: 'Витамин C', reason: 'Улучшение всасывания' }],
  collagen: [{ id: 'vitamin_c', name: 'Витамин C', reason: 'Необходим для синтеза коллагена' }, { id: 'msm', name: 'MSM', reason: 'Сера для коллагена' }],
  glucosamine: [{ id: 'chondroitin', name: 'Хондроитин', reason: 'Синергия для хрящей' }, { id: 'msm', name: 'MSM', reason: 'Сера для суставов' }],
  curcumin: [{ id: 'piperine', name: 'Пиперин', reason: 'Увеличение биодоступности 2000%' }],
  ashwagandha: [{ id: 'magnesium', name: 'Магний', reason: 'Синергия кортизол/расслабление' }],
  probiotics: [{ id: 'prebiotics', name: 'Пребиотики', reason: 'Пища для пробиотиков' }],
};
