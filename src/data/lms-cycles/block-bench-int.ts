...
export const BLOCK_BENCH_INT: SRCycleTemplate = {
 ...
 howItWorks: 'Блочный: жим, средний. Направление: жим лёжа; уровень: II разряд — МС; период: пиковый. 4-недельный блочный цикл для жимовиков среднего уровня. Направлен на преодоление плато через варьирование объёма и интенсивности в жиме лёжа. Повторяемый формат до остановки прогресса. Принцип построения — саморасчитывающаяся прогрессия: раскладка первой недели повторяется все 4 недель, а вес каждого упражнения на неделе N считается как ПМ0 × (1 + k)^N, где k = 2.5% за неделю (режим — натуральный или на курсе — задаётся при генерации плана). Тоннаж и КПШ растут вместе с ПМ, относительная интенсивность удерживается в рамках заданной раскладки. Объём: 4 тренировки в неделю, 4 недель; минимальный вес тела 60 кг.',
