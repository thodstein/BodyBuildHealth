...
export const BLOCK_BENCH_EXP: SRCycleTemplate = {
 ...
 howItWorks: 'Блочный: жим, продвинутый. Направление: жим лёжа; уровень: МС — МСМК; период: пиковый. 4-недельный блочный цикл для продвинутых жимовиков уровня МС-МСМК. Высокоинтенсивный тренинг с продвинутыми методами для максимальной стимуляции роста результата. 4 тренировки в неделю. Принцип построения — саморасчитывающаяся прогрессия: раскладка первой недели повторяется все 4 недель, а вес каждого упражнения на неделе N считается как ПМ0 × (1 + k)^N, где k = 0.5% за неделю (режим — натуральный или на курсе — задаётся при генерации плана). Тоннаж и КПШ растут вместе с ПМ, относительная интенсивность удерживается в рамках заданной раскладки. Объём: 4 тренировки в неделю, 4 недель; минимальный вес тела 60 кг.',
