...
export const BLOCK_BENCH_BEG: SRCycleTemplate = {
 ...
 howItWorks: 'Блочный: жим, новичок. Направление: жим лёжа; уровень: новичок; период: пиковый. 4-недельный блочный цикл для начинающих жимовиков. Сфокусирован на освоение техники жима лёжа и базовой силовой подготовки. Постепенное увеличение нагрузки с контролем восстановления и возможностью повторения. Принцип построения — саморасчитывающаяся прогрессия: раскладка первой недели повторяется все 4 недель, а вес каждого упражнения на неделе N считается как ПМ0 × (1 + k)^N, где k = 2% за неделю (режим — натуральный или на курсе — задаётся при генерации плана). Тоннаж и КПШ растут вместе с ПМ, относительная интенсивность удерживается в рамках заданной раскладки. Объём: 3 тренировки в неделю, 4 недель; минимальный вес тела 60 кг.',
