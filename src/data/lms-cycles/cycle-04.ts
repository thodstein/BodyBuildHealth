...
export const CYCLE_04: SRCycleTemplate = {
 ...
 howItWorks: 'Цикл «Силовой цикл (армрестлинг, верх)». Цикл с акцентом на жим (для жимовиков). Приседания и тяга идут фоном, жим — основной прогресс. Параметры: armwrestling, II-KMS, strength, 12 нед × 3 дн/нед, корректировка ПМ 0.5%/нед. Прогрессия весов: ПМ_нед_N = ПМ_0 × (1 + k)^N (k = 0.5%/нед для natural, ×3-4 для on_course). Фаза делода (при weeks ≥ 6): встроена в distributePhases.',
 conditions: [],
 tags: ['lms'],
 },
 week1: [
