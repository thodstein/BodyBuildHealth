...
export const CYCLE_05: SRCycleTemplate = {
 ...
 howItWorks: 'Цикл «Силовой цикл (жим, II-КМС)». Цикл с акцентом на присед. Тяга и жим фоном, присед — основной прогресс. Параметры: bench, II-KMS, strength, 12 нед × 4 дн/нед, корректировка ПМ 0.5%/нед. Прогрессия весов: ПМ_нед_N = ПМ_0 × (1 + k)^N (k = 0.5%/нед для natural, ×3-4 для on_course). Фаза делода (при weeks ≥ 6): встроена в distributePhases.',
