...
export const CYCLE_16: SRCycleTemplate = {
 ...
 howItWorks: 'Цикл «Выносливость (жим, II-КМС, 2 дн)». Пиковый силовой цикл (4-6 нед): подводка к соревнованиям. Снижение объёма, рост интенсивности к ПМ-неделе. Параметры: bench, II-KMS, endurance, 12 нед × 2 дн/нед, корректировка ПМ 0.5%/нед. Прогрессия весов: ПМ_нед_N = ПМ_0 × (1 + k)^N (k = 0.5%/нед для natural, ×3-4 для on_course). Фаза делода (при weeks ≥ 6): встроена в distributePhases.',
