...
export const SUBSTANCE_FORMS: Record<string, SubstanceForm> = {
  ...
  alpha_lipoic: {
    ...
    bioavailability: 'R-форма: 85% (отн. биодоступность), рацемат: 40%',
    note: 'R-форма — натуральная, в 2-4x активнее рацемата. S-форма — синтетическая, менее активна.',
    bestTime: 'натощак за 30 мин до еды',
  },
  coq10: {
  ...
  spironolactone: {
    ...
    note: '⚠ АНТИАНДРОГЕН: блокатор AR + 5α-редуктаза + CYP17. ПРОТИВОПОКАЗАН на ААС-курсе. '
        + 'Заменён на гидрохлоротиазид/индапамид (нет антиандрогенной активности). '
        + 'Только при гиперкалиемии (K+>5.5) под строгим врачебным контролем.',
    bestTime: 'утро',
  },
  hydrochlorothiazide: {
    id: 'hydrochlorothiazide', optimalForm: 'Гидрохлоротиазид 12.5-25 мг',
    pharmacyBrands: ['Гипотиазид 25', 'Гидрохлоротиазид-Тева'],
    altSubstance: 'indapamide',
    altForm: 'Индапамид 1.5-2.5 мг — тиазидоподобный, дольше T½, меньше K+-потерь',
    bioavailability: '60-80%',
    note: '⚠ через врача. Тиазидный диуретик. 1-я линия при отёках на ААС (нет антиандрогенной активности). '
        + 'Действует на дистальный извитой каналец (↓Na+ реабсорбция). '
        + 'Старт 12.5 мг, при необходимости ↑ до 25 мг. '
        + 'Противопоказан: анурия, тяжёлая почечная недостаточность (eGFR<30), гипокалиемия. '
        + 'Мониторинг: K+, Na+, Mg, мочевая кислота — каждые 2 нед. '
        + 'Внимание: ↑ мочевая кислота (риск подагры), ↑ глюкоза (риск инсулинорезистентности).',
    bestTime: 'утро',
  },
  indapamide: {
    id: 'indapamide', optimalForm: 'Индапамид 1.5-2.5 мг',
    pharmacyBrands: ['Арифон 2.5', 'Индапамид-Тева 2.5'],
    altSubstance: 'hydrochlorothiazide',
    altForm: 'Гидрохлоротиазид 12.5-25 мг — тиазид, классика',
    bioavailability: '90%',
    note: '⚠ через врача. Тиазидоподобный диуретик. 2-я линия при отёках на ААС. '
        + 'Дольше T½ (14ч vs HCTZ 6-15ч), меньше K+-потерь, ↓↓ влияние на мочевую кислоту. '
        + 'Дополнительно: вазодилятация (↑NO в эндотелии). '
        + 'Противопоказан: тяжёлая почечная недостаточность, гипокалиемия, печёночная энцефалопатия. '
        + 'Мониторинг: K+, Na+ — каждые 2 нед. Меньше риск гиперурикемии чем HCTZ.',
    bestTime: 'утро',
  },
  ...
  magnesium: {
    ...
    bioavailability: 'Бисглицинат 80%, Треонат 65% (транспортирует через ГЭБ), Цитрат 60%, Оксид 4%',
    note: 'Бисглицинат — для курса, сна. Треонат — для когнитивных функций. '
        + 'Цитрат — только при запоре (laxative). Оксид — практически бесполезен.',
  ...
  zinc: {
    ...
    bioavailability: 'Пиколинат 85%, Бисглицинат 55%, Оксид 20%',
