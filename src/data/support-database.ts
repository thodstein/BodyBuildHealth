...
,
  ...
  { interactionId: 'SYNERGY_AUTO_065', substanceA: '', substanceB: '', type: 'synergy' as 'synergy' | 'conflict' | 'caution', effect: 'Родиола розовая и L-тирозин синергично повышают стрессоустойчивость и когнитивную фокусировку', mechanisms: ['Ингибирование КОМТ', 'Повышение дофамина/норадреналина', 'Модуляция HPA оси', 'Анти-адаптогенный эффект'], severity: 'LOW', notes: 'Родиола 200-400 мг + тирозин 500-1000 мг; утром в стрессовые дни' },
