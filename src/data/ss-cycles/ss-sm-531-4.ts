...
function buildWeek(w: number): SSDaySpec[] {
  ...
  return [
    day('overhead_day', deload ? 'лёг' : 'тяж',
      ...
      ex('pin_press', 'Дожим узким (локаут)', 'shoulders', 0.7, [s(0.60, 8, 3)], { base: 'bench', role: 'accessory' }),
    ),
    ...
    day('squat_day', deload ? 'лёг' : 'тяж',
      ...
      ex('hip_thrust', 'Ягодичный мост', 'legs', 0.6, [s(0.55, 8, 3)], { base: 'deadlift', baseMult: 1, role: 'accessory' }),
    ),
