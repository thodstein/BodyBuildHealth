...
export const ORGAN_LABELS: Record<string, string> = {
  ...
  INTESTINES: '🫁 Кишечник', BLOOD: '🩸 Кровь', PROSTATE: '🔴 Простата', GUT: '🫁 Кишечник', BONE: '🦴 Кости', HAIR: '💇 Волосы', THYMUS: '🛡️ Тимус', MUCOSA: '🧴 Слизистая', GALLBLADDER: '🫁 Желчный пузырь', TESTES: '⚽ Яички',
};
...
kpv: {
  ...
  DIOSMIN: {
    ...
    category: ['flavonoid','vascular','antioxidant'],
    ...
    organs: ['VASCULAR','HEART','LIVER'], systems: ['vascular','cardio','hepatic'],
  ...
  SERRAPEPTASE: {
    ...
    category: ['proteolytic','enzyme','antiinflammatory'],
    ...
    organs: ['VASCULAR','LUNGS','JOINTS','BLOOD'], systems: ['vascular','respiratory','musculoskeletal'],
  ...
  PAPAIN: {
    ...
    category: ['proteolytic','enzyme','digestion'],
  ...
  PHARMA_TADALAFIL: {
    ...
    organs: ['VASCULAR','HEART','REPRODUCTIVE'], systems: ['vascular','cardio','reproductive'],
  ...
  LUMBROKINASE: {
    ...
    organs: ['BLOOD','VASCULAR','HEART'], systems: ['hematologic','vascular','cardio'],
  ...
  HORSE_CHESTNUT: {
    ...
    category: ['herb','vascular','antioxidant'],
    forms: [{id:'escin_100',name:'Escin 100mg',nameRu:'Эсцин 100 мг',dose:'100 мг 2x/д',best:true}],
    organs: ['VASCULAR','LIVER','SKIN'], systems: ['vascular','hepatic','integumentary'],
  ...
  INOSINE: {
    ...
    category: ['nucleotide','metabolic','energy'],
    forms: [{id:'inosine_500',name:'Inosine 500mg',nameRu:'Инозин 500 мг',dose:'500 мг 2x/д',best:true}],
    organs: ['HEART','LIVER','MUSCLE'], systems: ['cardio','hepatic','muscular'],
  ...
  NARINGIN: {
    ...
    category: ['flavonoid','antioxidant','vascular','hepatic'],
    forms: [{id:'naringin_250',name:'Naringin 250mg',nameRu:'Нарингин 250 мг',dose:'250-500 мг/д',best:true}],
    organs: ['LIVER','HEART','BLOOD','VASCULAR'], systems: ['hepatic','cardio','vascular','metabolic'],
  ...
  SAME: {
    ...
    category: ['amino','methylation','liver'],
  ...
  VITAMIN_B1: {
    ...
    category: ['vitamin','metabolic','energy'],
  ...
  PYCNOGENOL: {
    ...
    category: ['antioxidant','vascular','antiinflammatory'],
    forms: [{id:'pycnogenol_100',name:'Pycnogenol 100mg',nameRu:'Пикногенол 100 мг',dose:'100-200 мг/д',best:true}],
    organs: ['VASCULAR','SKIN','BRAIN','HEART'], systems: ['vascular','integumentary','neuro','cardio'],
  ...
  PHOSPHATIDYLSERINE: {
    ...
    category: ['nootropic','lipid','cognitive'],
  ...
  ARTICHOKE: {
    ...
    category: ['hepatoprotector','choleretic','digestion'],
  ...
  GLYCINE: {
    ...
    organs: ['BRAIN','LIVER','MUSCLE'], systems: ['neuro','hepatic','muscular'],
  ...
  ASTRAGALUS: {
    ...
    category: ['adaptogen','immune','antioxidant'],
  ...
  RUTIN: {
    ...
    category: ['flavonoid','vascular','antioxidant','antiinflammatory'],
    forms: [{id:'rutin_500',name:'Rutin 500mg',nameRu:'Рутин 500 мг',dose:'500 мг 2x/д',best:true}],
    organs: ['VASCULAR','HEART','BRAIN','SKIN'], systems: ['vascular','cardio','neuro','integumentary'],
    ...
    category: ['mineral','electrolyte','neuro','cardio'],
  ...
  HEPTRAL: {
    ...
    tier: 'specialty', category: ['hepatic','methyl_donor','neuro','pharma'],
    forms: [
  ...
  LEGALON: {
    ...
    tier: 'specialty', category: ['hepatic','antioxidant','herbal','pharma'],
    forms: [
  ...
  IBUDILAST: {
    ...
    tier: 'specialty', category: ['neuro','antiinflammatory','pde_inhibitor','pharma'],
    forms: [
    ...
    organs: ['BRAIN','NERVES','LUNGS','VASCULAR'], systems: ['neuro','respiratory','vascular'],
