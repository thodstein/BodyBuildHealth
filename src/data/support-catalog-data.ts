...
kpv: {
  ...
  "PHARMA_ANASTROZOLE": {
   ...
   NAC: {
    ...
    specialInstructions: ['Принимать с едой', 'Не превышать 2400 мг/сут', 'Интервал с антибиотиками 2 ч'],
  ...
  DIOSMIN: {
   ...
   BERBERINE: {
    ...
    specialInstructions: ['Принимать с едой', 'Не превышать 500 мг 3 раза в день', 'Курс 8-12 нед, перерыв 4 нед'],
    targetOrgan: 'Гепатоциты, β-клетки поджелудочной, энтероциты, кардиомиоциты',
