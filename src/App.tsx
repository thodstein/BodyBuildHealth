...
type Tab = 'home' | 'pharma' | 'training' | 'labs' | 'risks' | 'support' | 'nutrition' | 'profile' | 'articles' | 'marketplace' | 'analysis';
...
export default function App() {
  ...
  const renderContent = () => {
    ...
    switch (tab) {
      ...
      case 'analysis': return <AnalysisScreen key={key} />;
