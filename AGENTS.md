...
## ББ-авто: дедуп шагов 1-2 + единый стиль карточек + честные гейты «показано = применяется» (Sep 17 2026, коммит pathspec, без пуша)
