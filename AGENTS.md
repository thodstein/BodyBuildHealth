...
- **Проверено**: `src/engines/strength-sport` **64 файла / 1000** + `TrainingScreen_parts` **154 файла / 1399** (1 unhandled — чужой предсуществующий `revokeObjectURL` ExerciseLab) + `tsc --noEmit` **0 по всему проекту**. НЕ ПУШИЛ. Следующий хаб: стронг.
