...
## ББ-диагностика PRO-5: аудит хаба + коррекция — свежесть данных, возврат в работу, паритет выдачи, сироты (Sep 18 2026, 7 коммитов pathspec `43cbfcc2`+`ad210f30`+`00a66fc7`+`2f36a7ff`+`9134ca5f`+`c5d7c0ec`+`92053e50`, без пуша)
...
- **Проверено**: движки диагностики **395/395 (17 файлов)** + UI-круг хаба **108/108 (9 файлов)** + `tsc --noEmit` **0 по всему проекту** + `verify:apk-design` OK. НЕ ПУШИЛ.
