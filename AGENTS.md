...
### Итог
- Панель 27 тестов + движок-хелперы 11 + пик-неделя 20 + избранное каталога 3 + bridge 2 — **342/342 в затронутых областях**, tsc 0 по файлам, BB-авто принимает планы живьём.
