...
- **Добивка-2 «кроме P1» (коммит pathspec, без пуша)**: №2 — паритет свитча честно ±20%; №3 — кнопка +HIIT в валидаторе; №4 — предиктор из рекордов; №5 — NEW UI-тест 7/7; №6 — «до 16 лет». Проверено: 320/320 (движки+UI) + `tsc` 0 + apk-verify OK.
