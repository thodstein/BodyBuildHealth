...
- **Проверено**: свои UI **90/90 (10 файлов)**, широкий круг **1497/1498** (единственное падение — предсуществующее чужое `MesocycleProgressionCard`, замыкание только lms, моих файлов ноль), `tsc --noEmit` 0 (6GB), `verify:apk-design` OK. НЕ ПУШИТЬ.
