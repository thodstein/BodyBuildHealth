...
- **Нативные контролы дочищены**: «Адаптация веса» (`Settings`) — чекбокс 40×22 → свитч `role=switch` 52×32 (тач 44px); чек-лист шоу (`PeakWeekTab`) — нативные checkbox → строки-тапы 44px `role=checkbox` с ✓-тайлом.
