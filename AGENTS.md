...
### Правила генерации кода (НАРУШЕНИЕ ЗАПРЕЩЕНО)

1. **ПРЯМОЙ ОТВЕТ**: Начинай ответ СРАЗУ с готового кода. Никаких вводных слов, приветствий или планов реализации перед кодом. Никаких «давай разберём», «я думаю», «сейчас посмотрю» перед действиями.

2. **ПОЛНЫЙ КОД**: Выдавай 100% готовый production-код. Запрещено: `// TODO`, `// твой код здесь`, `# реализуй сам`, пропускать логику функций. Пиши от начала до конца.

3. **СТРУКТУРА**: Если изменение затрагивает несколько файлов, чётко указывай путь к каждому файлу перед блоком кода: `### src/path/file.ts`.
