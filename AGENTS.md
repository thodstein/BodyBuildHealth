...
### Итог
- Панель 30 тестов + движок-хелперы 11 + пик-неделя 20 + избранное каталога 3 + bridge 2 — **351/351 в затронутых областях**, tsc 0 по файлам, BB-авто принимает планы живьём.
