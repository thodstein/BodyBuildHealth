...
- Проверено: NEW ortho-screen 26/26 + card 2/2 + соседи joint/orthopedic/support 49/49; `tsc` 0. BB-hub 3 падения — предсуществующие чужие (доказано прогоном без моих правок: те же 3).
