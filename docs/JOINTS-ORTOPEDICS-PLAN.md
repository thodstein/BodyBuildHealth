...
- Проверено: NEW ortho-screen 27/27 + card 2/2 + соседи joint/orthopedic/support 49/49; `tsc` 0 по своим (1 ошибка — чужой `LiftMasterCard` WIP `diagnosticWeakSide`, не тронут). BB-hub 3 падения — предсуществующие чужие (доказано прогоном без моих правок: те же 3).
