...
- **lrTopUp в автосборке** — стейт `lrTopUp` (персист + очистка при закрытом перекосе) + пост-пасс поверх плана (клон первого упражнения мышцы, унилатерально, ≤3 сетов, делод скип, сессия <10 упр, строка в rationale).
