...
> ⚠️ **ИСТОРИЧЕСКИЙ ПЛАН.** «Хвостов 0» относится к PRO v2.2 (сентябрь 2026) и не
> покрывает более позднюю проверку по коду: safety-гейт болгарского daily-max, DUP
> event_day, честность симулятора контеста и экспорт/storage были усилены отдельным
> аудит-раундом — см. шапку `docs/STRONGMAN-PLANNER-PRO-PLAN.md`.
